...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-07-2025 08:02:36" }));
        ...
        tbSkala1.setSelectionForeground(new java.awt.Color(170, 0, 0));
        ...
        SekunderTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-07-2025 08:02:38" }));
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-07-2025 08:02:38" }));
        ...
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(TabTriase.getSelectedIndex()==0){
                ...
                if(PrimerKeluhanUtama.getText().trim().equals("")){
                    ...
                    int reply = JOptionPane.showConfirmDialog(rootPane,"ANDA AKAN MENYIMPAN DATA TRIASE "+triase+" !!! \n Apakah data yang ingin anda simpan sudah benar ?","Konfirmasi",JOptionPane.YES_NO_OPTION);
