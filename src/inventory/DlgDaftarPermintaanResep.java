...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    public DlgDaftarPermintaanResep(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Status","Kode Dokter","Poli/Unit","Triase","Kode Poli","Jenis Bayar","Tgl.Validasi","Jam Validasi",
        ...
        for (int i = 0; i <16; i++) {
            ...
            if(i==0){
                column.setPreferredWidth(75); //No Resep
            }else if(i==1){
                column.setPreferredWidth(80); // Tgl Resep
            }else if(i==2){
                column.setPreferredWidth(85); // Jam Resep
            }else if(i==3){
                column.setPreferredWidth(105); // no rawat
            }else if(i==4){
                column.setPreferredWidth(70); // no rm
            }else if(i==5){
                column.setPreferredWidth(190); // pasien
            }else if(i==6){
                column.setPreferredWidth(190); // dokter peresepan
            }else if(i==7){
                column.setPreferredWidth(90); // status
            }else if(i==8){
                column.setMinWidth(0);
                column.setMaxWidth(0); // kode dokter
            }else if(i==9){
                column.setPreferredWidth(140); // poli/unit
            }else if(i==10){
                column.setPreferredWidth(70); // triase
            }else if(i==11){
                column.setMinWidth(0);
                column.setMaxWidth(0); // kode poli
            }else if(i==12){
                column.setPreferredWidth(120); // jenis bayar
            }else if(i==13){
                column.setPreferredWidth(120); // tanggal validasi
            }else if(i==14){
                column.setPreferredWidth(65); // jam validasi
            }else if(i==15){
                column.setPreferredWidth(70); // tgl penyerahan
            }else if(i==16){
                column.setPreferredWidth(85); // jam penyerahan
            }
        }
        ...
        tabMode9=new DefaultTableModel(null,new Object[]{
                "Pasien","Billing","Kode","Nama Obat","Jumlah"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbResepPaket.setModel(tabMode9);

        //tbObat.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbObat.getBackground()));
        tbResepPaket.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbResepPaket.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 5; i++) {
            TableColumn column = tbResepPaket.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(350);
            }else if(i==1){
        ...
        tbResepPaket.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        TabPaket = new javax.swing.JTabbedPane();
        scrollPane10 = new widget.ScrollPane();
        tbResepPaket = new widget.Table();
        ...
        TabPaket.setBackground(new java.awt.Color(255, 255, 253));
        TabPaket.setForeground(new java.awt.Color(50, 50, 50));
        TabPaket.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        TabPaket.setName("TabPaket"); // NOI18N
        TabPaket.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TabPaketMouseClicked(evt);
            }
        });

        scrollPane10.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        scrollPane10.setName("scrollPane10"); // NOI18N
        scrollPane10.setOpaque(true);

        tbResepPaket.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tbResepPaket.setName("tbResepPaket"); // NOI18N
        scrollPane10.setViewportView(tbResepPaket);

        TabPaket.addTab("Detail Resep Paket", scrollPane10);

        internalFrame4.add(TabPaket, java.awt.BorderLayout.CENTER);
        TabPaket.getAccessibleContext().setAccessibleName("Detail Resep Paket");
        ...
        TabPilihRawat.addTab("Paket", internalFrame4);
...
*/
    ...
    private void TabPaketMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabPaketMouseClicked
        pilihRalan();// TODO add your handling code here:
    }//GEN-LAST:event_TabPaketMouseClicked
    ...
    */
    ...
    private javax.swing.JTabbedPane TabPaket;
    ...
    private widget.Table tbResepPaket;
                    ...
                    try{
                        ...
                        if(DEPOAKTIFOBAT.equals("")){
                            ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                                    ...
                                    " reg_periksa.kd_poli,penjab.png_jawab,"+
                                    "    CASE " +
                                    "        WHEN COALESCE( " +
                                    "            (SELECT plan FROM data_triase_igdprimer WHERE no_rawat = resep_obat.no_rawat), " +
                                    "            (SELECT plan FROM data_triase_igdsekunder WHERE no_rawat = resep_obat.no_rawat) " +
                                    "        ) = 'Zona Kuning' THEN 'Triase 2' " +
                                    "        WHEN COALESCE( " +
                                    "            (SELECT plan FROM data_triase_igdprimer WHERE no_rawat = resep_obat.no_rawat), " +
                                    "            (SELECT plan FROM data_triase_igdsekunder WHERE no_rawat = resep_obat.no_rawat) " +
                                    "        ) = 'Zona Hijau' THEN 'Triase 3' " +
                                    "        WHEN COALESCE( " +
                                    "            (SELECT plan FROM data_triase_igdprimer WHERE no_rawat = resep_obat.no_rawat), " +
                                    "            (SELECT plan FROM data_triase_igdsekunder WHERE no_rawat = resep_obat.no_rawat) " +
                                    "        ) IN ('Ruang Resusitasi','Ruang Kritis') THEN 'Triase 1' " +
                                    "        ELSE '-' " +
                                    "    END AS triase, " +
                            ...
                            if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                                while(rs.next()){
                                    Object[] row = new Object[]{
                                        ...
                                        rs.getString("kd_dokter"),rs.getString("nm_poli"),rs.getString("triase"),rs.getString("kd_poli"),rs.getString("png_jawab"),
                                ...
                                while(rs.next()){
                                    if(rs.getString("status").equals(cmbStatus.getSelectedItem().toString())){
                                        Object[] row = new Object[]{
                                            rs.getString("no_resep"),rs.getString("tgl_peresepan"),rs.getString("jam_peresepan"),rs.getString("no_rawat"),
                                            rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),rs.getString("nm_dokter"),rs.getString("status"),
                                            rs.getString("kd_dokter"),rs.getString("nm_poli"),rs.getString("kd_poli"),rs.getString("png_jawab"),rs.getString("triase"),
                                            rs.getString("tgl_perawatan"),rs.getString("jam"),rs.getString("tgl_penyerahan"),rs.getString("jam_penyerahan")
                                        };
                                        i++;
                                        SwingUtilities.invokeLater(() -> tabMode.addRow(row));
   ...
   private void tampil9() {
    ...
    try {
        if(TCari.getText().trim().equals("")){
            ps = koneksi.prepareStatement(
                " (SELECT reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,penjab.png_jawab,"+
                " reg_periksa.status_lanjut AS billing,databarang.kode_brng,databarang.nama_brng,alkes_paket_tindakan.jml AS jumlah "+
                " FROM reg_periksa "+
                ...
                " INNER JOIN alkes_paket_tindakan ON alkes_paket_tindakan.kode_paket = rawat_jl_dr.kd_jenis_prw "+
                " INNER JOIN databarang ON databarang.kode_brng = alkes_paket_tindakan.kode_brng "+
                ...
                " INNER JOIN alkes_paket_tindakan ON alkes_paket_tindakan.kode_paket = rawat_jl_pr.kd_jenis_prw "+
                " INNER JOIN databarang ON databarang.kode_brng = alkes_paket_tindakan.kode_brng "+
                " WHERE reg_periksa.tgl_registrasi BETWEEN ? AND ? ) "+
                " UNION ALL "+
                " (SELECT reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,penjab.png_jawab,"+
                " reg_periksa.status_lanjut AS billing,databarang.kode_brng,databarang.nama_brng,alkes_paket_operasi.jml AS jumlah "+
                " FROM reg_periksa "+
                " INNER JOIN pasien ON pasien.no_rkm_medis = reg_periksa.no_rkm_medis "+
                " INNER JOIN penjab ON penjab.kd_pj = reg_periksa.kd_pj "+
                " INNER JOIN operasi ON operasi.no_rawat = reg_periksa.no_rawat "+
                " INNER JOIN alkes_paket_operasi ON alkes_paket_operasi.kode_paket = operasi.kode_paket "+
                " INNER JOIN databarang ON databarang.kode_brng = alkes_paket_operasi.kode_brng "+
                " WHERE reg_periksa.tgl_registrasi BETWEEN ? AND ? ) "+
                " ORDER BY no_rawat, kode_brng "
            );
            ps.setString(1, Valid.SetTgl(DTPCari1.getSelectedItem()+""));
            ps.setString(2, Valid.SetTgl(DTPCari2.getSelectedItem()+""));
        ...
        while(rs.next()) {
            ...
            // baris detail obat
            tabMode9.addRow(new Object[]{
                "", "", rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("jumlah")
            });
        }
    } catch (Exception e) {
        System.out.println("Notif Alkes : "+e);
    } finally {
