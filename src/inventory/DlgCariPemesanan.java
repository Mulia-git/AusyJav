    ...
    private void tampil() {
        ...
        try{   
            ...
            ps=koneksi.prepareStatement("select pemesanan.tgl_pesan,pemesanan.no_faktur, "+
                    ...
                    "pemesanan.meterai,pemesanan.tagihan,pemesanan.no_order,pemesanan.potongan "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{"","Tgl.Datang",": "+rs.getString("tgl_pesan"),"","","","","","Diskon",":",Valid.SetAngka(rs.getDouble("potongan"))});
