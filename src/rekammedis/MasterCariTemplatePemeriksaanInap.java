 ...
 * @author dosen
 */
public final class MasterCariTemplatePemeriksaanInap extends javax.swing.JDialog {
    private final DefaultTableModel tabMode,tabModeRadiologi,tabModePK,tabModeDetailPK,tabModeObatUmum,tabModeObatRacikan,tabModeDetailObatRacikan,
                tabModePA,tabModeMB,tabModeDetailMB,TabModeTindakanInap;
    ...
    private String la="",ld="",pa="",pd="",kodedokter="",tanggaldilakukan="",jamdilakukan="",noperawatan="",norm="",nomor="",
            Suspen_Piutang_Tindakan_Ranap="",Tindakan_Ranap="",Beban_Jasa_Medik_Dokter_Tindakan_Ranap="",Utang_Jasa_Medik_Dokter_Tindakan_Ranap="",
            Beban_KSO_Tindakan_Ranap="",Utang_KSO_Tindakan_Ranap="",Beban_Jasa_Sarana_Tindakan_Ranap="",Utang_Jasa_Sarana_Tindakan_Ranap="",
            HPP_BHP_Tindakan_Ranap="",Persediaan_BHP_Tindakan_Ranap="",Beban_Jasa_Menejemen_Tindakan_Ranap="",Utang_Jasa_Menejemen_Tindakan_Ranap="";
    ...
    public widget.Table tbOperasi;
   
    private DefaultTableModel tabModeOperasi;
    /** Creates new form DlgPenyakit
     * @param parent
     * @param modal */
    public MasterCariTemplatePemeriksaanInap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Kode Template","Nama Paket","Jenis Paket","Billing Paket"};
        tabMode=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        
        tabModeOperasi=new DefaultTableModel(null,new Object[]{
            "Kode Operasi","Kru OK","Sewa Alat","Sewa OK","Instrumen"
        }){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                 // Ubah ke true jika ingin bisa diedit manual di tabel
                 return true; 
             }
        ...
        for (i = 0; i < 5; i++) {
            ...
            if(i==0){
                column.setPreferredWidth(300); // Kode Operasi
            }else{
                column.setPreferredWidth(100); // Harga-harga
            }
        }
        
        tbOperasi.setDefaultRenderer(Object.class, new WarnaTable());
        jLabelOperasi = new widget.Label();
        jLabelOperasi.setText("Data Operasi :");
        jLabelOperasi.setName("jLabelOperasi");
        FormInput.add(jLabelOperasi);
        
        Scroll12 = new widget.ScrollPane();
        Scroll12.setName("Scroll12");
        Scroll12.setViewportView(tbOperasi); // Masukkan tabel ke scroll
        FormInput.add(Scroll12);

      
       int yTerakhir = Scroll11.getY() + Scroll11.getHeight();

       
        if(jLabelOperasi == null) {
             jLabelOperasi = new widget.Label();
             jLabelOperasi.setText("Data Operasi :");
             jLabelOperasi.setName("jLabelOperasi");
             FormInput.add(jLabelOperasi);
        }
        jLabelOperasi.setBounds(20, yTerakhir + 10, 200, 23);
        ...
        Scroll12.setBounds(20, yTerakhir + 35, 700, 150);

        FormInput.setPreferredSize(new Dimension(730, Scroll12.getY() + Scroll12.getHeight() + 50));
...
//        
        ...
        try {
            ps=koneksi.prepareStatement(
                ...
                "set_akun_ranap.Utang_Jasa_Medik_Dokter_Tindakan_Ranap,set_akun_ranap.Beban_KSO_Tindakan_Ranap,set_akun_ranap.Utang_KSO_Tindakan_Ranap,"+
                "set_akun_ranap.Beban_Jasa_Sarana_Tindakan_Ranap,set_akun_ranap.Utang_Jasa_Sarana_Tindakan_Ranap,set_akun_ranap.Beban_Jasa_Menejemen_Tindakan_Ranap,"+
                "set_akun_ranap.Utang_Jasa_Menejemen_Tindakan_Ranap,set_akun_ranap.HPP_BHP_Tindakan_Ranap,set_akun_ranap.Persediaan_BHP_Tindakan_Ranap from set_akun_ranap");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Master Template Pemeriksaan Dokter Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(730, 1900));
        FormInput.setLayout(null);

        Rajal.setText("Rawat Jalan");
        Rajal.setName("Rajal"); // NOI18N
        FormInput.add(Rajal);
        Rajal.setBounds(580, 10, 140, 20);
        ...
        scrollPane3.setBounds(20, 30, 700, 40);

        jLabel41.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel41.setText("Jenis :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(20, 80, 410, 20);
        ...
        scrollPane4.setBounds(20, 100, 700, 40);
        ...
        Scroll4.setBounds(20, 320, 700, 123);
        ...
        Scroll7.setBounds(20, 860, 700, 113);
        ...
        Scroll8.setBounds(20, 980, 700, 223);

        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel21.setText("Tindakan :");
        jLabel21.setName("jLabel21"); // NOI18N
        FormInput.add(jLabel21);
        jLabel21.setBounds(20, 1220, 120, 23);
        ...
        Scroll12.setViewportView(tbTindakanInap);

        FormInput.add(Scroll12);
        Scroll12.setBounds(20, 1240, 700, 123);

        jLabel42.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel42.setText("Judul :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(20, 10, 410, 20);

        jLabel19.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel19.setText("Obat Non Racikan :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(16, 1370, 270, 23);
        ...
        Scroll9.setBounds(16, 1400, 700, 180);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("Obat Racikan :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(10, 1590, 270, 23);
        ...
        Scroll10.setBounds(20, 1620, 700, 103);
        ...
        Scroll11.setBounds(20, 1710, 700, 160);
        ...
        if(tabMode.getRowCount()!=0){
            if(tbDokter.getSelectedRow()>-1){
                try {
                    ...
                    Rajal.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),3).toString());
...
//                    }
                    ...
                    ps = koneksi.prepareStatement(
                        "SELECT template_pemeriksaan_dokter_tindakan_inap.kd_jenis_prw, " +
                        "jns_perawatan_inap.nm_perawatan, kategori_perawatan.nm_kategori, " +
                        "jns_perawatan_inap.total_byrdr, jns_perawatan_inap.bhp, jns_perawatan_inap.material, " +
                        "jns_perawatan_inap.tarif_tindakandr, jns_perawatan_inap.kso, jns_perawatan_inap.menejemen " +
                        "FROM template_pemeriksaan_dokter_tindakan_inap " +
                        "INNER JOIN jns_perawatan_inap ON template_pemeriksaan_dokter_tindakan_inap.kd_jenis_prw = jns_perawatan_inap.kd_jenis_prw " +
                        "INNER JOIN kategori_perawatan ON kategori_perawatan.kd_kategori = jns_perawatan_inap.kd_kategori " +
                    ...
                    Valid.tabelKosong(tabModeOperasi); // Kosongkan tabel GUI Operasi dulu
                    
                    // Query untuk mengambil data operasi berdasarkan no_template
                    ps = koneksi.prepareStatement(
                        "SELECT nama_operasi, tarif_kru_ok, tarif_sewa_alat, tarif_sewa_ok, tarif_instrumen " +
                        "FROM template_pemeriksaan_dokter_operasi WHERE kd_template = ?"
                    );
                    
                    try {
                        // Ambil No Template dari Tabel Dokter (Kolom 0)
                        ps.setString(1, tabMode.getValueAt(tbDokter.getSelectedRow(), 0).toString());
                        rs = ps.executeQuery();
                        
                        while(rs.next()){
                            // Masukkan data ke Model Tabel Operasi (tabModeOperasi)
                            // Pastikan urutan kolomnya sesuai dengan definisi tabModeOperasi
                            tabModeOperasi.addRow(new Object[]{
                                rs.getString("nama_operasi"),
                                rs.getDouble("tarif_kru_ok"),
                                rs.getDouble("tarif_sewa_alat"),
                                rs.getDouble("tarif_sewa_ok"),
                                rs.getDouble("tarif_instrumen")
                            });
                        }
                    } catch (Exception e) {
                ...
                if(sukses==true){
                    ...
                    if(tabModeRadiologi.getRowCount()>0){
                        ...
                        if(Sequel.menyimpantf2("permintaan_radiologi","?,?,?,?,?,?,?,?,?,?,?,?","No.Permintaan Radiologi",12,new String[]{
                                nomor,noperawatan,tanggaldilakukan,jamdilakukan,"0000-00-00","00:00:00","0000-00-00","00:00:00",kodedokter,"ranap","-",Subjek.getText()
                            })==true){
                    ...
                    if(tabModePA.getRowCount()>0){
                        ...
                        if(Sequel.menyimpantf2("permintaan_labpa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Permintaan",20,new String[]{
                                nomor,noperawatan,tanggaldilakukan,jamdilakukan,"0000-00-00","00:00:00","0000-00-00","00:00:00",kodedokter,"ranap","-",Subjek.getText(),tanggaldilakukan,"-","-","-","-","0000-00-00","-","-"
                            })==true){
                    ...
                    if(TabModeTindakanInap.getRowCount()>0){
                        ttljmdokter=0;ttlkso=0;ttlpendapatan=0;ttljasasarana=0;ttlbhp=0;ttlmenejemen=0;
                        for(i=0;i<tbTindakanInap.getRowCount();i++){ 
                            if(Sequel.menyimpantf2("rawat_inap_dr","?,?,?,?,?,?,?,?,?,?,?","Tindakan/Pemeriksaan "+tbTindakanInap.getValueAt(i,1).toString(),11,new String[]{
                                noperawatan, tbTindakanInap.getValueAt(i,0).toString(), // kd_jenis_prw
                                kodedokter, tanggaldilakukan, jamdilakukan,
                                tbTindakanInap.getValueAt(i,4).toString(), // material
                                tbTindakanInap.getValueAt(i,5).toString(), // bhp
                                tbTindakanInap.getValueAt(i,6).toString(), // tarif_tindakandr
                                tbTindakanInap.getValueAt(i,7).toString(), // kso
                                tbTindakanInap.getValueAt(i,8).toString(), // menejemen
                                tbTindakanInap.getValueAt(i,3).toString()  // biaya_rawat
                            })==true){
                                ttlpendapatan=ttlpendapatan+Double.parseDouble(tbTindakanInap.getValueAt(i,3).toString());
                                ttljasasarana=ttljasasarana+Double.parseDouble(tbTindakanInap.getValueAt(i,4).toString());
                                ttlbhp=ttlbhp+Double.parseDouble(tbTindakanInap.getValueAt(i,5).toString());
                                ttljmdokter=ttljmdokter+Double.parseDouble(tbTindakanInap.getValueAt(i,6).toString());
                                ttlkso=ttlkso+Double.parseDouble(tbTindakanInap.getValueAt(i,7).toString());
                                ttlmenejemen=ttlmenejemen+Double.parseDouble(tbTindakanInap.getValueAt(i,8).toString());
                            }else{
                                sukses=false;
                            } 
                        }
                        ...
                        if(sukses==true){
                            ...
                            if(ttlbhp>0){
                                if(Sequel.menyimpantf("tampjurnal","'"+HPP_BHP_Tindakan_Ranap+"','HPP BHP Tindakan Ralan','"+ttlbhp+"','0'","debet=debet+'"+(ttlbhp)+"'","kd_rek='"+HPP_BHP_Tindakan_Ranap+"'")==false){
                                    sukses=false;
                                }      
                                if(Sequel.menyimpantf("tampjurnal","'"+Persediaan_BHP_Tindakan_Ranap+"','Persediaan BHP Tindakan Ralan','0','"+ttlbhp+"'","kredit=kredit+'"+(ttlbhp)+"'","kd_rek='"+Persediaan_BHP_Tindakan_Ranap+"'")==false){
                                    sukses=false;
                                }                           
                            }
                            if(ttlmenejemen>0){
                            ...
                            if(sukses==true){
                                sukses=jur.simpanJurnal(noperawatan,"U","TINDAKAN RAWAT INAP PASIEN "+noperawatan+" DIPOSTING OLEH "+akses.getkode());
                            }     
                        }
                    }
                    if (tbOperasi.getRowCount() > 0) {
                        for (i = 0; i < tbOperasi.getRowCount(); i++) {
                            // Cek jika nama operasi tidak kosong
                            if (!tbOperasi.getValueAt(i, 0).toString().trim().equals("")) {
                                try {
                                    
                                      String namaOperasi =  tbOperasi.getValueAt(i, 0).toString();
                                    
                                    double tarifKru = Double.parseDouble(tbOperasi.getValueAt(i, 1).toString().replaceAll(",", "").replaceAll("\\.", ""));
                                    double tarifSewaAlat = Double.parseDouble(tbOperasi.getValueAt(i, 2).toString().replaceAll(",", "").replaceAll("\\.", ""));
                                    double tarifSewaOK = Double.parseDouble(tbOperasi.getValueAt(i, 3).toString().replaceAll(",", "").replaceAll("\\.", ""));
                                    double tarifInstrumen = Double.parseDouble(tbOperasi.getValueAt(i, 4).toString().replaceAll(",", "").replaceAll("\\.", ""));

                                    // 2. Gabungkan Tanggal dan Jam untuk kolom tgl_operasi (datetime)
                                    String waktuOperasi = tanggaldilakukan + " " + jamdilakukan;

                                    // 3. Simpan ke Tabel 'operasi'
                                    // Kita butuh 57 tanda tanya (?) karena tabel memiliki 57 kolom
                                    if (Sequel.menyimpantf2("operasi", 
                                            // String tanda tanya sebanyak 57 kali:
                                            "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", 
                                            "Data Operasi " + tbOperasi.getValueAt(i, 0).toString(), 57, new String[]{

                                            noperawatan,            // 1. no_rawat
                                            waktuOperasi,           // 2. tgl_operasi (datetime)
                                            "-",                    // 3. jenis_anasthesi
                                            "-",                    // 4. kategori
                                            "-",             // 5. operator1 (Dokter yang login/dipilih)
                                            "-",                    // 6. operator2
                                            "-",                    // 7. operator3
                                            "-",                    // 8. asisten_operator1
                                            "-",                    // 9. asisten_operator2
                                            "-",                    // 10. asisten_operator3
                                            "-",                    // 11. instrumen
                                            "-",                    // 12. dokter_anak
                                            "-",                    // 13. perawaat_resusitas
                                            "-",                    // 14. dokter_anestesi
                                            "-",                    // 15. asisten_anestesi
                                            "-",                    // 16. asisten_anestesi2
                                            "-",                    // 17. bidan
                                            "-",                    // 18. bidan2
                                            "-",                    // 19. bidan3
                                            "-",                    // 20. perawat_luar
                                            ...
                                            "-",                    // 26. dokter_pjanak
                                            "-",                    // 27. dokter_umum
                                            namaOperasi,                    // 28. kode_paket
                                            String.valueOf(tarifKru), // 29. biayaoperator1 (KRU OK) -> SESUAI PERMINTAAN
                                            "0",                    // 30. biayaoperator2
                                            "0",                    // 31. biayaoperator3
                                            "0",                    // 32. biayaasisten_operator1
                                            "0",                    // 33. biayaasisten_operator2
                                            "0",                    // 34. biayaasisten_operator3
                                            String.valueOf(tarifInstrumen), // 35. biayainstrumen -> SESUAI PERMINTAAN
                                            "0",                    // 36. biayadokter_anak
                                            "0",                    // 37. biayaperawaat_resusitas
                                            "0",                    // 38. biayadokter_anestesi
                                            "0",                    // 39. biayaasisten_anestesi
                                            "0",                    // 40. biayaasisten_anestesi2
                                            "0",                    // 41. biayabidan
                                            "0",                    // 42. biayabidan2
                                            "0",                    // 43. biayabidan3
                                            "0",                    // 44. biayaperawat_luar
                                            String.valueOf(tarifSewaAlat),  // 45. biayaalat -> SESUAI PERMINTAAN
                                            String.valueOf(tarifSewaOK),    // 46. biayasewaok -> SESUAI PERMINTAAN
                                            "0",                    // 47. akomodasi
                                            "0",                    // 48. bagian_rs
                                            "0",                    // 49. biaya_omloop
                                            "0",                    // 50. biaya_omloop2
                                            ...
                                            "0",                    // 53. biaya_omloop5
                                            "0",                    // 54. biayasarpras
                                            "0",                    // 55. biaya_dokter_pjanak
                                            "0",                    // 56. biaya_dokter_umum
                                            "Ranap"                 // 57. status
                                        }) == true) {

                                        // Hitung total pendapatan jika diperlukan untuk jurnal
                                        // ttlpendapatan += tarifKru + tarifSewaAlat + tarifSewaOK + tarifInstrumen;

                                    } else {
                                        sukses = false;
                                    }
                                } catch (Exception e) {
                                    System.out.println("Error Simpan Operasi: " + e);
                                    sukses = false;
                                }
                            }
                        }
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                        ...
                        "template_pemeriksaan_dokter.jenis, template_pemeriksaan_dokter.tipe " +
