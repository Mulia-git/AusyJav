...
public class DapurPermintaan extends javax.swing.JDialog {
    ...
    private DapurCariPermintaan form=new DapurCariPermintaan(null,false);
     ...
     * @param parent
     * @param modal */
    public DapurPermintaan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Ruangan.setBounds(95, 40, 274, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(NoPermintaan.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                sukses=true;
                if(Sequel.menyimpantf2("permintaan_dapur","?,?,?,?,?","No.Permintaan",5,new String[]{
                        ...
                        for(i=0;i<jml;i++){  
                            try {
                                if(Valid.SetAngka(tbDokter.getValueAt(i,0).toString())>0){
                                    if(Sequel.menyimpantf2("detail_permintaan_dapur","?,?,?,?,?","Detail Permintaan",5,new String[]{
...
private void NoPermintaanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoPermintaanKeyPressed
        Valid.pindah(evt, BtnSimpan, Ruangan);
...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            if(Valid.daysOld("./cache/permintaandapur.iyem")<8){
                tampil2();
            }else{
                tampil();
            }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurPermintaan dialog = new DapurPermintaan(new javax.swing.JFrame(), true);
    ...
    private void tampil2() {
        try{
            ...
            response = root.path("permintaandapur");
            if(response.isArray()){
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            ...
            BtnSimpan.setEnabled(akses.getpermintaan_dapur());
    ...
    private void autoNomor() {
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(permintaan_dapur.no_permintaan,3),signed)),0) from permintaan_dapur where permintaan_dapur.tanggal='"+Valid.SetTgl(Tanggal.getSelectedItem()+"")+"' ",
                "PD"+Tanggal.getSelectedItem().toString().substring(8,10)+Tanggal.getSelectedItem().toString().substring(3,5)+Tanggal.getSelectedItem().toString().substring(0,2),3,NoPermintaan); 
    }
