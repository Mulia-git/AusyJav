...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    public DlgCariTagihanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        PreOp3.setDocument(new batasInput((int)100).getKata(PreOp3));      
        PostOp2.setDocument(new batasInput((int)100).getKata(PostOp2));      
    ...
    private void initComponents() {
        ...
        PreOp3 = new widget.TextBox();
        PostOp2 = new widget.TextBox();
        jLabel7 = new widget.Label();
        jLabel8 = new widget.Label();
        Jaringan = new widget.TextBox();
        DikirimPA2 = new widget.ComboBox();
        ...
        MnUbahLaporan.setBackground(new java.awt.Color(255, 255, 254));
        MnUbahLaporan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnUbahLaporan.setForeground(new java.awt.Color(50, 50, 50));
        MnUbahLaporan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnUbahLaporan.setText("Ubah Laporan Operasi Pasien");
        MnUbahLaporan.setName("MnUbahLaporan"); // NOI18N
        MnUbahLaporan.setPreferredSize(new java.awt.Dimension(220, 26));
        MnUbahLaporan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnUbahLaporanActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnUbahLaporan);
        ...
        kdanestesi.setBounds(90, 40, 100, 23);
        ...
        nmanestesi.setBounds(190, 40, 190, 23);
        ...
        BtnAnastesi.setBounds(380, 40, 28, 23);

        label22.setText("dr Anak :");
        label22.setName("label22"); // NOI18N
        label22.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label22);
        label22.setBounds(0, 70, 82, 23);
        ...
        kddranak.setBounds(90, 70, 100, 23);
        ...
        nmdranak.setBounds(190, 70, 190, 23);
        ...
        btnAnak.setBounds(380, 70, 28, 23);
        ...
        BtnSimpan4.setBounds(500, 50, 100, 30);
        ...
        BtnCloseIn4.setBounds(600, 50, 100, 30);
        ...
        panelGlass7.setPreferredSize(new java.awt.Dimension(300, 300));
        panelGlass7.setLayout(null);

        label40.setText("Tanggal Operasi :");
        label40.setName("label40"); // NOI18N
        label40.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass7.add(label40);
        label40.setBounds(406, 40, 101, 23);
        ...
        label44.setText("Selesai Operasi :");
        label44.setName("label44"); // NOI18N
        label44.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass7.add(label44);
        label44.setBounds(410, 80, 101, 23);
        ...
        PreOp.setBounds(150, 80, 256, 23);

        jLabel10.setText("Diagnosis Pra Bedah :");
        jLabel10.setName("jLabel10"); // NOI18N
        panelGlass7.add(jLabel10);
        jLabel10.setBounds(0, 80, 145, 23);

        jLabel11.setText("No KO :");
        jLabel11.setName("jLabel11"); // NOI18N
        panelGlass7.add(jLabel11);
        jLabel11.setBounds(430, 170, 40, 23);
        ...
        panelGlass7.add(waktuAnastesi);
        waktuAnastesi.setBounds(510, 140, 100, 23);

        jLabel12.setText("Insisi kulit & pembukaan lapangan operasi :");
        jLabel12.setName("jLabel12"); // NOI18N
        panelGlass7.add(jLabel12);
        jLabel12.setBounds(0, 150, 150, 23);

        jLabel13.setText("Pemeriksaan PA :");
        jLabel13.setName("jLabel13"); // NOI18N
        panelGlass7.add(jLabel13);
        jLabel13.setBounds(210, 270, 145, 23);
        ...
        DikirimPA.setBounds(360, 270, 60, 20);
        ...
        scrollPane3.setBounds(500, 210, 320, 112);

        jLabel14.setText("Hasil Eksplori :");
        jLabel14.setName("jLabel14"); // NOI18N
        panelGlass7.add(jLabel14);
        jLabel14.setBounds(420, 210, 70, 23);
        ...
        panelGlass7.add(btnTemplate);
        btnTemplate.setBounds(470, 240, 28, 23);

        jLabel15.setText("Jenis Anastesi :");
        jLabel15.setName("jLabel15"); // NOI18N
        panelGlass7.add(jLabel15);
        jLabel15.setBounds(0, 180, 145, 23);
        ...
        panelGlass7.add(jnsAnastesi);
        jnsAnastesi.setBounds(150, 180, 256, 23);

        label45.setText("Mulai Anastesi :");
        label45.setName("label45"); // NOI18N
        label45.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass7.add(label45);
        label45.setBounds(400, 140, 101, 23);

        Jaringan1.setHighlighter(null);
        Jaringan1.setName("Jaringan1"); // NOI18N
        Jaringan1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Jaringan1KeyPressed(evt);
            }
        });
        panelGlass7.add(Jaringan1);
        Jaringan1.setBounds(150, 150, 256, 23);

        label46.setText("Selesai Anastesi :");
        label46.setName("label46"); // NOI18N
        label46.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass7.add(label46);
        label46.setBounds(610, 140, 101, 23);

        jLabel16.setText("Bahan Anastesi :");
        jLabel16.setName("jLabel16"); // NOI18N
        panelGlass7.add(jLabel16);
        jLabel16.setBounds(0, 210, 145, 23);
        ...
        panelGlass7.add(bahanAnastesi);
        bahanAnastesi.setBounds(150, 210, 256, 23);
        ...
        panelGlass7.add(golonganOperasi);
        golonganOperasi.setBounds(120, 240, 110, 23);

        jLabel17.setText("Golongan Operasi :");
        jLabel17.setName("jLabel17"); // NOI18N
        panelGlass7.add(jLabel17);
        jLabel17.setBounds(20, 240, 92, 23);

        jLabel18.setText("Macam Operasi :");
        jLabel18.setName("jLabel18"); // NOI18N
        panelGlass7.add(jLabel18);
        jLabel18.setBounds(170, 240, 145, 23);
        ...
        panelGlass7.add(macamOperasi);
        macamOperasi.setBounds(320, 240, 90, 23);

        jLabel19.setText("Urgensi Operasi :");
        jLabel19.setName("jLabel19"); // NOI18N
        panelGlass7.add(jLabel19);
        jLabel19.setBounds(-20, 270, 145, 23);
        ...
        panelGlass7.add(urgensiOps);
        urgensiOps.setBounds(120, 270, 110, 23);
        ...
        panelGlass7.add(icd9);
        icd9.setBounds(510, 110, 256, 23);

        jLabel20.setText("ICD-9-CM :");
        jLabel20.setName("jLabel20"); // NOI18N
        panelGlass7.add(jLabel20);
        jLabel20.setBounds(360, 110, 145, 23);

        jLabel21.setText("Ronde :");
        jLabel21.setName("jLabel21"); // NOI18N
        panelGlass7.add(jLabel21);
        jLabel21.setBounds(610, 170, 40, 23);
        ...
        panelGlass7.add(selesaiAnastesi);
        selesaiAnastesi.setBounds(710, 140, 100, 23);
        ...
        jLabel1.setBounds(20, 320, 140, 20);

        jLabel22.setText(" Persiapan Operasi :");
        jLabel22.setName("jLabel22"); // NOI18N
        panelGlass7.add(jLabel22);
        jLabel22.setBounds(0, 350, 145, 23);
        ...
        panelGlass7.add(persiapanOps);
        persiapanOps.setBounds(140, 350, 256, 23);
        ...
        panelGlass7.add(posisiPasien);
        posisiPasien.setBounds(140, 380, 256, 23);

        jLabel23.setText("Posisi Pasieni :");
        jLabel23.setName("jLabel23"); // NOI18N
        panelGlass7.add(jLabel23);
        jLabel23.setBounds(-30, 380, 160, 23);
        ...
        panelGlass7.add(desinfeksi);
        desinfeksi.setBounds(140, 410, 256, 23);

        jLabel24.setText("Desinfeksi :");
        jLabel24.setName("jLabel24"); // NOI18N
        panelGlass7.add(jLabel24);
        jLabel24.setBounds(-70, 410, 190, 23);

        jLabel25.setText("Apa yang dilakukan :");
        jLabel25.setName("jLabel25"); // NOI18N
        panelGlass7.add(jLabel25);
        jLabel25.setBounds(0, 470, 120, 23);
        ...
        scrollPane4.setViewportView(dilakukan);

        panelGlass7.add(scrollPane4);
        scrollPane4.setBounds(130, 470, 270, 74);
        ...
        panelGlass7.add(tutupLuka);
        tutupLuka.setBounds(570, 340, 256, 23);

        jLabel26.setText("Penutupan Luka Operasi & kulit");
        jLabel26.setName("jLabel26"); // NOI18N
        panelGlass7.add(jLabel26);
        jLabel26.setBounds(390, 340, 170, 23);
        ...
        panelGlass7.add(penuylitOps);
        penuylitOps.setBounds(570, 370, 256, 23);

        jLabel27.setText("Penyulit Operasi :");
        jLabel27.setName("jLabel27"); // NOI18N
        panelGlass7.add(jLabel27);
        jLabel27.setBounds(390, 370, 170, 23);

        jLabel28.setText("Jumlah Pendarahan :");
        jLabel28.setName("jLabel28"); // NOI18N
        panelGlass7.add(jLabel28);
        jLabel28.setBounds(390, 400, 170, 23);
        ...
        panelGlass7.add(jmlDarah);
        jmlDarah.setBounds(570, 400, 256, 23);
        ...
        panelGlass7.add(hasilOps1);
        hasilOps1.setBounds(570, 430, 256, 23);

        jLabel29.setText("Hasil Operasi :");
        jLabel29.setName("jLabel29"); // NOI18N
        panelGlass7.add(jLabel29);
        jLabel29.setBounds(390, 430, 170, 23);
        ...
        panelGlass7.add(hasilOps2);
        hasilOps2.setBounds(570, 460, 256, 23);
        ...
        panelGlass7.add(bahanAnastesi1);
        bahanAnastesi1.setBounds(570, 490, 256, 23);

        jLabel30.setText("Lain-lain yang perlu :");
        jLabel30.setName("jLabel30"); // NOI18N
        panelGlass7.add(jLabel30);
        jLabel30.setBounds(420, 490, 145, 23);
        ...
        panelGlass7.add(noKo1);
        noKo1.setBounds(480, 170, 100, 23);
        ...
        panelGlass7.add(ronde1);
        ronde1.setBounds(660, 170, 100, 23);

        jLabel31.setText("Diagnosis Pasca Bedah :");
        jLabel31.setName("jLabel31"); // NOI18N
        panelGlass7.add(jLabel31);
        jLabel31.setBounds(0, 110, 145, 23);
        ...
        PostOp.setBounds(150, 110, 256, 23);

        internalFrame6.add(panelGlass7, java.awt.BorderLayout.CENTER);
        ...
        PreOp3.setHighlighter(null);
        PreOp3.setName("PreOp3"); // NOI18N
        PreOp3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PreOp3KeyPressed(evt);
            }
        });

        PostOp2.setHighlighter(null);
        PostOp2.setName("PostOp2"); // NOI18N
        PostOp2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PostOp2KeyPressed(evt);
            }
        });
        ...
        DikirimPA2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        DikirimPA2.setName("DikirimPA2"); // NOI18N
        DikirimPA2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DikirimPA2KeyPressed(evt);
            }
        });
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(int i=0;i<row;i++){  
                Sequel.menyimpan("temporary","'"+i+"','"+
                                ...
                                tabMode.getValueAt(i,39).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi operasi"); 
            }
            ...
            Valid.MyReportqry("rptOperasi.jasper","report","::[ Transaksi Operasi ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
        }
        ...
        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
            if(Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString())>0){
                ...
                if (reply == JOptionPane.YES_OPTION) {
                    ...
                    String kode_paket = Sequel.cariIsi("select kode_paket from operasi where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1)+"' and tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0) +"'");
                    String norawat = tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString();
                    ...
                    if(sukses==true){
                        ...
                        if(status.equals("Ranap")){
                            ...
                            if(ttlpendapatan>0){
                                if(Sequel.menyimpantf("tampjurnal","'"+Suspen_Piutang_Operasi_Ranap+"','Suspen Piutang Operasi Ranap','0','"+ttlpendapatan+"'","kredit=kredit+'"+ttlpendapatan+"'","kd_rek='"+Suspen_Piutang_Operasi_Ranap+"'")==false){
                                    sukses=false;
                                }     
                                if(Sequel.menyimpantf("tampjurnal","'"+Operasi_Ranap+"','Pendapatan Operasi Rawat Inap','"+ttlpendapatan+"','0'","debet=debet+'"+ttlpendapatan+"'","kd_rek='"+Operasi_Ranap+"'")==false){
                                    sukses=false;
                                }                             
                            }
                            if(ttljmdokter>0){
                                if(Sequel.menyimpantf("tampjurnal","'"+Beban_Jasa_Medik_Dokter_Operasi_Ranap+"','Beban Jasa Medik Dokter Operasi Ranap','0','"+ttljmdokter+"'","kredit=kredit+'"+ttljmdokter+"'","kd_rek='"+Beban_Jasa_Medik_Dokter_Operasi_Ranap+"'")==false){
                                    sukses=false;
                                }     
                                if(Sequel.menyimpantf("tampjurnal","'"+Utang_Jasa_Medik_Dokter_Operasi_Ranap+"','Utang Jasa Medik Dokter Operasi Ranap','"+ttljmdokter+"','0'","debet=debet+'"+ttljmdokter+"'","kd_rek='"+Utang_Jasa_Medik_Dokter_Operasi_Ranap+"'")==false){
                                    sukses=false;
                                }                             
                            }
                            if(ttljmpetugas>0){
                                if(Sequel.menyimpantf("tampjurnal","'"+Beban_Jasa_Medik_Paramedis_Operasi_Ranap+"','Beban Jasa Medik Petugas Operasi Ranap','0','"+ttljmpetugas+"'","kredit=kredit+'"+ttljmpetugas+"'","kd_rek='"+Beban_Jasa_Medik_Paramedis_Operasi_Ranap+"'")==false){
                                    sukses=false;
                                }      
                                if(Sequel.menyimpantf("tampjurnal","'"+Utang_Jasa_Medik_Paramedis_Operasi_Ranap+"','Utang Jasa Medik Petugas Operasi Ranap','"+ttljmpetugas+"','0'","debet=debet+'"+ttljmpetugas+"'","kd_rek='"+Utang_Jasa_Medik_Paramedis_Operasi_Ranap+"'")==false){
                                    sukses=false;
                                }                             
                            }
                            if(ttlbhp>0){
                                if(Sequel.menyimpantf("tampjurnal","'"+HPP_Obat_Operasi_Ranap+"','HPP Persediaan Operasi Rawat Inap','0','"+ttlbhp+"'","kredit=kredit+'"+ttlbhp+"'","kd_rek='"+HPP_Obat_Operasi_Ranap+"'")==false){
                                    sukses=false;
                                }     
                                if(Sequel.menyimpantf("tampjurnal","'"+Persediaan_Obat_Kamar_Operasi_Ranap+"','Persediaan BHP Operasi Rawat Inap','"+ttlbhp+"','0'","debet=debet+'"+ttlbhp+"'","kd_rek='"+Persediaan_Obat_Kamar_Operasi_Ranap+"'")==false){
                                    sukses=false;
                                }                             
                            }
                            if(sukses==true){
                            ...
                            Sequel.queryu("delete from tampjurnal");    
                            if(ttlpendapatan>0){
                                if(Sequel.menyimpantf("tampjurnal","'"+Suspen_Piutang_Operasi_Ralan+"','Suspen Piutang Operasi Ralan','0','"+ttlpendapatan+"'","kredit=kredit+'"+ttlpendapatan+"'","kd_rek='"+Suspen_Piutang_Operasi_Ralan+"'")==false){
                                    sukses=false;
                                }    
                                if(Sequel.menyimpantf("tampjurnal","'"+Operasi_Ralan+"','Pendapatan Operasi Rawat Jalan','"+ttlpendapatan+"','0'","debet=debet+'"+ttlpendapatan+"'","kd_rek='"+Operasi_Ralan+"'")==false){
                                    sukses=false;
                                }                             
                            }
                            if(ttljmdokter>0){
                                if(Sequel.menyimpantf("tampjurnal","'"+Beban_Jasa_Medik_Dokter_Operasi_Ralan+"','Beban Jasa Medik Dokter Operasi Ralan','0','"+ttljmdokter+"'","kredit=kredit+'"+ttljmdokter+"'","kd_rek='"+Beban_Jasa_Medik_Dokter_Operasi_Ralan+"'")==false){
                                    sukses=false;
                                }     
                                if(Sequel.menyimpantf("tampjurnal","'"+Utang_Jasa_Medik_Dokter_Operasi_Ralan+"','Utang Jasa Medik Dokter Operasi Ralan','"+ttljmdokter+"','0'","debet=debet+'"+ttljmdokter+"'","kd_rek='"+Utang_Jasa_Medik_Dokter_Operasi_Ralan+"'")==false){
                                    sukses=false;
                                }                             
                            }
                            if(ttljmpetugas>0){
                                if(Sequel.menyimpantf("tampjurnal","'"+Beban_Jasa_Medik_Paramedis_Operasi_Ralan+"','Beban Jasa Medik Petugas Operasi Ralan','0','"+ttljmpetugas+"'","kredit=kredit+'"+ttljmpetugas+"'","kd_rek='"+Beban_Jasa_Medik_Paramedis_Operasi_Ralan+"'")==false){
                                    sukses=false;
                                }      
                                if(Sequel.menyimpantf("tampjurnal","'"+Utang_Jasa_Medik_Paramedis_Operasi_Ralan+"','Utang Jasa Medik Petugas Operasi Ralan','"+ttljmpetugas+"','0'","debet=debet+'"+ttljmpetugas+"'","kd_rek='"+Utang_Jasa_Medik_Paramedis_Operasi_Ralan+"'")==false){
                                    sukses=false;
                                }                             
                            }
                            if(ttlbhp>0){
                                if(Sequel.menyimpantf("tampjurnal","'"+HPP_Obat_Operasi_Ralan+"','HPP Persediaan Operasi Rawat Jalan','0','"+ttlbhp+"'","kredit=kredit+'"+ttlbhp+"'","kd_rek='"+HPP_Obat_Operasi_Ralan+"'")==false){
                                    sukses=false;
                                }     
                                if(Sequel.menyimpantf("tampjurnal","'"+Persediaan_Obat_Kamar_Operasi_Ralan+"','Persediaan BHP Operasi Rawat Jalan','"+ttlbhp+"','0'","debet=debet+'"+ttlbhp+"'","kd_rek='"+Persediaan_Obat_Kamar_Operasi_Ralan+"'")==false){
                                    sukses=false;
                                }                             
                            }
                            if(sukses==true){
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
    if(tbDokter.getSelectedRow()>-1){
        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){            
            if(Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString())>0){
                ...
                int reply = JOptionPane.showConfirmDialog(rootPane,"Apakah data yang ingin anda simpan sudah benar ?","Konfirmasi",JOptionPane.YES_NO_OPTION);
                if (reply == JOptionPane.YES_OPTION) {
                    Sequel.AutoComitFalse();
                    sukses=true;
                    ...
                    if(Sequel.queryutf("delete from beri_obat_operasi where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1) +"' and tanggal='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0)+"'")==true){
                        if(status.equals("Ranap")){
                            if(ttlbhp>0){
                                ...
                                if(Sequel.menyimpantf("tampjurnal","'"+Suspen_Piutang_Operasi_Ranap+"','Suspen Piutang Operasi Ranap','0','"+ttlbhp+"'","kredit=kredit+'"+ttlbhp+"'","kd_rek='"+Suspen_Piutang_Operasi_Ranap+"'")==false){
                                    sukses=false;
                                }    
                                if(Sequel.menyimpantf("tampjurnal","'"+Operasi_Ranap+"','Pendapatan Operasi Rawat Inap','"+ttlbhp+"','0'","debet=debet+'"+ttlbhp+"'","kd_rek='"+Operasi_Ranap+"'")==false){
                                    sukses=false;
                                }
                                if(sukses==true){
                            ...
                            if(ttlbhp>0){
                                ...
                                if(Sequel.menyimpantf("tampjurnal","'"+Suspen_Piutang_Operasi_Ralan+"','Suspen Piutang Operasi Ralan','0','"+ttlbhp+"'","kredit=kredit+'"+ttlbhp+"'","kd_rek='"+Suspen_Piutang_Operasi_Ralan+"'")==false){
                                    sukses=false;
                                }    
                                if(Sequel.menyimpantf("tampjurnal","'"+Operasi_Ralan+"','Pendapatan Operasi Rawat Jalan','"+ttlbhp+"','0'","debet=debet+'"+ttlbhp+"'","kd_rek='"+Operasi_Ralan+"'")==false){
                                    sukses=false;
                                } 
                                if(sukses==true){
                ...
                try {
                    try{
                        rs=koneksi.prepareStatement(
                                ...
                                "operasi.no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()+"' and operasi.tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()+"' ").executeQuery();
                        while(rs.next()){
                            finger=rs.getString("nm_perawatan")+", "+finger;
                        }
                    }catch (Exception e) {
    ...
    private void MnUbahLaporanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUbahLaporanActionPerformed
         TNoRw.setText((String) tbDokter.getValueAt(tbDokter.getSelectedRow(),1));
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                try {
                 String sql =
                        "SELECT *"+
                        "FROM laporan_operasi WHERE no_rawat = '" + tbDokter.getValueAt(tbDokter.getSelectedRow(),1) + "'";

                 System.out.print(sql);
                    rs2 = koneksi.prepareStatement(sql).executeQuery();
                   ...
                   if(rs2.next()){
                         ...
                         TPasien.setText((String) tbDokter.getValueAt(tbDokter.getSelectedRow(),2));

                     

                        jenis.setText(rs2.getString("jnsAnastesi"));
                        PreOp.setText(rs2.getString("diagnosa_preop"));
                        PostOp.setText(rs2.getString("diagnosa_postop"));
                        Jaringan.setText((String)rs2.getString("jaringan_dieksekusi"));
                      
                      // tanggal operasi
                        java.sql.Timestamp ts = rs2.getTimestamp("tanggal");
                        if(ts != null){
                            tgl.setDate(new java.util.Date(ts.getTime()));
                        }

                        // selesai operasi 
                        java.sql.Timestamp tselesaioperasi = rs2.getTimestamp("selesaioperasi");
                        if(tselesaioperasi != null){
                            tgl3.setDate(new java.util.Date(tselesaioperasi.getTime()));
                        }
                        System.out.print(tselesaioperasi);

                        DikirimPA.setSelectedItem(rs2.getString("permintaan_pa"));
                        Laporan1.setText(rs2.getString("laporan_operasi"));

//                        status = rs2.getString("status");

                        icd9.setText(rs2.getString("icd9"));
                        jnsAnastesi.setText(rs2.getString("jnsAnastesi"));
                        bahanAnastesi.setText(rs2.getString("bahanAnastesi"));

                        golonganOperasi.setSelectedItem(rs2.getString("golonganOperasi"));
                        urgensiOps.setSelectedItem(rs2.getString("urgensiOps"));
                        macamOperasi.setSelectedItem(rs2.getString("macamOperasi"));

                        waktuAnastesi.setText(rs2.getString("waktuAnastesi"));
                        selesaiAnastesi.setText(rs2.getString("selesaiAnastesi"));

                        noKo1.setText(rs2.getString("noKo"));
                        ronde1.setText(rs2.getString("ronde"));

                        persiapanOps.setText(rs2.getString("persiapanOps"));
                        posisiPasien.setText(rs2.getString("posisiPasien"));
                        desinfeksi.setText(rs2.getString("desinfeksi"));
                        dilakukan.setText(rs2.getString("dilakukan"));
                    }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
            ...
            "tanggal='" + new java.sql.Timestamp(tgl.getDate().getTime()) + "'," +
            "diagnosa_preop='" + PreOp.getText() + "'," +
            "diagnosa_postop='" + PostOp.getText() + "'," +
            "jaringan_dieksekusi='" + Jaringan.getText() + "'," +
            "selesaioperasi='" + new java.sql.Timestamp(tgl2.getDate().getTime()) + "'," +
            "permintaan_pa='" + DikirimPA.getSelectedItem() + "'," +
            "laporan_operasi='" + Laporan1.getText() + "'," +
            "icd9='" + icd9.getText() + "'," +
            "jnsAnastesi='" + jnsAnastesi.getText() + "'," +
            "bahanAnastesi='" + bahanAnastesi.getText() + "'," +
            "golonganOperasi='" + golonganOperasi.getSelectedItem() + "'," +
            "urgensiOps='" + urgensiOps.getSelectedItem() + "'," +
            "macamOperasi='" + macamOperasi.getSelectedItem() + "'," +
            "waktuAnastesi='" + waktuAnastesi.getText() + "'," +
            "selesaiAnastesi='" + selesaiAnastesi.getText() + "'," +
            "noKo='" + noKo1.getText() + "'," +
            "ronde='" + ronde1.getText() + "'," +
            "persiapanOps='" + persiapanOps.getText() + "'," +
            "posisiPasien='" + posisiPasien.getText() + "'," +
            "desinfeksi='" + desinfeksi.getText() + "'," +
            "dilakukan='" + dilakukan.getText() + "' " +
            "WHERE no_rawat='" + TNoRw.getText() + "'";

       try {
            System.out.println("=== SQL UPDATE LAPORAN OPERASI ===");
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,"Update gagal, cek console");
        }
    ...
    private void PreOp3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PreOp3KeyPressed
        Valid.pindah(evt,tgl2,PostOp2);
    }//GEN-LAST:event_PreOp3KeyPressed

    private void PostOp2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PostOp2KeyPressed
        Valid.pindah(evt,PreOp3,Jaringan);
    }//GEN-LAST:event_PostOp2KeyPressed

    private void JaringanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JaringanKeyPressed
        Valid.pindah(evt,PostOp2,DikirimPA2);
    }//GEN-LAST:event_JaringanKeyPressed

    private void DikirimPA2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DikirimPA2KeyPressed
        Valid.pindah(evt,Jaringan,Laporan);
    }//GEN-LAST:event_DikirimPA2KeyPressed
        ...
        template.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(template.getTable().getSelectedRow()!= -1){  
                    PreOp3.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),2).toString());
                    PostOp2.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),3).toString());
                    Jaringan.setText(template.getTable().getValueAt(template.getTable().getSelectedRow(),4).toString());
                    DikirimPA2.setSelectedItem(template.getTable().getValueAt(template.getTable().getSelectedRow(),5).toString());
...
//        Valid.pindah(evt,TCariPaket,jenis);
    ...
    private void tgl3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tgl3KeyPressed
        Valid.pindah(evt,kdonloop5,PreOp3);
    ...
    private void Jaringan1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Jaringan1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Jaringan1KeyPressed
    ...
    */
    ...
    private widget.ComboBox DikirimPA2;
    private widget.panelisi FormInput;
    private widget.TextBox Jaringan;
    private widget.TextBox Jaringan1;
    ...
    private widget.TextBox PostOp2;
    private widget.TextBox PreOp;
    private widget.TextBox PreOp3;
        ...
        try{
            ...
            while(rs.next()){
                ...
                tabMode.addRow(new Object[]{
                    ...
                    "Perawatan","Kru OK","Instrumen","Dokter Anak",
                    "Dokter Anestesi","Perawat Luar","Sewa OK/VK","Alat","Akomodasi","Sarpras","Dokter PJ Anak","Dokter Umum","Biaya Perawatan",
                ...
                while(rs2.next()){
                     double kruOK = 
                safeGetDouble(rs2, "biayaasisten_operator1") +
                safeGetDouble(rs2, "biayaasisten_operator2") +
                safeGetDouble(rs2, "biayaasisten_operator3") +
                safeGetDouble(rs2, "biayaasisten_anestesi") +
                safeGetDouble(rs2, "biayaasisten_anestesi2")+
                safeGetDouble(rs2, "biayabidan")+
                safeGetDouble(rs2, "biayabidan2")+
                safeGetDouble(rs2, "biayabidan3")+
                safeGetDouble(rs2, "biaya_omloop")+
                safeGetDouble(rs2, "biaya_omloop2")+
                safeGetDouble(rs2, "biaya_omloop3")+
                safeGetDouble(rs2, "biaya_omloop4")+
                safeGetDouble(rs2, "biaya_omloop5")+ safeGetDouble(rs2, "biayaperawaat_resusitas")+ safeGetDouble(rs2, "bagian_rs")
                    ;
    ...
    public void setPasien(String pasien, Date tanggal){
     ...
     private double safeGetDouble(ResultSet rs, String columnLabel) throws SQLException {
    ...
    try {
        ...
        // kalau ada format aneh lain, anggap saja 0 biar tidak meledak
        return 0.0;
    }
}
