...
public final class DlgJnsPerawatanOperasi extends javax.swing.JDialog {
    ...
    public DlgJnsPerawatanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        TAsisOperator2.setVisible(false);
         jLabel35.setVisible(false);
        TAsisOperator3.setVisible(false);
         jLabel15.setVisible(false);
        TAsisAnastesi.setVisible(false);
         jLabel36.setVisible(false);
        TAsisAnastesi1.setVisible(false);
         jLabel23.setVisible(false);
         TBidan1.setVisible(false);
         jLabel27.setVisible(false);
         TBidan2.setVisible(false);
         jLabel28.setVisible(false);
         TBidan3.setVisible(false);
         jLabel26.setVisible(false);
         TOmloop1.setVisible(false);
         jLabel29.setVisible(false);
         TOmloop2.setVisible(false);
         jLabel30.setVisible(false);
         TOmloop3.setVisible(false);
         jLabel37.setVisible(false);
         TOmloop4.setVisible(false);
         jLabel38.setVisible(false);
         TOmloop5.setVisible(false);
         jLabel22.setVisible(false);
         TResusitas.setVisible(false);
         
         jLabel24.setVisible(false);
         TBagianRS.setVisible(false);
         
         
         
         int shift = jLabel25.getY() - jLabel19.getY(); 

     

        geserKeAtas(jLabel25, shift);
        geserKeAtas(TAkomodasi, shift);

        geserKeAtas(jLabel10, shift);
         geserKeAtas(TSewaOK, shift);
      
        geserKeAtas(jLabel11, shift);
        geserKeAtas(TPerawatLuar, shift);

        geserKeAtas(jLabel31, shift);
        geserKeAtas(TSarpras, shift);
        
         java.awt.Rectangle lblSar = jLabel31.getBounds();   
        java.awt.Rectangle txtSar = TSarpras.getBounds();  

        
        int yTotal = txtSar.y + txtSar.height + 8; 

        jLabel16.setBounds(lblSar.x, yTotal, lblSar.width, lblSar.height); 
        TTotal.setBounds(txtSar.x, yTotal, txtSar.width, txtSar.height);   

      
        int yKelas = yTotal + TTotal.getHeight() + 6;      

        jLabel5.setBounds(lblSar.x, yKelas, jLabel5.getWidth(), jLabel5.getHeight());
        Kelas.setBounds(txtSar.x, yKelas, Kelas.getWidth(), Kelas.getHeight());
        int targetYAlat = TAnak.getY() + TAnak.getHeight() + 6;

        // selisih geser = posisi sekarang - posisi yang diinginkan
        int shiftAlat = TAlat.getY() - targetYAlat;

        // pakai helper geserKeAtas yang sudah kamu punya
        geserKeAtas(jLabel13, shiftAlat);  // label "Alat : Rp"
        geserKeAtas(TAlat,    shiftAlat);  // textbox Alat
        this.setLocation(8,1);
        setSize(628,674);
        
        java.awt.Rectangle rLblAlat = jLabel13.getBounds();   // label "Alat : Rp"
        java.awt.Rectangle rTxtAlat = TAlat.getBounds();      // textbox Alat

        // berapa jarak antar baris
        int jarakBaris = 6;

        // ============= 1) INSTRUMEN di bawah ALAT =============
        int yInstr = rLblAlat.y + rLblAlat.height + jarakBaris;

        java.awt.Rectangle rLblInstr = jLabel20.getBounds();   // label "Instrumen : Rp"
        java.awt.Rectangle rTxtInstr = TInstrumen.getBounds(); // textbox Instrumen
        ...
        // ============= 2) dr UMUM di bawah INSTRUMEN =============
        int yUmum = yInstr + rLblInstr.height + jarakBaris;

        java.awt.Rectangle rLblUmum = jLabel32.getBounds();   // label "dr Umum : Rp"
        java.awt.Rectangle rTxtUmum = TdrUmum.getBounds();    // textbox dr Umum
        ...
        // ============= 3) dr Pj Anak di bawah dr UMUM =============
        int yPjAnak = yUmum + rLblUmum.height + jarakBaris;

        java.awt.Rectangle rLblPjAnak = jLabel33.getBounds();   // label "dr Pj Anak : Rp"
        java.awt.Rectangle rTxtPjAnak = TdrPJAnak.getBounds();  // textbox dr Pj Anak
        ...
        Object[] row={"P","Kode Paket","Nama Operasi","Kategori","Operator 1","Operator 2","Operator 3",
                      "Kru OK","Instrumen","dr Anestesi","dr Anak",
                      "Perawat Luar","Alat","Sewa OK/VK",
                      "Akomodasi","Sarpras","dr Pj Anak","dr Umum",
        ...
        Class[] types = new Class[] {
                    ...
                    java.lang.Object.class,  // 1  Kode Paket
                    java.lang.Object.class,  // 2  Nama Operasi
                    java.lang.Object.class,  // 3  Kategori
                    java.lang.Double.class,  // 4  Operator 1
                    java.lang.Double.class,  // 5  Operator 2
                    java.lang.Double.class,  // 6  Operator 3
                    java.lang.Double.class,  // 7  Kru OK
                    java.lang.Double.class,  // 8  Instrumen
                    java.lang.Double.class,  // 9  dr Anestesi
                    java.lang.Double.class,  // 10 dr Anak
            
                    java.lang.Double.class,  // 15 Perawat Luar
                    java.lang.Double.class,  // 16 Alat
                    java.lang.Double.class,  // 17 Sewa OK/VK
                    java.lang.Double.class,  // 18 Akomodasi
                   
                    java.lang.Double.class,  // 25 Sarpras
                    java.lang.Double.class,  // 26 dr Pj Anak
                    java.lang.Double.class,  // 27 dr Umum
                    java.lang.Double.class,  // 28 Total
                    java.lang.String.class,  // 29 Jenis Bayar
                    java.lang.String.class   // 30 Kelas
                };
       ...
       int colCount = tbJnsPerawatan.getColumnCount();  // harusnya 31
        ...
        for (i = 0; i < colCount; i++) {
            ...
            if (i == 0) {
                ...
                column.setPreferredWidth(90);   // Kode Paket
            } else if (i == 2) {
                column.setPreferredWidth(220);  // Nama Operasi
            } else if (i == 3) {
                column.setPreferredWidth(100);  // Kategori
            } else if (i == 29) {
                column.setPreferredWidth(200);  // Jenis Bayar
            } else if (i == 30) {
                column.setPreferredWidth(70);   // Kelas
            } else {
                column.setPreferredWidth(85);   // kolom lain
            }
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TAsisOperator1,"Kru OK");
        }
        ...
        if(tabMode.getRowCount()!=0){
            try {
                ...
                if(evt.getClickCount()==2){
                    ...
                    Kelas.setSelectedItem(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),21).toString());
                }
...
private void TOmloop1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TOmloop1KeyPressed
    ...
    */
    ...
    private void tampil() {
        ...
        while (rs.next()) { 
            double kruOK = 
                safeGetDouble(rs, "asisten_operator1") +
                safeGetDouble(rs, "asisten_operator2") +
                safeGetDouble(rs, "asisten_operator3") +
                safeGetDouble(rs, "asisten_anestesi") +
                safeGetDouble(rs, "asisten_anestesi2")+
                safeGetDouble(rs, "bidan")+
                safeGetDouble(rs, "bidan2")+
                safeGetDouble(rs, "bidan3")+
                safeGetDouble(rs, "omloop")+
                safeGetDouble(rs, "omloop2")+
                safeGetDouble(rs, "omloop3")+
                safeGetDouble(rs, "omloop4")+
                safeGetDouble(rs, "omloop5")+ safeGetDouble(rs, "perawaat_resusitas")+safeGetDouble(rs, "bagian_rs")
                    ;
            ...
            tabMode.addRow(new Object[]{
                ...
                safeGetDouble(rs, "operator1"),      
                safeGetDouble(rs, "operator2"),      
                safeGetDouble(rs, "operator3"),      
                kruOK,                                

                safeGetDouble(rs, "instrumen"),       
                safeGetDouble(rs, "dokter_anestesi"),
                safeGetDouble(rs, "dokter_anak"),     
            
                safeGetDouble(rs, "perawat_luar"),   
                safeGetDouble(rs, "alat"),            
                safeGetDouble(rs, "sewa_ok"),         
                safeGetDouble(rs, "akomodasi"),       
                      
                 
                safeGetDouble(rs, "sarpras"),         
                safeGetDouble(rs, "dokter_pjanak"),  
                safeGetDouble(rs, "dokter_umum"),     
                safeGetDouble(rs, "jumlah"),         
   ...
   private void getData() {
    if (tbJnsPerawatan.getSelectedRow() != -1) {
        ...
        TNm.setText(tbJnsPerawatan.getValueAt(row, 2).toString());
        Kategori.setSelectedItem(tbJnsPerawatan.getValueAt(row, 3).toString());

     
        TOperator1.setText(getAngkaKolom(4));
        TOperator2.setText(getAngkaKolom(5));
        TOperator3.setText(getAngkaKolom(6));

        
        TAsisOperator1.setText(getAngkaKolom(7));
        ...
        TInstrumen.setText(getAngkaKolom(8));

       
        TAnastesi.setText(getAngkaKolom(9));

       
        TAnak.setText(getAngkaKolom(10));

      
//        TResusitas.setText(getAngkaKolom(11));

        
//        TBidan1.setText(getAngkaKolom(12));
//        TBidan2.setText(getAngkaKolom(13));
//        TBidan3.setText(getAngkaKolom(14));

      
        TPerawatLuar.setText(getAngkaKolom(11));

        
        TAlat.setText(getAngkaKolom(12));

       
        TSewaOK.setText(getAngkaKolom(13));

       
        TAkomodasi.setText(getAngkaKolom(14));

        
//        TBagianRS.setText(getAngkaKolom(15));

//     
//        TOmloop1.setText(getAngkaKolom(20));
//        TOmloop2.setText(getAngkaKolom(21));
//        TOmloop3.setText(getAngkaKolom(22));
//        TOmloop4.setText(getAngkaKolom(23));
//        TOmloop5.setText(getAngkaKolom(24));

        
        TSarpras.setText(getAngkaKolom(15));

        
        TdrPJAnak.setText(getAngkaKolom(16));

      
        TdrUmum.setText(getAngkaKolom(17));

        
        TTotal.setText(getAngkaKolom(18));

       
        Sequel.cariIsi(
            "select kd_pj from paket_operasi where kode_paket=?",
            kdpnj,
            tbJnsPerawatan.getValueAt(row, 1).toString()
        );
        nmpnj.setText(tbJnsPerawatan.getValueAt(row, 19).toString());
       
    }
}

private String getAngkaKolom(int colIndex) {
    int row = tbJnsPerawatan.getSelectedRow();
    if (row < 0) {
        return "0";
    }

    Object v = tbJnsPerawatan.getValueAt(row, colIndex);
    if (v == null) {
        return "0";
    }
    ...
    try {
        ...
        return Valid.SetAngka2(d);
    } catch (NumberFormatException e) {
        // kalau ada format aneh, jangan bikin error, anggap 0
        return "0";
    }
}
...
//        }
 ...
 private void geserKeAtas(javax.swing.JComponent comp, int deltaY) {
        java.awt.Rectangle b = comp.getBounds();
        comp.setBounds(b.x, b.y - deltaY, b.width, b.height);
    }
...
private void pindahBaris(javax.swing.JLabel label, javax.swing.JComponent field, int y) {
    java.awt.Rectangle b1 = label.getBounds();
    java.awt.Rectangle b2 = field.getBounds();

    label.setBounds(b1.x, y, b1.width, b1.height);
    field.setBounds(b2.x, y, b2.width, b2.height);
}
