...
public class MasterTemplatePemeriksaanDokter extends javax.swing.JDialog {
    private final DefaultTableModel tabMode,tabModeRadiologi,tabModePK,tabModeDetailPK,tabModeObatUmum,tabModeObatRacikan,tabModeDetailObatRacikan,
                tabModePA,tabModeMB,tabModeDetailMB,TabModeTindakan,TabModeTindakanInap;
    ...
    private widget.Label jLabelOperasi;
    ...
    public MasterTemplatePemeriksaanDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Template","Nama Paket","Jenis Paket","Billing Paket","Diskon"};
      ...
      FormInput.setLayout(null);
        ...
        FormInput.setPreferredSize(new Dimension(900, 3300));

        // Label
        jLabelOperasi = new widget.Label();
        jLabelOperasi.setText("Operasi :");
        jLabelOperasi.setName("jLabelOperasi");
        FormInput.add(jLabelOperasi);
        jLabelOperasi.setBounds(20, 2360, 270, 23);

      
        tbOperasi = new widget.Table();        
        tbOperasi.setName("tbOperasi");

       
        Scroll12 = new widget.ScrollPane();
        Scroll12.setName("Scroll12");
        Scroll12.setOpaque(true);
        Scroll12.setBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.GRAY, 1));

        Scroll12.setViewportView(tbOperasi);
        FormInput.add(Scroll12);
        Scroll12.setBounds(20, 2380, 700, 120); 

        
        DefaultTableModel model = new DefaultTableModel(
            new Object[][]{},
            new String[]{"Kode Operasi", "Kru OK", "Sewa Alat", "Sewa OK", "Instrumen"}
        ) {
            @Override public boolean isCellEditable(int r, int c) { return true; }
            @Override public Class<?> getColumnClass(int c) { return c == 4 ? Double.class : String.class; }
        };
        tbOperasi.setModel(model);
        tbOperasi.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tbOperasi.getColumnModel().getColumn(0).setPreferredWidth(200);
        tbOperasi.getColumnModel().getColumn(1).setPreferredWidth(120);
        tbOperasi.getColumnModel().getColumn(2).setPreferredWidth(120);
        tbOperasi.getColumnModel().getColumn(3).setPreferredWidth(120);
        tbOperasi.getColumnModel().getColumn(4).setPreferredWidth(80);
        ...
        tbOperasi.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                int col = tbOperasi.getSelectedColumn();
                if (row >= 0 && col >= 0) {
                    // pastikan cell selection diaktifkan agar editCellAt bekerja mulus
                    tbOperasi.setRowSelectionAllowed(true);
                    tbOperasi.setColumnSelectionAllowed(true);
                    tbOperasi.setCellSelectionEnabled(true);

                    tbOperasi.editCellAt(row, col);
                    Component editor = tbOperasi.getEditorComponent();
       ...
       Container parentContainer = FormInput.getParent();

        if (parentContainer instanceof JViewport) {
            JScrollPane topScroll = (JScrollPane) SwingUtilities.getAncestorOfClass(JScrollPane.class, parentContainer);
            if (topScroll != null) {
                // scroll ke koordinat Y lokasi operasinya agar langsung terlihat saat testing
                JScrollBar vsb = topScroll.getVerticalScrollBar();
                vsb.setValue(2300); // geser ke dekat posisi operasinya
            }
        }
        ...
        TabModeTindakanInap=new DefaultTableModel(null,new Object[]{
                "P","Kode","Nama Perawatan/Tindakan","Kategori"
            }){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
        ...
        tbTindakanInap.setModel(TabModeTindakanInap);
        tbTindakanInap.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbTindakanInap.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        for (i = 0; i < 4; i++) {
            TableColumn column = tbTindakanInap.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(20);
            }else if(i==1){
                column.setPreferredWidth(90);
        ...
        tbTindakanInap.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        Diskon.setDocument(new batasInput((int)200).getKata(Diskon));   
        ...
        CariTindakanInap.setDocument(new batasInput((byte)100).getKata(CariTindakanInap)); 
    ...
    private void initComponents() {
        ...
        CariTindakanInap = new widget.TextBox();
        BtnCariTindakanInap = new widget.Button();
        Scroll14 = new widget.ScrollPane();
        tbTindakanInap = new widget.Table();
        BtnAllTindakanInap = new widget.Button();
        ...
        scrollInput.setPreferredSize(new java.awt.Dimension(102, 2370));

        FormInput.setBackground(new java.awt.Color(255, 255, 255));
        FormInput.setBorder(null);
        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(730, 2355));
        FormInput.setLayout(null);
        ...
        FormInput.add(Kd);
        Kd.setBounds(90, 10, 220, 23);

        jLabel40.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel40.setText("Judul Pemeriksaan :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(20, 50, 410, 20);
        ...
        scrollPane2.setBounds(20, 70, 700, 40);

        jLabel41.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel41.setText("Jenis Pemeriksaan :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(20, 110, 410, 20);
        ...
        scrollPane3.setBounds(20, 130, 700, 40);
        ...
        BtnCariRadiologi.setBounds(660, 200, 28, 23);
        ...
        Scroll3.setBounds(20, 230, 700, 116);
        ...
        CariPK.setBounds(20, 370, 640, 23);
        ...
        BtnCariLaboratoriumPK.setBounds(660, 370, 28, 23);
        ...
        Scroll4.setBounds(20, 400, 700, 109);
        ...
        Scroll5.setBounds(20, 540, 700, 216);
        ...
        CariDetailPK.setBounds(20, 510, 640, 23);
        ...
        BtnDetailLaboratPK.setBounds(660, 510, 28, 23);

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("Permintaan Laborat Patologi Anatomi :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(20, 760, 250, 23);
        ...
        CariPA.setBounds(20, 780, 640, 23);
        ...
        BtnCariPA.setBounds(660, 780, 28, 23);
        ...
        CariMB.setBounds(20, 960, 640, 23);
        ...
        BtnCariMB.setBounds(660, 960, 28, 23);
        ...
        Scroll7.setBounds(20, 980, 700, 109);
        ...
        CariDetailMB.setBounds(20, 1100, 640, 23);
        ...
        BtnCariDetailMB.setBounds(660, 1100, 28, 23);
        ...
        Scroll8.setBounds(20, 1120, 700, 216);

        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel21.setText("Tindakan Rawat Jalan :");
        jLabel21.setName("jLabel21"); // NOI18N
        FormInput.add(jLabel21);
        jLabel21.setBounds(20, 1350, 120, 23);
        ...
        CariTindakan.setBounds(20, 1370, 640, 23);
        ...
        BtnCariTindakan.setBounds(660, 1370, 28, 23);
        ...
        FormInput.add(Scroll12);
        Scroll12.setBounds(20, 1400, 700, 116);
        ...
        BtnAllRadiologi.setBounds(690, 200, 28, 23);
        ...
        BtnAllPatologiKlinis.setBounds(690, 370, 28, 23);
        ...
        BtnAllDetailLaboratPK.setBounds(690, 510, 28, 23);
        ...
        BtnAllPA.setBounds(690, 780, 28, 23);
        ...
        BtnAllMB.setBounds(690, 960, 28, 23);
        ...
        BtnAllDetailMB.setBounds(690, 1100, 28, 23);
        ...
        BtnAllTindakan.setBounds(690, 1370, 28, 23);

        label13.setText("Diskon :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(75, 23));
        FormInput.add(label13);
        label13.setBounds(340, 10, 40, 23);

        Rajal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Rawat Jalan", "Rawat Inap" }));
        ...
        FormInput.add(Rajal);
        Rajal.setBounds(600, 10, 120, 20);

        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel22.setText("Tindakan Rawat Inap :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(20, 1530, 120, 23);

        CariTindakanInap.setHighlighter(null);
        CariTindakanInap.setName("CariTindakanInap"); // NOI18N
        CariTindakanInap.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CariTindakanInapKeyPressed(evt);
            }
        });
        FormInput.add(CariTindakanInap);
        CariTindakanInap.setBounds(20, 1550, 640, 23);

        BtnCariTindakanInap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept.png"))); // NOI18N
        BtnCariTindakanInap.setMnemonic('1');
        BtnCariTindakanInap.setToolTipText("Alt+1");
        BtnCariTindakanInap.setName("BtnCariTindakanInap"); // NOI18N
        BtnCariTindakanInap.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnCariTindakanInap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCariTindakanInapActionPerformed(evt);
            }
        });
        FormInput.add(BtnCariTindakanInap);
        BtnCariTindakanInap.setBounds(660, 1550, 28, 23);
        ...
        tbTindakanInap.setName("tbTindakanInap"); // NOI18N
        Scroll14.setViewportView(tbTindakanInap);

        FormInput.add(Scroll14);
        Scroll14.setBounds(20, 1580, 700, 116);

        BtnAllTindakanInap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Search-16x16.png"))); // NOI18N
        BtnAllTindakanInap.setMnemonic('2');
        BtnAllTindakanInap.setToolTipText("Alt+2");
        BtnAllTindakanInap.setName("BtnAllTindakanInap"); // NOI18N
        BtnAllTindakanInap.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnAllTindakanInap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAllTindakanInapActionPerformed(evt);
            }
        });
        FormInput.add(BtnAllTindakanInap);
        BtnAllTindakanInap.setBounds(690, 1550, 28, 23);

        jLabel19.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel19.setText("Obat Non Racikan :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(20, 1710, 270, 23);
        ...
        BtnCariObatNonRacikan.setBounds(660, 1730, 28, 23);
        ...
        CariObatNonRacikan.setBounds(20, 1730, 640, 23);
        ...
        Scroll9.setBounds(20, 1760, 700, 216);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("Obat Racikan :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(20, 1980, 270, 23);
        ...
        Scroll10.setBounds(20, 2000, 700, 96);
        ...
        CariObatRacikan.setBounds(20, 2100, 580, 23);
        ...
        BtnCariObatRacikan.setBounds(600, 2100, 28, 23);
        ...
        Scroll11.setBounds(20, 2130, 700, 216);
        ...
        BtnAllObatNonRacikan.setBounds(690, 1730, 28, 23);
        ...
        BtnAllObatRacikan.setBounds(630, 2100, 28, 23);
        ...
        BtnTambah1.setBounds(660, 2100, 28, 23);
        ...
        BtnHapus1.setBounds(690, 2100, 28, 23);
        ...
        FormInput.add(Diskon);
        Diskon.setBounds(390, 10, 180, 23);

        label14.setText("No.Template :");
        label14.setName("label14"); // NOI18N
        label14.setPreferredSize(new java.awt.Dimension(75, 23));
        FormInput.add(label14);
        label14.setBounds(0, 10, 85, 23);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            Valid.textKosong(Kd,"Nama Paket");
...
//            Valid.textKosong(Asesmen,"Asesmen");
            ...
            if(Sequel.menyimpantf("template_pemeriksaan_dokter","?,?,?,?,?","No.Template",5,new String[]{
                Kd.getText(),Subjek.getText(),Objek.getText(),Rajal.getSelectedItem().toString(),Diskon.getText()
            })==true){
//                index=1;
...
//                }
                ...
                for(i=0;i<tbTindakanInap.getRowCount();i++){ 
                    if(tbTindakanInap.getValueAt(i,0).toString().equals("true")){
                        Sequel.menyimpan("template_pemeriksaan_dokter_tindakan_inap","?,?","Tindakan Dokter",2,new String[]{
                            Kd.getText(),tbTindakanInap.getValueAt(i,1).toString()
                        });
                    }
                }
               if (tbOperasi.isEditing()) {
                    try {
                        tbOperasi.getCellEditor().stopCellEditing();
                    } catch (Exception ex) {
            ...
            String insertSql = "INSERT INTO template_pemeriksaan_dokter_operasi "
                    + "(kd_template, nama_operasi, tarif_kru_ok, tarif_sewa_alat, tarif_sewa_ok, tarif_instrumen) "
                    + "VALUES (?, ?, ?, ?, ?, ?)";

            PreparedStatement psInsert = null;
            boolean previousAutoCommit = true;
            try {
                previousAutoCommit = koneksi.getAutoCommit();
                koneksi.setAutoCommit(false);
                psInsert = koneksi.prepareStatement(insertSql);

                for (int i = 0; i < tbOperasi.getRowCount(); i++) {
                    String namaOperasi = tbOperasi.getValueAt(i, 0) != null ? tbOperasi.getValueAt(i, 0).toString().trim() : "";

                    String sKru   = tbOperasi.getValueAt(i, 1) != null ? tbOperasi.getValueAt(i, 1).toString().trim() : "";
                    String sSewaA = tbOperasi.getValueAt(i, 2) != null ? tbOperasi.getValueAt(i, 2).toString().trim() : "";
                    String sSewaO = tbOperasi.getValueAt(i, 3) != null ? tbOperasi.getValueAt(i, 3).toString().trim() : "";
                    String sInstr = tbOperasi.getValueAt(i, 4) != null ? tbOperasi.getValueAt(i, 4).toString().trim() : "";

                    
                    if (namaOperasi.equals("") && sKru.equals("") && sSewaA.equals("") && sSewaO.equals("") && sInstr.equals("")) {
                        continue;
                    }

                  
                    java.util.function.Function<String, Double> parseSmartDouble = (s) -> {
                        if (s == null) return 0.0;
                        String t = s.trim();
                        if (t.equals("")) return 0.0;
                        ...
                        try {
                            ...
                            t = t.replaceAll("[^0-9\\.-]", "");
                            if (t.equals("") || t.equals(".") || t.equals("-")) return 0.0;
                    ...
                    double tarifKru   = parseSmartDouble.apply(sKru);
                    double tarifSewaA = parseSmartDouble.apply(sSewaA);
                    double tarifSewaO = parseSmartDouble.apply(sSewaO);
                    double tarifInstr = parseSmartDouble.apply(sInstr);

                  
                    psInsert.setString(1, Kd.getText());
                    psInsert.setString(2, namaOperasi);
                    psInsert.setDouble(3, tarifKru);
                    psInsert.setDouble(4, tarifSewaA);
                    psInsert.setDouble(5, tarifSewaO);
                    psInsert.setDouble(6, tarifInstr);
                ...
                try { koneksi.rollback(); } catch (SQLException e2) { e2.printStackTrace(); }
                ex.printStackTrace();
                JOptionPane.showMessageDialog(this, "Gagal menyimpan operasi:\n" + ex.getMessage(), "Notifikasi", JOptionPane.ERROR_MESSAGE);
            } finally {
                try {
                    if (psInsert != null) psInsert.close();
                    koneksi.setAutoCommit(previousAutoCommit);
...
*/
    ...
    private void ObjekKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ObjekKeyPressed
        Valid.pindah2(evt,Subjek,CariRadiologi);
    ...
    private void CariTindakanInapKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CariTindakanInapKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            tampilTindakanInap2();
        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            BtnSimpan.requestFocus();
...
//            CariObatRacikan.requestFocus();
    ...
    }//GEN-LAST:event_CariTindakanInapKeyPressed

    private void BtnCariTindakanInapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariTindakanInapActionPerformed
        tampilTindakanInap2();// TODO add your handling code here:
    }//GEN-LAST:event_BtnCariTindakanInapActionPerformed

    private void BtnAllTindakanInapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllTindakanInapActionPerformed
        CariTindakanInap.setText("");
        tampilTindakanInap();
        tampilTindakanInap2();// TODO add your handling code here:
    }//GEN-LAST:event_BtnAllTindakanInapActionPerformed
    ...
    */
    ...
    private widget.Button BtnAllTindakanInap;
    ...
    private widget.Button BtnCariTindakanInap;
    ...
    public widget.TextBox CariTindakanInap;
    ...
    public widget.Table tbTindakanInap;
        ...
        try{
            if(akses.getkode().equals("Admin Utama")){
                ps=koneksi.prepareStatement(
                        "select template_pemeriksaan_dokter.no_template, template_pemeriksaan_dokter.judul, " +
                        "template_pemeriksaan_dokter.jenis, template_pemeriksaan_dokter.tipe, template_pemeriksaan_dokter.besar_pengurangan " +
                        "from template_pemeriksaan_dokter " +
                        (TCari.getText().equals("") ? "" : 
                            "where template_pemeriksaan_dokter.no_template like ? or " +
                            "template_pemeriksaan_dokter.judul like ? or " +
                            "template_pemeriksaan_dokter.jenis like ? or " +
                            "template_pemeriksaan_dokter.tipe like ? " +
                            "template_pemeriksaan_dokter.besar_pengurangan like ? ") +
...
//                        ps.setString(7,"%"+TCari.getText().trim()+"%");
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("no_template"),rs.getString("judul"),rs.getString("jenis"),rs.getString("tipe"),rs.getString("besar_pengurangan")
                    });
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        Valid.tabelKosong(TabModeTindakanInap);
    ...
    private void getData() {
        if(tbDokter.getSelectedRow() != -1 && tabMode.getColumnCount() >= 4){
            Kd.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),0).toString());
            Subjek.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),1).toString());
            Objek.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),2).toString());
            Rajal.setSelectedItem(tabMode.getValueAt(tbDokter.getSelectedRow(),3).toString());
            Diskon.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),4).toString());
        }
    }
    ...
    private void tampilTindakanInap() {         
        try{
            file=new File("./cache/permintaantindakaninap.iyem");
            file.createNewFile();
            fileWriter = new FileWriter(file);
            StringBuilder iyembuilder = new StringBuilder();
        
            ps=koneksi.prepareStatement(
                    "select jns_perawatan_inap.kd_jenis_prw,jns_perawatan_inap.nm_perawatan,kategori_perawatan.nm_kategori from jns_perawatan_inap inner join kategori_perawatan "+
                    "on jns_perawatan_inap.kd_kategori=kategori_perawatan.kd_kategori where jns_perawatan_inap.status='1' and jns_perawatan_inap.total_byrdr>0 order by jns_perawatan_inap.kd_jenis_prw");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
                    iyembuilder.append("{\"KodePeriksa\":\"").append(rs.getString(1)).append("\",\"NamaPemeriksaan\":\"").append(rs.getString(2).replaceAll("\"","")).append("\",\"Kategori\":\"").append(rs.getString(3).replaceAll("\"","")).append("\"},");
            ...
            if (iyembuilder.length() > 0) {
                iyembuilder.setLength(iyembuilder.length() - 1);
                fileWriter.write("{\"permintaantindakaninap\":["+iyembuilder+"]}");
                fileWriter.flush();
            }
    ...
    private void tampilTindakanInap2() {         
        try{
            jml=0;
            for(i=0;i<tbTindakanInap.getRowCount();i++){
                if(tbTindakanInap.getValueAt(i,0).toString().equals("true")){
            ...
            for(i=0;i<tbTindakanInap.getRowCount();i++){
                if(tbTindakanInap.getValueAt(i,0).toString().equals("true")){
                    pilih[index]=true;
                    kode[index]=tbTindakanInap.getValueAt(i,1).toString();
                    nama[index]=tbTindakanInap.getValueAt(i,2).toString();
                    kategori[index]=tbTindakanInap.getValueAt(i,3).toString();
                    index++;
                }
            }
            ...
            Valid.tabelKosong(TabModeTindakanInap);
            for(i=0;i<jml;i++){                
                TabModeTindakanInap.addRow(new Object[] {pilih[i],kode[i],nama[i],kategori[i]});
            }  
            ...
            myObj = new FileReader("./cache/permintaantindakaninap.iyem");
            root = mapper.readTree(myObj);
            response = root.path("permintaantindakaninap");
            if(response.isArray()){
                for(JsonNode list:response){
                    if((list.path("KodePeriksa").asText().toLowerCase().contains(CariTindakanInap.getText().toLowerCase())||
                        list.path("NamaPemeriksaan").asText().toLowerCase().contains(CariTindakanInap.getText().toLowerCase())||
                        list.path("Kategori").asText().toLowerCase().contains(CariTindakanInap.getText().toLowerCase()))){
                        TabModeTindakanInap.addRow(new Object[]{
                            false,list.path("KodePeriksa").asText(),list.path("NamaPemeriksaan").asText(),list.path("Kategori").asText()
                        });
                    }
                }
    ...
    if (FormDetail.isVisible() == true) {
        if (tbDokter.getSelectedRow() != -1) {
            try {
                // 1. Inisialisasi StringBuilder
                htmlContent = new StringBuilder();
                
                // 2. Tambahkan Informasi Dasar (Subjek, Objek, Rajal, Diskon)
                htmlContent.append(
                    "<tr class='isi'>").append(
                        "<td valign='top' align='left' width='100%'>").append(
                            "Subjek : ").append(tabMode.getValueAt(tbDokter.getSelectedRow(), 1).toString()).append(
                        "</td>").append(
                    "</tr>").append(
                    "<tr class='isi'>").append(
                        "<td valign='top' align='left' width='100%'>").append(
                            "Objek : ").append(tabMode.getValueAt(tbDokter.getSelectedRow(), 2).toString()).append(
                        "</td>").append(
                    "</tr>").append(
                    "<tr class='isi'>").append(
                        "<td valign='top' align='left' width='100%'>").append(
                            "Rajal : ").append(tabMode.getValueAt(tbDokter.getSelectedRow(), 3).toString()).append(
                        "</td>").append(
                    "</tr>").append(
                    "<tr class='isi'>").append(
                        "<td valign='top' align='left' width='100%'>").append(
                            "Diskon : ").append(tabMode.getValueAt(tbDokter.getSelectedRow(), 4).toString()).append(
                        "</td>").append(
                    "</tr>"
                );

                // 3. Query Permintaan Radiologi
                ps = koneksi.prepareStatement(
                ...
                // 4. Query Permintaan Laborat PK (Patologi Klinis)
                ps = koneksi.prepareStatement(
                ...
                try {
                        ...
                        do {
                            ...
                            try {
                                ...
                                if (rs2.next()) {
                                    ...
                                    do {
                                        la = ""; ld = ""; pa = ""; pd = "";
                                        if (!rs2.getString("nilai_rujukan_ld").equals("")) ld = "LD : " + rs2.getString("nilai_rujukan_ld");
                                        if (!rs2.getString("nilai_rujukan_la").equals("")) la = ", LA : " + rs2.getString("nilai_rujukan_la");
                                        if (!rs2.getString("nilai_rujukan_pd").equals("")) pd = ", PD : " + rs2.getString("nilai_rujukan_pd");
                                        if (!rs2.getString("nilai_rujukan_pa").equals("")) pa = " PA : " + rs2.getString("nilai_rujukan_pa");
                                    ...
                                    htmlContent.append("</table>").append("</td>").append("</tr>");
                                }
                            } catch (Exception e) {
                                System.out.println("Notif Detail PK : " + e);
                            } finally {
                    ...
                    System.out.println("Notif PK : " + e);
                } finally {
                    if (rs != null) rs.close();
                    if (ps != null) ps.close();
                }

                // 5. Query Permintaan Laborat PA
                ps = koneksi.prepareStatement(
                    "select template_pemeriksaan_dokter_permintaan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan from template_pemeriksaan_dokter_permintaan_lab " +
                    "inner join jns_perawatan_lab on template_pemeriksaan_dokter_permintaan_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw " +
                ...
                try {
                    ...
                    System.out.println("Notif PA : " + e);
                } finally {
                    if (rs != null) rs.close();
                    if (ps != null) ps.close();
                }

                // 6. Query Permintaan Laborat MB
                ps = koneksi.prepareStatement(
                    "select template_pemeriksaan_dokter_permintaan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan from template_pemeriksaan_dokter_permintaan_lab " +
                    "inner join jns_perawatan_lab on template_pemeriksaan_dokter_permintaan_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw " +
                ...
                try {
                            ...
                            try {
                                ...
                                if (rs2.next()) {
                                    ...
                                    do {
                                        ...
                                        if (!rs2.getString("nilai_rujukan_ld").equals("")) ld = "LD : " + rs2.getString("nilai_rujukan_ld");
                                        if (!rs2.getString("nilai_rujukan_la").equals("")) la = ", LA : " + rs2.getString("nilai_rujukan_la");
                                        if (!rs2.getString("nilai_rujukan_pa").equals("")) pd = ", PD : " + rs2.getString("nilai_rujukan_pd");
                                        if (!rs2.getString("nilai_rujukan_pd").equals("")) pa = " PA : " + rs2.getString("nilai_rujukan_pa");
                                ...
                                System.out.println("Notif Detail MB : " + e);
                            } finally {
                                if (rs2 != null) rs2.close();
                                if (ps2 != null) ps2.close();
                            }
                    ...
                    System.out.println("Notif MB : " + e);
                } finally {
                    if (rs != null) rs.close();
                    if (ps != null) ps.close();
                }

                // 7. Query Obat Non Racikan
                ps = koneksi.prepareStatement(
                ...
                try {
                    ...
                    System.out.println("Notif Obat Non Racik : " + e);
                } finally {
                    if (rs != null) rs.close();
                    if (ps != null) ps.close();
                }

                // 8. Query Obat Racikan
                ps = koneksi.prepareStatement(
                ...
                try {
                    ...
                    System.out.println("Notif Obat Racikan : " + e);
                } finally {
                    if (rs != null) rs.close();
                    if (ps != null) ps.close();
                }

                // 9. Query Tindakan Rawat Jalan
                ps = koneksi.prepareStatement(
                ...
                try {
                    ...
                    System.out.println("Notif Tindakan Rajal : " + e);
                } finally {
                    if (rs != null) rs.close();
                    if (ps != null) ps.close();
                }

                // 10. Query Tindakan Rawat Inap
                ps = koneksi.prepareStatement(
                    "select template_pemeriksaan_dokter_tindakan_inap.kd_jenis_prw,jns_perawatan_inap.nm_perawatan,kategori_perawatan.nm_kategori from template_pemeriksaan_dokter_tindakan_inap inner join jns_perawatan_inap " +
                    "on template_pemeriksaan_dokter_tindakan_inap.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw inner join kategori_perawatan on kategori_perawatan.kd_kategori=jns_perawatan_inap.kd_kategori " +
                    "where template_pemeriksaan_dokter_tindakan_inap.no_template=?");
                try {
                    ps.setString(1, tabMode.getValueAt(tbDokter.getSelectedRow(), 0).toString());
                    rs = ps.executeQuery();
                    if (rs.next()) {
                ...
                // 11. Query & Tampilan OPERASI
                PreparedStatement psOp = null;
                ResultSet rsOp = null;
                String templateId = tabMode.getValueAt(tbDokter.getSelectedRow(), 0).toString();

             
                if (tbOperasi != null) {
                   
                    ((DefaultTableModel)tbOperasi.getModel()).setRowCount(0);
                }

                try {
                    String sqlByKd = "SELECT nama_operasi, tarif_kru_ok, tarif_sewa_alat, tarif_sewa_ok, tarif_instrumen " +
                                     "FROM template_pemeriksaan_dokter_operasi WHERE kd_template = ? ORDER BY id";
                    psOp = koneksi.prepareStatement(sqlByKd);
                    psOp.setString(1, templateId);
//                    System.out.println(">>> Cek Query: " + psOp.toString());
                    rsOp = psOp.executeQuery();

                    if (rsOp.next()) {
//                        System.out.println(">>> DATA DITEMUKAN! Memulai loop...");
                        ...
                        htmlContent.append("<tr class='isi'><td valign='top' align='left' width='100%'>")
                                   ...
                                   .append("<tr class='isi'>")
                                   .append("<td valign='middle' bgcolor='#FFFAF8' align='center' width='30%'>Kode Operasi</td>")
                                   .append("<td valign='middle' bgcolor='#FFFAF8' align='center' width='20%'>Kru OK</td>")
                                   .append("<td valign='middle' bgcolor='#FFFAF8' align='center' width='15%'>Sewa Alat</td>")
                                   .append("<td valign='middle' bgcolor='#FFFAF8' align='center' width='15%'>Sewa OK</td>")
                                   .append("<td valign='middle' bgcolor='#FFFAF8' align='center' width='20%'>Tarif Instrumen</td>")
                                   .append("</tr>");

                        do {
                            String namaOp = rsOp.getString("nama_operasi") != null ? rsOp.getString("nama_operasi") : "";
                            
                           
//                             System.out.println("   -> Menemukan Operasi: " + namaOp);
                            
                            double kru = 0.0, sewaA = 0.0, sewaO = 0.0, instr = 0.0;
                            try { kru = rsOp.getDouble("tarif_kru_ok"); } catch (Exception ex) { kru = 0.0; }
                            try { sewaA = rsOp.getDouble("tarif_sewa_alat"); } catch (Exception ex) { sewaA = 0.0; }
                            try { sewaO = rsOp.getDouble("tarif_sewa_ok"); } catch (Exception ex) { sewaO = 0.0; }
                            try { instr = rsOp.getDouble("tarif_instrumen"); } catch (Exception ex) { instr = 0.0; }

                            htmlContent.append("<tr class='isi'>")
                                       .append("<td align='left'>").append(namaOp).append("</td>")
                                       .append("<td align='right'>").append(df.format(kru)).append("</td>")
                                       .append("<td align='right'>").append(df.format(sewaA)).append("</td>")
                                       .append("<td align='right'>").append(df.format(sewaO)).append("</td>")
                                       .append("<td align='right'>").append(df.format(instr)).append("</td>")
                                       .append("</tr>");

                            // 2. UNTUK TABEL GUI (Input Template) -> PAKAI VARIABLE ASLI (Double)
                            if (tbOperasi != null) {
                                ((DefaultTableModel)tbOperasi.getModel()).addRow(new Object[]{
                                    namaOp, 
                                    kru,   
                                    sewaA,
                                    sewaO, 
                    ...
                    if (rsOp != null) try { rsOp.close(); } catch (Exception e) {}
                    if (psOp != null) try { psOp.close(); } catch (Exception e) {}
                }
                // 12. Set HTML ke Komponen Tampilan (LoadHTML)
                LoadHTML.setText(
                    "<html>" +
                ...
                System.out.println("Notif Utama : " + e);
            }
        }
    }
}
    private void ganti(){
        if(Sequel.queryu2tf("delete from template_pemeriksaan_dokter where no_template=?",1,new String[]{
            ...
            if(Sequel.menyimpantf("template_pemeriksaan_dokter","?,?,?,?,?","No.Template",5,new String[]{
                tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),Subjek.getText(),Objek.getText(),Rajal.getSelectedItem().toString(),Diskon.getText()
            })==true){
                for(i=0;i<tbPermintaanRadiologi.getRowCount();i++){ 
                    if(tbPermintaanRadiologi.getValueAt(i,0).toString().equals("true")){
                        Sequel.menyimpan("template_pemeriksaan_dokter_permintaan_radiologi","?,?","Pemeriksaan Radiologi",2,new String[]{
                ...
                for(i=0;i<tbTindakanInap.getRowCount();i++){ 
                    if(tbTindakanInap.getValueAt(i,0).toString().equals("true")){
                        Sequel.menyimpan("template_pemeriksaan_dokter_tindakan_inap","?,?","Tindakan Dokter",2,new String[]{
                            tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),tbTindakanInap.getValueAt(i,1).toString()
                        });
                    }
                }
                Sequel.queryu("delete from template_pemeriksaan_dokter_operasi where kd_template='" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString() + "'");
        ...
        private void tbOperasiMouseClicked(java.awt.event.MouseEvent evt) {
         int row = tbOperasi.getSelectedRow();
         int col = tbOperasi.getSelectedColumn();

         if (evt.getClickCount() == 1 && row >= 0 && col >= 0) {
             tbOperasi.editCellAt(row, col);
             Component editor = tbOperasi.getEditorComponent();
             if (editor != null) editor.requestFocus();
         }
