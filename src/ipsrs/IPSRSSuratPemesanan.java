...
public class IPSRSSuratPemesanan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public IPSRSSuratPemesanan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            IPSRSSuratPemesanan dialog = new IPSRSSuratPemesanan(new javax.swing.JFrame(), true);
    ...
    private void autoNomor() {
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_pemesanan_non_medis.no_pemesanan,3),signed)),0) from surat_pemesanan_non_medis where surat_pemesanan_non_medis.tanggal='"+Valid.SetTgl(Tanggal.getSelectedItem()+"")+"' ",
