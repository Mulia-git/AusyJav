...
public class DlgSetHarga extends javax.swing.JDialog {
    private final DefaultTableModel tabMode,tabModePengaturanUmum,tabModePengaturanHargaUmum,tabModePengaturanHargaPerBarang,tabModeSettingObat,tabModeMappingObat;
    ...
    private DlgBarang obat=new DlgBarang(null,false);
    private DlgCariCaraBayar bayar=new DlgCariCaraBayar(null,false);
    ...
    public DlgSetHarga(java.awt.Frame parent, boolean modal) {
        ...
        tabModePengaturanUmum=new DefaultTableModel(null,new Object[]{
              "Harga obat yang digunakan","Asal harga jual obat","Sertakan PPN Pembelian"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        tabModeSettingObat=new DefaultTableModel(null,new Object[]{
              "Obat Per Cara Bayar","Margin Di Jual Bebas (%)","Lokasi Gudang","Set Obat Di IGD","Margin Di IGD (%)"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };

        tbSettingObat.setModel(tabModeSettingObat);
        tbSettingObat.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbSettingObat.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 5; i++) {
            TableColumn column = tbSettingObat.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbSettingObat.setDefaultRenderer(Object.class, new WarnaTable());
        
        
        tabModeMappingObat=new DefaultTableModel(null,new Object[]{
              "Kode Barang","Barang/BHP/Alkes","Kode Bayar","Cara Bayar"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };

        tbMappingObat.setModel(tabModeMappingObat);
        tbMappingObat.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbMappingObat.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 4; i++) {
            TableColumn column = tbMappingObat.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(100);
            }else if(i==1){
                column.setPreferredWidth(250);
        ...
        tbMappingObat.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        tabModePengaturanHargaPerBarang=new DefaultTableModel(null,new Object[]{
              "Jual(%)","Ranap K1(%)","Ranap K2(%)","Ranap K3(%)","Kelas Utama(%)",
              "Ranap VIP(%)","Ranap VVIP(%)","Beli Luar(%)","Jual Bebas(%)","Karyawan(%)",
        ...
        marginjualbebas.setDocument(new batasInput((byte)10).getKata(marginjualbebas));
        marginigd.setDocument(new batasInput((byte)10).getKata(marginigd));          
        ...
        obat.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if (obat.getTable().getSelectedRow() != -1) {
                    kdobat.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(), 1).toString());
                    nmobat.setText(obat.getTable().getValueAt(obat.getTable().getSelectedRow(), 2).toString());
                }
                obat.requestFocus();
            }
        ...
        bayar.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if (bayar.getTable().getSelectedRow() != -1) {
                    kdpj.setText(bayar.getTable().getValueAt(bayar.getTable().getSelectedRow(), 1).toString());
                    nmpj.setText(bayar.getTable().getValueAt(bayar.getTable().getSelectedRow(), 2).toString());
                }
                bayar.requestFocus();
            }
    ...
    private void initComponents() {
        ...
        tbSettingObat = new widget.Table();
        panelGlass9 = new widget.panelisi();
        jLabel8 = new widget.Label();
        cmbPerCaraBayar = new widget.ComboBox();
        jLabel9 = new widget.Label();
        jLabel10 = new widget.Label();
        cmbIGD = new widget.ComboBox();
        jLabel11 = new widget.Label();
        marginjualbebas = new widget.TextBox();
        marginigd = new widget.TextBox();
        ...
        tbMappingObat = new widget.Table();
        ...
        jLabel5.setText("Harga obat yang digunakan :");
        jLabel5.setName("jLabel5"); // NOI18N
        panelGlass8.add(jLabel5);
        jLabel5.setBounds(0, 12, 155, 23);
        ...
        cmbPengaturan.setBounds(159, 12, 115, 23);

        jLabel6.setText("Asal harga jual obat :");
        jLabel6.setName("jLabel6"); // NOI18N
        panelGlass8.add(jLabel6);
        jLabel6.setBounds(270, 12, 120, 23);
        ...
        cmbHargaDasar.setBounds(394, 12, 120, 23);

        jLabel7.setText("Sertakan PPN Pembelian :");
        jLabel7.setName("jLabel7"); // NOI18N
        panelGlass8.add(jLabel7);
        jLabel7.setBounds(525, 12, 130, 23);

        cmbPPN.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Yes", "No" }));
        cmbPPN.setName("cmbPPN"); // NOI18N
        cmbPPN.setPreferredSize(new java.awt.Dimension(55, 28));
        cmbPPN.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbPPNKeyPressed(evt);
            }
        });
        panelGlass8.add(cmbPPN);
        cmbPPN.setBounds(659, 12, 70, 23);
        ...
        ranapvipperbarang.setEditable(false);
        ...
        ranapvipperbarang.setBounds(553, 10, 0, 0);
        ...
        label55.setBounds(320, 70, 229, 23);

        ranapvvipperbarang.setEditable(false);
        ...
        ranapvvipperbarang.setBounds(550, 70, 0, 0);
        ...
        label56.setBounds(290, 100, 260, 23);

        beliluarperbarang.setEditable(false);
        ...
        beliluarperbarang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                beliluarperbarangActionPerformed(evt);
            }
        });
        ...
        beliluarperbarang.setBounds(550, 100, 0, 0);
        ...
        label57.setBounds(320, 130, 229, 23);

        jualbebasperbarang.setEditable(false);
        ...
        jualbebasperbarang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jualbebasperbarangActionPerformed(evt);
            }
        });
        ...
        jualbebasperbarang.setBounds(550, 130, 0, 0);
        ...
        karyawanperbarang.setBounds(550, 160, 0, 0);
        ...
        label58.setBounds(300, 160, 250, 23);

        label59.setText("Harga Jual (%) :");
        ...
        ranapk1perbarang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ranapk1perbarangActionPerformed(evt);
            }
        });
        ...
        label61.setBounds(0, 100, 229, 23);
        ...
        ranapk2perbarang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ranapk2perbarangActionPerformed(evt);
            }
        });
        ...
        ranapk2perbarang.setBounds(230, 100, 0, 0);

        ranapk3perbarang.setEditable(false);
        ...
        ranapk3perbarang.setBounds(230, 130, 0, 0);
        ...
        label62.setBounds(0, 130, 229, 23);
        ...
        label63.setBounds(0, 160, 229, 23);

        ranaputamaperbarang.setEditable(false);
        ...
        ranaputamaperbarang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ranaputamaperbarangActionPerformed(evt);
            }
        });
        ...
        kdbarang.setBounds(233, 40, 80, 23);
        ...
        nmbarang.setBounds(320, 40, 288, 23);
        ...
        Btnbarang.setBounds(610, 40, 25, 23);
        ...
        tbSettingObat.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbSettingObat.setName("tbSettingObat"); // NOI18N
        tbSettingObat.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbSettingObatMouseClicked(evt);
            }
        });
        tbSettingObat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbSettingObatKeyPressed(evt);
            }
        });
        Scroll5.setViewportView(tbSettingObat);
        ...
        jLabel8.setText("Margin di Jual Bebas (%) :");
        jLabel8.setName("jLabel8"); // NOI18N
        panelGlass9.add(jLabel8);
        jLabel8.setBounds(0, 50, 130, 23);

        cmbPerCaraBayar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Yes", "No" }));
        cmbPerCaraBayar.setName("cmbPerCaraBayar"); // NOI18N
        cmbPerCaraBayar.setPreferredSize(new java.awt.Dimension(55, 28));
        cmbPerCaraBayar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbPerCaraBayarKeyPressed(evt);
            }
        });
        panelGlass9.add(cmbPerCaraBayar);
        cmbPerCaraBayar.setBounds(140, 10, 70, 23);

        jLabel9.setText("Margin di IGD (%) :");
        jLabel9.setName("jLabel9"); // NOI18N
        panelGlass9.add(jLabel9);
        jLabel9.setBounds(230, 50, 100, 23);

        jLabel10.setText("Lokasi Gudang :");
        jLabel10.setName("jLabel10"); // NOI18N
        panelGlass9.add(jLabel10);
        jLabel10.setBounds(430, 10, 90, 23);

        cmbIGD.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Yes", "No" }));
        cmbIGD.setName("cmbIGD"); // NOI18N
        cmbIGD.setPreferredSize(new java.awt.Dimension(55, 28));
        cmbIGD.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbIGDKeyPressed(evt);
            }
        });
        panelGlass9.add(cmbIGD);
        cmbIGD.setBounds(340, 10, 70, 23);

        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel11.setText("Obat per Cara Bayar :");
        jLabel11.setName("jLabel11"); // NOI18N
        panelGlass9.add(jLabel11);
        jLabel11.setBounds(20, 10, 110, 23);

        marginjualbebas.setText("0");
        marginjualbebas.setHighlighter(null);
        marginjualbebas.setName("marginjualbebas"); // NOI18N
        marginjualbebas.setPreferredSize(new java.awt.Dimension(50, 23));
        marginjualbebas.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                marginjualbebasMouseMoved(evt);
            }
        });
        marginjualbebas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseExited(java.awt.event.MouseEvent evt) {
                marginjualbebasMouseExited(evt);
            }
        });
        marginjualbebas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                marginjualbebasKeyPressed(evt);
            }
        });
        panelGlass9.add(marginjualbebas);
        marginjualbebas.setBounds(140, 50, 50, 23);

        marginigd.setText("0");
        marginigd.setHighlighter(null);
        marginigd.setName("marginigd"); // NOI18N
        marginigd.setPreferredSize(new java.awt.Dimension(50, 23));
        marginigd.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                marginigdMouseMoved(evt);
            }
        });
        marginigd.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseExited(java.awt.event.MouseEvent evt) {
                marginigdMouseExited(evt);
            }
        });
        marginigd.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                marginigdKeyPressed(evt);
            }
        });
        panelGlass9.add(marginigd);
        marginigd.setBounds(340, 50, 50, 23);

        jLabel12.setText("Obat IGD :");
        jLabel12.setName("jLabel12"); // NOI18N
        panelGlass9.add(jLabel12);
        jLabel12.setBounds(250, 10, 80, 23);

        kdbangsal.setName("kdbangsal"); // NOI18N
        kdbangsal.setPreferredSize(new java.awt.Dimension(207, 23));
        kdbangsal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kdbangsalKeyPressed(evt);
            }
        });
        panelGlass9.add(kdbangsal);
        kdbangsal.setBounds(530, 10, 80, 23);

        nmbangsal.setEditable(false);
        nmbangsal.setName("nmbangsal"); // NOI18N
        nmbangsal.setPreferredSize(new java.awt.Dimension(207, 23));
        panelGlass9.add(nmbangsal);
        nmbangsal.setBounds(610, 10, 288, 23);
        ...
        panelGlass9.add(Btnbangsal);
        Btnbangsal.setBounds(900, 10, 25, 23);

        internalFrame7.add(panelGlass9, java.awt.BorderLayout.PAGE_START);

        TabSetting.addTab("Setting Obat", internalFrame7);
        ...
        panelisi7.setPreferredSize(new java.awt.Dimension(100, 84));
        panelisi7.setLayout(null);

        label69.setText("Cara Bayar :");
        label69.setName("label69"); // NOI18N
        label69.setPreferredSize(new java.awt.Dimension(82, 23));
        panelisi7.add(label69);
        label69.setBounds(0, 40, 229, 23);

        label22.setText("Barang/BHP/Alkes :");
        label22.setName("label22"); // NOI18N
        label22.setPreferredSize(new java.awt.Dimension(65, 23));
        panelisi7.add(label22);
        label22.setBounds(0, 10, 229, 23);

        kdpj.setName("kdpj"); // NOI18N
        kdpj.setPreferredSize(new java.awt.Dimension(207, 23));
        ...
        panelisi7.add(kdpj);
        kdpj.setBounds(233, 40, 80, 23);

        nmpj.setEditable(false);
        nmpj.setName("nmpj"); // NOI18N
        nmpj.setPreferredSize(new java.awt.Dimension(207, 23));
        panelisi7.add(nmpj);
        nmpj.setBounds(320, 40, 288, 23);
        ...
        Btnpj.setPreferredSize(new java.awt.Dimension(28, 23));
        ...
        panelisi7.add(Btnpj);
        Btnpj.setBounds(610, 40, 25, 23);

        kdobat.setName("kdobat"); // NOI18N
        kdobat.setPreferredSize(new java.awt.Dimension(207, 23));
        kdobat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kdobatKeyPressed(evt);
            }
        });
        panelisi7.add(kdobat);
        kdobat.setBounds(230, 10, 80, 23);

        nmobat.setEditable(false);
        nmobat.setName("nmobat"); // NOI18N
        nmobat.setPreferredSize(new java.awt.Dimension(207, 23));
        panelisi7.add(nmobat);
        nmobat.setBounds(320, 10, 288, 23);
        ...
        panelisi7.add(Btnobat);
        Btnobat.setBounds(610, 10, 25, 23);

        internalFrame6.add(panelisi7, java.awt.BorderLayout.PAGE_START);

        Scroll4.setComponentPopupMenu(Popup2);
        Scroll4.setDoubleBuffered(true);
        Scroll4.setName("Scroll4"); // NOI18N
        Scroll4.setOpaque(true);

        tbMappingObat.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbMappingObat.setComponentPopupMenu(Popup2);
        tbMappingObat.setName("tbMappingObat"); // NOI18N
        tbMappingObat.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbMappingObatMouseClicked(evt);
            }
        });
        tbMappingObat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbMappingObatKeyPressed(evt);
            }
        });
        Scroll4.setViewportView(tbMappingObat);
        ...
        panelisi8.add(LCount2);

        internalFrame6.add(panelisi8, java.awt.BorderLayout.PAGE_END);

        TabSetting.addTab("Mapping Obat Per Cara Bayar", internalFrame6);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TabSetting.getSelectedIndex()==0){
            if(tabModePengaturanUmum.getRowCount()>0){
                ...
                Sequel.menyimpan("set_harga_obat","?,?,?",3,new String[]{
            ...
            if(ranapk1perbarang.getText().trim().equals("")){
                ranapk1perbarang.setText("0");
            }
            if(ranapk2perbarang.getText().trim().equals("")){
                ranapk2perbarang.setText("0");
            }
            if(ranapk3perbarang.getText().trim().equals("")){
                ranapk3perbarang.setText("0");
            }
            if(ranaputamaperbarang.getText().trim().equals("")){
                ranaputamaperbarang.setText("0");
            }
            if(ranapvipperbarang.getText().trim().equals("")){
                ranapvipperbarang.setText("0");
            }
            if(ranapvvipperbarang.getText().trim().equals("")){
                ranapvvipperbarang.setText("0");
            }
            if(beliluarperbarang.getText().trim().equals("")){
                beliluarperbarang.setText("0");
            }
            if(jualbebasperbarang.getText().trim().equals("")){
                jualbebasperbarang.setText("0");
            }
            if(karyawanperbarang.getText().trim().equals("")){
                karyawanperbarang.setText("0");
            }
            
            if(ralanperbarang.getText().trim().equals("")){
                Valid.textKosong(ralanperbarang,"Harga Jual");
        ...
        }else if(TabSetting.getSelectedIndex()==4){
            if(tabModeSettingObat.getRowCount()>0){
                JOptionPane.showMessageDialog(null,"Maaf, Hanya diijinkan satu pengaturan ...!!!!");
                cmbPerCaraBayar.requestFocus();
            }else{
                Sequel.menyimpan("setting_obat","?,?,?,?,?",5,new String[]{
                    cmbPerCaraBayar.getSelectedItem().toString(),
                    marginjualbebas.getText(),
                    kdbangsal.getText(),
                    cmbIGD.getSelectedItem().toString(),
                    marginigd.getText()
                });
                tampilsettingobat();
                emptTeks();
            }
        }else if(TabSetting.getSelectedIndex()==5){
            if(kdpj.getText().trim().equals("")||nmpj.getText().trim().equals("")){
                Valid.textKosong(kdpj,"Cara Bayar");
            }else{            
                Sequel.menyimpan("mapping_obat_cara_bayar","?,?",2,new String[]{
                    kdobat.getText(),
                    kdpj.getText()
                });
                tampilmappingobat();
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            if(TabSetting.getSelectedIndex()==0){
                Valid.pindah(evt,cmbPPN,BtnBatal);
            }else if(TabSetting.getSelectedIndex()==1){
                ...
                Valid.pindah(evt,cmbPerCaraBayar,BtnBatal);
            }                
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(TabSetting.getSelectedIndex()==0){
            ...
            Sequel.queryu("delete from setting_obat");
            tampilsettingobat();
            emptTeks();
        }else if(TabSetting.getSelectedIndex()==5){
                Sequel.queryu("DELETE FROM mapping_obat_cara_bayar where kode_brng='"+ kdobat.getText() + "' AND kd_pj='" + kdpj.getText() + "'"); 
            tampilmappingobat();
            emptTeks();
        }             
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TabSetting.getSelectedIndex()==0){
            ...
            if(kdobat.getText().trim().equals("")||nmpj.getText().trim().equals("")){
                Valid.textKosong(kdobat,"Nama Obat");
            }else{     
                Sequel.queryu("DELETE FROM mapping_obat_cara_bayar where kode_brng='"+ kdobat.getText() + "' AND kd_pj='" + kdpj.getText() + "'");       
                Sequel.menyimpan("mapping_obat_cara_bayar","?,?",2,new String[]{
                    kdobat.getText(),
    ...
    private void cmbHargaDasarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbHargaDasarKeyPressed
        Valid.pindah(evt,cmbPengaturan,cmbPPN);
    }//GEN-LAST:event_cmbHargaDasarKeyPressed

    private void cmbPPNKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbPPNKeyPressed
        Valid.pindah(evt,cmbHargaDasar,BtnSimpan);
    }//GEN-LAST:event_cmbPPNKeyPressed

    private void ranaputamaperbarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ranaputamaperbarangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ranaputamaperbarangActionPerformed

    private void beliluarperbarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beliluarperbarangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_beliluarperbarangActionPerformed

    private void ranapk1perbarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ranapk1perbarangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ranapk1perbarangActionPerformed

    private void ranapk2perbarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ranapk2perbarangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ranapk2perbarangActionPerformed

    private void jualbebasperbarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jualbebasperbarangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jualbebasperbarangActionPerformed
    ...
    private void tbSettingObatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbSettingObatMouseClicked
        if(tabModeSettingObat.getRowCount()!=0){
            try {
                getDataSettingObat();
            } catch (java.lang.NullPointerException e) {
    ...
    }//GEN-LAST:event_tbSettingObatMouseClicked

    private void tbSettingObatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbSettingObatKeyPressed
        if(tabModeSettingObat.getRowCount()!=0){
            if((evt.getKeyCode()==KeyEvent.VK_ENTER)||(evt.getKeyCode()==KeyEvent.VK_UP)||(evt.getKeyCode()==KeyEvent.VK_DOWN)){
                try {
                    getDataSettingObat();
    ...
    }//GEN-LAST:event_tbSettingObatKeyPressed

    private void cmbPerCaraBayarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbPerCaraBayarKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbPerCaraBayarKeyPressed

    private void cmbIGDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbIGDKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbIGDKeyPressed

    private void marginjualbebasMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_marginjualbebasMouseMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_marginjualbebasMouseMoved

    private void marginjualbebasMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_marginjualbebasMouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_marginjualbebasMouseExited

    private void marginjualbebasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_marginjualbebasKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_marginjualbebasKeyPressed

    private void marginigdMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_marginigdMouseMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_marginigdMouseMoved

    private void marginigdMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_marginigdMouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_marginigdMouseExited

    private void marginigdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_marginigdKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_marginigdKeyPressed
    ...
    private void BtnbangsalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnbangsalActionPerformed
        ...
        bangsal.setVisible(true);// TODO add your handling code here:
    ...
    private void BtnpjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnpjActionPerformed
        bayar.emptTeks();
        bayar.isCek();
        bayar.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void tbMappingObatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMappingObatMouseClicked
        if(tabModeMappingObat.getRowCount()!=0){
            try {
                getDataMappingObat();
            } catch (java.lang.NullPointerException e) {
            }
        }// TODO add your handling code here:
    }//GEN-LAST:event_tbMappingObatMouseClicked

    private void tbMappingObatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbMappingObatKeyPressed
        if(tabModeMappingObat.getRowCount()!=0){
            if((evt.getKeyCode()==KeyEvent.VK_ENTER)||(evt.getKeyCode()==KeyEvent.VK_UP)||(evt.getKeyCode()==KeyEvent.VK_DOWN)){
                try {
                    getDataMappingObat();
    ...
    }//GEN-LAST:event_tbMappingObatKeyPressed
    ...
    private void BtnCari2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari2ActionPerformed
        tampilmappingobat();// TODO add your handling code here:
    ...
    private void BtnobatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnobatActionPerformed
        obat.emptTeks();
        obat.isCek();
        obat.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        obat.setLocationRelativeTo(internalFrame1);
        obat.setAlwaysOnTop(false);
    ...
    */
    ...
    private widget.ComboBox cmbIGD;
    private widget.ComboBox cmbPPN;
    private widget.ComboBox cmbPengaturan;
    private widget.ComboBox cmbPerCaraBayar;
    ...
    private widget.TextBox marginigd;
    private widget.TextBox marginjualbebas;
    ...
    private widget.Table tbMappingObat;
    ...
    private widget.Table tbSettingObat;
    ...
    private void tampilsettingobat() {
        Valid.tabelKosong(tabModeSettingObat);
        try{
            ps=koneksi.prepareStatement(
                   "SELECT so.per_cara_bayar,\n" +
                    "so.persen_jual_bebas,\n" +
                    "b.nm_bangsal,\n" +
                    "so.obat_igd,\n" +
                    "so.margin_igd\n" +
                    "FROM setting_obat AS so\n" +
                    "JOIN bangsal AS b\n" +
                    "    ON so.kode_gudang = b.kd_bangsal;");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
                    tabModeSettingObat.addRow(new Object[]{
                        rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5)
                    });
                }
            } catch (Exception e) {
    ...
    private void tampilmappingobat() {
        Valid.tabelKosong(tabModeMappingObat);
        try{
            ps = koneksi.prepareStatement(
                "SELECT mocb.kode_brng, db.nama_brng, mocb.kd_pj, pj.png_jawab " +
                "FROM mapping_obat_cara_bayar AS mocb " +
                "JOIN databarang AS db ON mocb.kode_brng = db.kode_brng " +
                "JOIN penjab AS pj ON mocb.kd_pj = pj.kd_pj " +
                "WHERE db.nama_brng LIKE ? OR pj.png_jawab LIKE ?"
            );

            try {
                ps.setString(1,"%"+TCari2.getText().trim()+"%");
                ps.setString(2,"%"+TCari2.getText().trim()+"%");
                rs=ps.executeQuery();
                while(rs.next()){
                    tabModeMappingObat.addRow(new Object[]{
                        rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("kd_pj"),rs.getString("png_jawab")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : "+e);
            ...
            LCount2.setText(""+tabModeMappingObat.getRowCount());
        }catch(Exception e){
            System.out.println("Notifikasi : "+e);
        }
    }
    ...
    private void getDataSettingObat() {
        int row=tbSettingObat.getSelectedRow();
        if(row!= -1){
            cmbPerCaraBayar.setSelectedItem(tabModeSettingObat.getValueAt(row,0).toString());
            marginjualbebas.setText(tabModeSettingObat.getValueAt(row,1).toString());
            nmbangsal.setText(tabModeSettingObat.getValueAt(row,2).toString());
            cmbIGD.setSelectedItem(tabModeSettingObat.getValueAt(row,3).toString());
            marginigd.setText(tabModeSettingObat.getValueAt(row,4).toString());
        }
    }
    
     private void getDataMappingObat() {
        int row=tbMappingObat.getSelectedRow();
        if(row!= -1){
            kdobat.setText(tabModeMappingObat.getValueAt(row,0).toString());
            nmobat.setText(tabModeMappingObat.getValueAt(row,1).toString());
            kdpj.setText(tabModeMappingObat.getValueAt(row,2).toString());
            nmpj.setText(tabModeMappingObat.getValueAt(row,3).toString());
        }
    }
    ...
    public void emptTeks() {
        if(TabSetting.getSelectedIndex()==0){
            ...
            cmbPengaturan.setSelectedIndex(0);
            cmbPPN.setSelectedIndex(0);
            cmbPengaturan.requestFocus();
        }else if(TabSetting.getSelectedIndex()==1){
            ralanumum.setText("0");
            ranapk1umum.setText("0");
