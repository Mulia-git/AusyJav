...
public class DlgBilingRanap extends javax.swing.JDialog {
    ...
    private String biaya="",tambahan="",totals="",norawatbayi="",centangdokterranap="",kd_pj="",
            ...
            Harian_Ranap="",Uang_Muka_Ranap="",Sisa_Uang_Muka_Ranap="",tampilkan_ppnobat_ranap="",HPP_Obat_Rawat_Inap="",
            ...
            sqlpsbiayasekali="select biaya_sekali.nama_biaya,biaya_sekali.besar_biaya,(biaya_sekali.besar_biaya*1) as total from biaya_sekali "+
                    " where biaya_sekali.kd_kamar=? order by biaya_sekali.nama_biaya",
    ...
    private void initComponents() {
        ...
        MnBayi.setBackground(new java.awt.Color(250, 255, 245));
        ...
        internalFrame6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ubah Manual Lama Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        ppBersihkanPiutang.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppBersihkanPiutang.setForeground(new java.awt.Color(50, 50, 50));
        ppBersihkanPiutang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppBersihkanPiutang.setText("Bersihkan Piutang");
        ppBersihkanPiutang.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppBersihkanPiutang.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppBersihkanPiutang.setName("ppBersihkanPiutang"); // NOI18N
        ppBersihkanPiutang.setPreferredSize(new java.awt.Dimension(200, 25));
        ppBersihkanPiutang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBersihkanPiutangActionPerformed(evt);
            }
        });
        PopupPiutang.add(ppBersihkanPiutang);

        PopupBayar.setName("PopupBayar"); // NOI18N

        ppBersihkanBayar.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppBersihkanBayar.setForeground(new java.awt.Color(50, 50, 50));
        ppBersihkanBayar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppBersihkanBayar.setText("Bersihkan Pembayaran");
        ppBersihkanBayar.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppBersihkanBayar.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppBersihkanBayar.setName("ppBersihkanBayar"); // NOI18N
        ppBersihkanBayar.setPreferredSize(new java.awt.Dimension(200, 25));
        ppBersihkanBayar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBersihkanBayarActionPerformed(evt);
            }
        });
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Billing/Pembayaran Ranap Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-02-2026 08:53:55" }));
        ...
        BtnCariBayar.setBounds(847, 40, 25, 23);
        ...
        TCari1.setBounds(110, 210, 734, 23);
        ...
        ChkPiutang.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkPiutangItemStateChanged(evt);
            }
        });
        ...
        TabRawat.addTab("Pembayaran", scrollPane9);
...
private void MnHapusTagihanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusTagihanActionPerformed
	...
	try{
        ...
        if(i>0){
            ...
            if((-1*ttlPotongan)>0){
                if(Sequel.menyimpantf2("tampjurnal","'"+Potongan_Ranap+"','Potongan Ranap','0','"+(-1*ttlPotongan)+"'","Rekening")==false){
                    sukses=false;
                }   
            }

            if((-1*ttlRetur_Obat)>0){
                if(Sequel.menyimpantf("tampjurnal","'"+Retur_Obat_Ranap+"','Retur Obat Ranap','0','"+(-1*ttlRetur_Obat)+"'","kredit=kredit+'"+(-1*ttlRetur_Obat)+"'","kd_rek='"+Retur_Obat_Ranap+"'")==false){
                    sukses=false;
                }   
                if(Sequel.menyimpantf("tampjurnal","'"+HPP_Obat_Rawat_Inap+"','HPP Persediaan Obat Rawat Inap','"+(-1*ttlRetur_Obat)+"','0'","debet=debet+'"+(-1*ttlRetur_Obat)+"'","kd_rek='"+HPP_Obat_Rawat_Inap+"'")==false){
                    sukses=false;
                } 
                if(Sequel.menyimpantf("tampjurnal","'"+Persediaan_Obat_Rawat_Inap+"','Persediaan Obat Rawat Inap','0','"+(-1*ttlRetur_Obat)+"'","kredit=kredit+'"+(-1*ttlRetur_Obat)+"'","kd_rek='"+Persediaan_Obat_Rawat_Inap+"'")==false){
                    sukses=false;
                }   
            }

            if(ttlRegistrasi>0){
                if(Sequel.menyimpantf2("tampjurnal","'"+Registrasi_Ranap+"','Registrasi Ranap','"+ttlRegistrasi+"','0'","Rekening")==false){
                    sukses=false;
                }   
            }

            if(ttlTambahan>0){
                if(Sequel.menyimpantf2("tampjurnal","'"+Tambahan_Ranap+"','Tambahan Ranap','"+ttlTambahan+"','0'","Rekening")==false){
                    sukses=false;
                }    
            }

            if(ttlResep_Pulang>0){
                if(Sequel.menyimpantf2("tampjurnal","'"+Resep_Pulang_Ranap+"','Resep Pulang Ranap','"+ttlResep_Pulang+"','0'","Rekening")==false){
                    sukses=false;
                }    
            }

            if(ttlKamar>0){
                if(Sequel.menyimpantf2("tampjurnal","'"+Kamar_Inap+"','Kamar Inap','"+ttlKamar+"','0'","Rekening")==false){
                    sukses=false;
                }    
            }

            if(ttlHarian>0){
                if(Sequel.menyimpantf2("tampjurnal","'"+Harian_Ranap+"','Harian Ranap','"+ttlHarian+"','0'","Rekening")==false){
                    sukses=false;
                }    
            }
            
            if((ttlRanap_Dokter+ttlRanap_Paramedis+ttlRalan_Dokter+ttlRalan_Paramedis)>0){
                if(Sequel.menyimpantf("tampjurnal","'"+Tindakan_Ranap+"','Tindakan Ranap','"+(ttlRanap_Dokter+ttlRanap_Paramedis+ttlRalan_Dokter+ttlRalan_Paramedis)+"','0'", 
                                 "debet=debet+"+(ttlRanap_Dokter+ttlRanap_Paramedis+ttlRalan_Dokter+ttlRalan_Paramedis),"kd_rek='"+Tindakan_Ranap+"'")==false){
                    sukses=false;
                }                            
            }

            if(ttlLaborat>0){
                if(Sequel.menyimpantf("tampjurnal","'"+Laborat_Ranap+"','Laborat','"+ttlLaborat+"','0'", 
                                 "debet=debet+"+ttlLaborat,"kd_rek='"+Laborat_Ranap+"'")==false){
                    sukses=false;
                }                    
            }

            if(ttlRadiologi>0){
                if(Sequel.menyimpantf("tampjurnal","'"+Radiologi_Ranap+"','Radiologi','"+ttlRadiologi+"','0'", 
                                 "debet=debet+"+ttlRadiologi,"kd_rek='"+Radiologi_Ranap+"'")==false){
                    sukses=false;
                }     
            }
            ...
            if((ttlObat-obatlangsung-ppnobat)>0){
                if(Sequel.menyimpantf("tampjurnal","'"+Obat_Ranap+"','Obat Ranap','"+(ttlObat-obatlangsung-ppnobat)+"','0'","debet=debet+'"+(ttlObat-obatlangsung-ppnobat)+"'","kd_rek='"+Obat_Ranap+"'")==false){
                    sukses=false;
                }  
            }
             
            if(obatlangsung>0){
                if(Sequel.menyimpantf("tampjurnal","'"+Obat_Langsung_Ranap+"','Obat Ranap','"+obatlangsung+"','0'","debet=debet+'"+obatlangsung+"'","kd_rek='"+Obat_Langsung_Ranap+"'")==false){
                    sukses=false;
                }   
            }
            
            if(ppnobat>0){
                if(Sequel.menyimpantf("tampjurnal","'"+PPN_Keluaran+"','PPN Keluaran','"+ppnobat+"','0'","debet=debet+'"+ppnobat+"'","kd_rek='"+PPN_Keluaran+"'")==false){
                    sukses=false;
                }   
            }

            if(ttlOperasi>0){
                if(Sequel.menyimpantf("tampjurnal","'"+Operasi_Ranap+"','Operasi','"+ttlOperasi+"','0'", 
                                 "debet=debet+"+ttlOperasi,"kd_rek='"+Operasi_Ranap+"'")==false){
                    sukses=false;
                }  
            }
            
            if(uangdeposit>0){
                if(Sequel.menyimpantf("tampjurnal","'"+Uang_Muka_Ranap+"','Kontra Akun Uang Muka','0','"+uangdeposit+"'",
                                 "kredit=kredit+"+uangdeposit,"kd_rek='"+Uang_Muka_Ranap+"'")==false){
                    sukses=false;
                }    
            }
            
            if(sisadeposit>0){
                if(Sequel.menyimpantf("tampjurnal","'"+Sisa_Uang_Muka_Ranap+"','Sisa Uang Muka Ranap','"+sisadeposit+"','0'",
                                 "debet=debet+"+sisadeposit,"kd_rek='"+Sisa_Uang_Muka_Ranap+"'")==false){
                    sukses=false;
                }  
            ...
            if(ttlService>0){
                if(Sequel.menyimpantf2("tampjurnal","'"+Service_Ranap+"','Biaya Service Ranap','"+ttlService+"','0'","Rekening")==false){
                    sukses=false;
                }   
            }
            ...
            psakunbayar=koneksi.prepareStatement(
             ...
             try{
                 ...
                 while(rsakunbayar.next()){
                     if(Sequel.menyimpantf("tampjurnal","'"+rsakunbayar.getString("kd_rek")+"','"+rsakunbayar.getString("nama_bayar")+"','0','"+rsakunbayar.getString("besar_bayar")+"'",
                                 "kredit=kredit+"+rsakunbayar.getString("besar_bayar"),"kd_rek='"+rsakunbayar.getString("kd_rek")+"'")==false){
                            sukses=false;
                     }   
                 } 
             }catch (Exception e) {
             ...
             try{
                 ...
                 while(rsakunpiutang.next()){      
                     if(Sequel.menyimpantf("tampjurnal","'"+rsakunpiutang.getString("kd_rek")+"','"+rsakunpiutang.getString("nama_bayar")+"','0','"+rsakunpiutang.getString("totalpiutang")+"'",
                                      "kredit=kredit+"+rsakunpiutang.getString("totalpiutang"),"kd_rek='"+rsakunpiutang.getString("kd_rek")+"'")==false){
                            sukses=false;
                     }  
                 } 
             }catch (Exception e) {
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void MnDataResepPulangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataResepPulangActionPerformed
        ...
        reseppulang.isCek();
        reseppulang.setNoRm(TNoRw.getText(),TNoRM.getText(),TPasien.getText(),DTPTgl.getDate(),new Date()); 
        ...
        if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            try{
                ...
                for(i=0;i<tbBilling.getRowCount();i++){  
                    if(tbBilling.getValueAt(i,0).toString().equals("true")){
                        ...
                        try {
                            ...
                            pstemporary.setString(2,tbBilling.getValueAt(i,1).toString().replaceAll("'","`"));
                            pstemporary.setString(3,tbBilling.getValueAt(i,2).toString().replaceAll("'","`"));
                            pstemporary.setString(4,tbBilling.getValueAt(i,3).toString().replaceAll("'","`"));
                            pstemporary.setString(5,biaya);
                            try {
                                pstemporary.setString(6,tbBilling.getValueAt(i,5).toString().replaceAll("'","`"));
                            } catch (Exception e) {
                                pstemporary.setString(6,"");
                            }                            
                            pstemporary.setString(7,tambahan);
                            pstemporary.setString(8,totals);
                            try {
                                pstemporary.setString(9,tbBilling.getValueAt(i,8).toString().replaceAll("'","`"));  
                            } catch (Exception e) {
                                pstemporary.setString(9,""); 
                            }                              
                ...
                if(ChkPiutang.isSelected()==false){ 
                    i++;
                    Sequel.menyimpan("temporary_bayar_ranap","'"+i+"','','','','','','','','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    i++;
                    Sequel.menyimpan("temporary_bayar_ranap","'"+i+"','TOTAL TAGIHAN',':','','','','','<b>"+TtlSemua.getText()+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    i++;
                    Sequel.menyimpan("temporary_bayar_ranap","'"+i+"','PPN',':','','','','','<b>"+Valid.SetAngka(besarppn)+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    i++;
                    Sequel.menyimpan("temporary_bayar_ranap","'"+i+"','TAGIHAN+PPN',':','','','','','<b>"+TagihanPPn.getText()+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    i++;
                    Sequel.menyimpan("temporary_bayar_ranap","'"+i+"','','','','','','','','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    i++;
                    Sequel.menyimpan("temporary_bayar_ranap","'"+i+"','DEPOSIT',':','','','','','<b>"+Deposit.getText()+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    i++;
                ...
                if(i>0){                       
                    ...
                    if(i==1){
                        ...
                        if(piutang>0){
                            Valid.panggilUrl("billing/LaporanBilling11.php?petugas="+akses.getkode().replaceAll(" ","_")+"&nonota="+Sequel.cariIsi("select count(kamar_inap.no_rawat) from kamar_inap inner join reg_periksa "+
                                    "on kamar_inap.no_rawat=reg_periksa.no_rawat where reg_periksa.kd_pj='"+kd_pj+"' and kamar_inap.tgl_keluar like '%"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(0,7)+"%'")+"/RI/"+kd_pj+"/"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(5,7)+"/"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(0,4)+"&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB());
                        }else{
    ...
    private void MnDataResepPulang1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataResepPulang1ActionPerformed
        if(Sequel.cariRegistrasi(TNoRw.getText())>0){
            ...
            reseppulang.setLocationRelativeTo(internalFrame1);
            reseppulang.isCek();
            reseppulang.setNoRm(norawatbayi,"-","By.Ny."+TPasien.getText(),DTPTgl.getDate(),new Date());
            reseppulang.setVisible(true);
        }            
    ...
    private void ppBersihkanPiutangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanPiutangActionPerformed
        Valid.tabelKosong(tabModeAkunPiutang);
        if(status.equals("belum")){
            tampilAkunPiutang2();
        }else if(status.equals("sudah")){
    ...
    }//GEN-LAST:event_ppBersihkanPiutangActionPerformed

    private void ppBersihkanBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanBayarActionPerformed
        Valid.tabelKosong(tabModeAkunBayar);
        if(status.equals("belum")){
            tampilAkunBayar2();
        }else if(status.equals("sudah")){
    ...
    }//GEN-LAST:event_ppBersihkanBayarActionPerformed
    ...
    private void TabRawatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabRawatMouseClicked
        if(TabRawat.getSelectedIndex()==2){
            try {
                ...
                psperiksalab=koneksi.prepareStatement("select permintaan_lab.noorder,permintaan_lab.tgl_permintaan,"+
                    ...
                    "where permintaan_lab.no_rawat=? order by permintaan_lab.tgl_permintaan,permintaan_lab.jam_permintaan desc");
                try {
                ...
                psperiksalab=koneksi.prepareStatement("select permintaan_labpa.noorder,permintaan_labpa.tgl_permintaan,"+
                    ...
                    "where permintaan_labpa.no_rawat=? order by permintaan_labpa.tgl_permintaan,permintaan_labpa.jam_permintaan desc");
                try {
                    psperiksalab.setString(1,TNoRw.getText());
                    rsperiksalab=psperiksalab.executeQuery();
                    while(rsperiksalab.next()){
                ...
                psperiksalab=koneksi.prepareStatement("select permintaan_labmb.noorder,permintaan_labmb.tgl_permintaan,"+
                    ...
                    "where permintaan_labmb.no_rawat=? order by permintaan_labmb.tgl_permintaan,permintaan_labmb.jam_permintaan desc");
                try {
                    psperiksalab.setString(1,TNoRw.getText());
                    rsperiksalab=psperiksalab.executeQuery();
                    while(rsperiksalab.next()){
                ...
                psperiksarad=koneksi.prepareStatement("select permintaan_radiologi.noorder,permintaan_radiologi.tgl_permintaan,"+
                    ...
                    "where permintaan_radiologi.no_rawat=? order by permintaan_radiologi.tgl_permintaan,permintaan_radiologi.jam_permintaan desc");
                try {
                ...
                psobatlangsung=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                    ...
                    " where resep_obat.tgl_peresepan<>'0000-00-00' and resep_obat.no_rawat=? order by resep_obat.tgl_perawatan desc,resep_obat.jam desc");
                try {
    ...
    private void MnCariPeriksaLabPAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCariPeriksaLabPAActionPerformed
        if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
        }else{
            DlgCariPeriksaLabPA cperiksalab=new DlgCariPeriksaLabPA(null,false);
            cperiksalab.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            cperiksalab.setLocationRelativeTo(internalFrame1);
            cperiksalab.SetNoRw(TNoRw.getText());
            cperiksalab.setAlwaysOnTop(false);
    ...
    private void BtnAll1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAll1KeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt, btnCariPiutang,BtnSimpan);
        }
    ...
    private void ChkPiutangItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkPiutangItemStateChanged
        if(ChkPiutang.isSelected()==false){
    ...
    */
    ...
    try {      
        ...
        try {
            ...
            if (rscekbilling != null) rscekbilling.close();
            if (pscekbilling != null) pscekbilling.close();
        }

   
        pscarirm = koneksi.prepareStatement(
        ...
        try {
            ...
            if (rscarirm != null) rscarirm.close();
            if (pscarirm != null) pscarirm.close();
        }

        pscaripasien = koneksi.prepareStatement(
            "select nm_pasien,jk,tgl_lahir from pasien where no_rkm_medis=?"
        );
        try {
            ...
            if (rscaripasien.next()) {
                ...
                nm_pasien = rscaripasien.getString("nm_pasien");
                jk = rscaripasien.getString("jk");
                tgl_lahir = rscaripasien.getString("tgl_lahir");
            }
        } finally {
            if (rscaripasien != null) rscaripasien.close();
            if (pscaripasien != null) pscaripasien.close();
        }
        ...
        if (i <= 0) {
            ...
            uangdeposit = Sequel.cariIsiAngka(
                "select ifnull(sum(besar_deposit),0) from deposit where no_rawat=?",
                TNoRw.getText()
            );
            Deposit.setText(Valid.SetAngka(uangdeposit));
            ...
            uangdeposit = Sequel.cariIsiAngka(
                "select ifnull(sum(Uang_Muka),0) from nota_inap where no_rawat=?",
                TNoRw.getText()
            );
            Deposit.setText(Valid.SetAngka(uangdeposit));
            ...
            Valid.SetTgl2(
                DTPTgl,
                Sequel.cariIsi(
                    "select concat(tanggal,' ',jam) from nota_inap where no_rawat=?",
                    TNoRw.getText()
                )
            );
            ...
            try {
                ...
                if (rsreg != null) rsreg.close();
                if (pssudahmasuk != null) pssudahmasuk.close();
            }
        ...
        System.out.println("Notifikasi isRawat : " + e);
    }
...
private void prosesCariObat(String norawat) {
    ...
    try {
        ...
        if (rsobatlangsung.next()) {
            tabModeRwJlDr.addRow(new Object[]{
                true, x + ". Obat & BHP Langsung", ":", "", null, null, null, null, "Obat"
            });
            x++;

            tabModeRwJlDr.addRow(new Object[]{
                centangobatranap.equals("Yes"),
                "   ",
                "Obat & BHP",
                ":",
                rsobatlangsung.getDouble("besar_tagihan"),
                1, 0,
                rsobatlangsung.getDouble("besar_tagihan"),
                "Obat"
            });
            ...
            ttlobat += obatlangsung;
        }
    } catch (Exception e) {
        System.out.println("Notifikasi Obat Langsung : " + e);
    }
    ...
    try {
        ...
        if (rsobatoperasi.next()) {
            tabModeRwJlDr.addRow(new Object[]{
                true, x + ". Obat & BHP Operasi", ":", "", null, null, null, null, "Obat"
            });
            x++;

            rsobatoperasi.beforeFirst();
            while (rsobatoperasi.next()) {
                tabModeRwJlDr.addRow(new Object[]{
                    centangobatranap.equals("Yes"),
                    "   ",
                    rsobatoperasi.getString("nm_obat"),
                    ":",
                    rsobatoperasi.getDouble("hargasatuan"),
                    rsobatoperasi.getDouble("jumlah"),
                    0,
                    rsobatoperasi.getDouble("total"),
                    "Obat"
                });

                ttlobat += rsobatoperasi.getDouble("total");
            }
        }
    } catch (Exception e) {
        System.out.println("Notifikasi Obat Operasi : " + e);
    }

    /* ======================================================
       OBAT REGULER DIPISAH RALAN & RANAP
       ====================================================== */
    String[] statusRawat = {"Ralan", "Ranap"};

    for (String status : statusRawat) {

        subttl = 0;
           String namaPoli = "";

            if(status.equals("Ralan")){
                namaPoli = Sequel.cariIsi(
        ...
        tabModeRwJlDr.addRow(new Object[]{
            true,
            status.equals("Ralan")
                ? "Rincian Obat & BHP Rawat Jalan (" + namaPoli + ")"
                : "Rincian Obat & BHP Rawat Inap",
            ":", "", null, null, null, null, "HEADER"
        });
        ...
        try {
            pscariobat = koneksi.prepareStatement(
                ...
                "where detail_pemberian_obat.no_rawat=? and detail_pemberian_obat.status=? " +
                "group by databarang.kode_brng, detail_pemberian_obat.biaya_obat " +
                "order by jenis.nama"
            );

            pscariobat.setString(1, norawat);
            pscariobat.setString(2, status);

            rscariobat = pscariobat.executeQuery();

            while (rscariobat.next()) {
                double total = rscariobat.getDouble("total") + rscariobat.getDouble("tambahan");

                tabModeRwJlDr.addRow(new Object[]{
                    centangobatranap.equals("Yes"),
                    "   ",
                    rscariobat.getString("nama_brng") + " (" + rscariobat.getString("nama") + ")",
                    ":",
                    rscariobat.getDouble("biaya_obat"),
                    rscariobat.getDouble("jml"),
                    rscariobat.getDouble("tambahan"),
                    total,
                    status.equals("Ralan") ? "Obat Ralan" : "Obat Ranap"
                });
            ...
            System.out.println("Notifikasi Obat " + status + " : " + e);
        }

        if (subttl > 0) {
            tabModeRwJlDr.addRow(new Object[]{
                true, "",
                "Total Obat & BHP " + (status.equals("Ralan") ? "Rawat Jalan" : "Rawat Inap")
                + " : " + Valid.SetAngka(subttl),
                "", null, null, null, null, "TtlObat"
            });
        }
    ...
    try {
        ...
        if (rsreturobat.next()) {
            tabModeRwJlDr.addRow(new Object[]{
                true, "", "Retur Obat :", "", null, null, null, null, "Retur Obat"
            });
        }
        ...
        while (rsreturobat.next()) {
            tabModeRwJlDr.addRow(new Object[]{
                centangobatranap.equals("Yes"),
                "   ",
                rsreturobat.getString("nama_brng"),
                ":",
                rsreturobat.getDouble("h_retur"),
                rsreturobat.getDouble("jml"),
                0,
                rsreturobat.getDouble("ttl"),
                "Retur Obat"
            });

            subttl += rsreturobat.getDouble("ttl");
        }

        ttlretur = subttl;

    } catch (Exception e) {
        System.out.println("Notifikasi Retur Obat : " + e);
    }
    ...
    if ((ttlobat + ttlretur) > 0) {
        if (tampilkan_ppnobat_ranap.equals("Yes")) {
            ppnobat = Math.round((ttlobat + ttlretur) * 0.11);
            tabModeRwJlDr.addRow(new Object[]{
                true, "", "PPN Obat", ":", ppnobat, 1, 0, ppnobat, "Obat"
            });
            tabModeRwJlDr.addRow(new Object[]{
                true, "",
                "Total Obat Bersih : " + Valid.SetAngka3(ttlobat + ttlretur + ppnobat),
                "", null, null, null, null, "TtlObat"
            });
        } else {
            tabModeRwJlDr.addRow(new Object[]{
                true, "",
                "Total Obat Bersih : " + Valid.SetAngka3(ttlobat + ttlretur),
                "", null, null, null, null, "TtlObat"
            });
        }
    }
    ...
    private void prosesCariService(){
        String no_rawat = TNoRw.getText();
        String kd_pj_bpj = Sequel.cariIsi("SELECT kd_pj FROM reg_periksa WHERE no_rawat = '"+no_rawat+"'");
        try {   
            if(ChkPiutang.isSelected()==false){
            ...
            try {
                ...
                if(rsservice.next()){
                    ...
                    Double admin_ranap = 0.0;
                    if(kd_pj_bpj.equals("BPJ")){
                        admin_ranap = 0.02;
                    }else{
                        admin_ranap = rsservice.getDouble("besar")/100;
                    }
                    
                    if(kd_pj_bpj.equals("B28")){
                        ttlService=150000;
                        ttl=ttl+ttlService;
                    }else if(kd_pj_bpj.equals("BPK")){
                        admin_ranap = 0.03;
                        ttlService=Valid.roundUp(admin_ranap*
    ...
    try {
        ...
        for(String status : statusRawat){
           ...
           tabModeRwJlDr.addRow(new Object[]{
                true,
                status.equals("Ralan")
                    ? "Rincian Biaya Rawat Jalan (" + namaPoli + ")"
            ...
            while(rskategori.next()){
                ...
                PreparedStatement psDr, psDrPr, psPr;
                ResultSet rsDr, rsDrPr, rsPr;

                if(status.equals("Ralan")){
                    psDr   = koneksi.prepareStatement(sqlpsralandokter);
                    psDrPr = koneksi.prepareStatement(sqlpsralandrpr);
                    psPr   = koneksi.prepareStatement(sqlpsralanperawat);
                }else{
                    psDr   = koneksi.prepareStatement(sqlpsranapdokter);
                    psDrPr = koneksi.prepareStatement(sqlpsranapdrpr);
                    psPr   = koneksi.prepareStatement(sqlpsranapperawat);
                }

                psDr.setString(1, norawat);
                psDr.setString(2, rskategori.getString(1));
                rsDr = psDr.executeQuery();

                psDrPr.setString(1, norawat);
                psDrPr.setString(2, rskategori.getString(1));
                rsDrPr = psDrPr.executeQuery();

                psPr.setString(1, norawat);
                psPr.setString(2, rskategori.getString(1));
                rsPr = psPr.executeQuery();

                boolean adaDr = rsDr.next();
                boolean adaDrPr = rsDrPr.next();
                boolean adaPr = rsPr.next();

                if(adaDr || adaDrPr || adaPr){
                    tabModeRwJlDr.addRow(new Object[]{
                        true,"  "+rskategori.getString(2),":","",null,null,null,null,status
                    });
                    ada = true;
                }
                ...
                if(ada){
                    ...
                    if(adaDr){
                        rsDr.beforeFirst();
                        while(rsDr.next()){
                            tamkur = Sequel.cariIsiAngka(
                                "select ifnull(sum(tamkur),0) from tamkur " +
                                "where no_rawat='" + norawat + "' " +
                                "and nm_perawatan='" + rsDr.getString("nm_perawatan") + "' " +
                                "and status='" + (status.equals("Ralan") ? "Ralan Dokter" : "Ranap Dokter") + "'"
                            );

                            double nilai = rinciandokterranap.equals("Yes")
                                    ? rsDr.getDouble("totaltarif_tindakandr")
                                    : rsDr.getDouble("biaya");

                            if(status.equals("Ranap")){
                                detailbhp += rsDr.getDouble("totalbhp");
                                detailjs  += rsDr.getDouble("totalmaterial");
                            }

                            subttl += nilai + tamkur;

                            tabModeRwJlDr.addRow(new Object[]{
                                true,"     ",rsDr.getString("nm_perawatan"),":",
                                nilai, rsDr.getDouble("jml"), tamkur,
                                nilai + tamkur,
                                status.equals("Ralan") ? "Ralan Dokter" : "Ranap Dokter"
                            });
                        }
                    }
                    ...
                    if(adaDrPr){
                        ...
                        while(rsDrPr.next()){
                            tamkur = Sequel.cariIsiAngka(
                                "select ifnull(sum(tamkur),0) from tamkur " +
                                "where no_rawat='" + norawat + "' " +
                                "and nm_perawatan='" + rsDrPr.getString("nm_perawatan") + "' " +
                                "and status='" + (status.equals("Ralan") ?
                                    "Ralan Dokter Paramedis" : "Ranap Dokter Paramedis") + "'"
                            );

                            double nilai = rinciandokterranap.equals("Yes")
                                    ? rsDrPr.getDouble("totaltarif_tindakandr")
                                    : rsDrPr.getDouble("biaya");

                            if(status.equals("Ranap")){
                                detailbhp += rsDrPr.getDouble("totalbhp");
                                detailjs  += rsDrPr.getDouble("totalmaterial")
                                           + rsDrPr.getDouble("totaltarif_tindakanpr");
                            }

                            subttl += nilai + tamkur;

                            tabModeRwJlDr.addRow(new Object[]{
                                true,"     ",rsDrPr.getString("nm_perawatan"),":",
                                nilai, rsDrPr.getDouble("jml"), tamkur,
                                nilai + tamkur,
                                status.equals("Ralan") ?
                                    "Ralan Dokter Paramedis" : "Ranap Dokter Paramedis"
                            });
                    ...
                    if(adaPr){
                        ...
                        while(rsPr.next()){
                            tamkur = Sequel.cariIsiAngka(
                                "select ifnull(sum(tamkur),0) from tamkur " +
                                "where no_rawat='" + norawat + "' " +
                                "and nm_perawatan='" + rsPr.getString("nm_perawatan") + "' " +
                                "and status='" + (status.equals("Ralan") ?
                                    "Ralan Paramedis" : "Ranap Paramedis") + "'"
                            );

                            subttl += rsPr.getDouble("biaya") + tamkur;

                            tabModeRwJlDr.addRow(new Object[]{
                                true,"     ",
                                rsPr.getString("nm_perawatan"),":",
                                rsPr.getDouble("biaya"),
                                rsPr.getDouble("jml"),
                                tamkur,
                                rsPr.getDouble("biaya") + tamkur,
                                status.equals("Ralan") ?
                                    "Ralan Paramedis" : "Ranap Paramedis"
                            });
                        }
                    ...
                    if(subttl > 0){
                        tabModeRwJlDr.addRow(new Object[]{
                            true,"","Total "+rskategori.getString(2)+" : "+Valid.SetAngka(subttl),
                            "",null,null,null,null,"Ttl"+status
                        });
                    }
                }

                rsDr.close(); rsDrPr.close(); rsPr.close();
                psDr.close(); psDrPr.close(); psPr.close();
            }

            rskategori.close();
            pskategori.close();

            prosesLabByStatus(norawat, status);
            prosesRadiologiByStatus(norawat, status);
        }

        if(detailjs > 0){
            tabModeRwJlDr.addRow(new Object[]{
                true,x+". Jasa Sarpras",":","",null,null,null,detailjs,"Sarpras"
            });
        }

    } catch (Exception e){
        System.out.println("Notifikasi prosesCariTindakan : "+e);
    }
}
    private void prosesLabByStatus(String norawat, String status){
    try{
        subttl = 0;
        ...
        psperiksalab = koneksi.prepareStatement(
            ...
            "where periksa_lab.no_rawat=? and periksa_lab.status=? " +
            "group by periksa_lab.kd_jenis_prw"
        );

        psperiksalab.setString(1, norawat);
        psperiksalab.setString(2, status);
        rsperiksalab = psperiksalab.executeQuery();

        if(rsperiksalab.next()){
            tabModeRwJlDr.addRow(new Object[]{
                true,
                (status.equals("Ralan") ? "Pemeriksaan Lab Rawat Jalan ("+namaPoli+")" : "Pemeriksaan Lab Rawat Inap"),
        ...
        while(rsperiksalab.next()){
            psdetaillab = koneksi.prepareStatement(
                "select sum(detail_periksa_lab.biaya_item) as total " +
            ...
            tabModeRwJlDr.addRow(new Object[]{
                ...
                rsperiksalab.getDouble("biaya"),
                rsperiksalab.getDouble("jml"),
                lab,
                rsperiksalab.getDouble("total") + lab,
                "Laborat"
            });

            subttl += rsperiksalab.getDouble("total") + lab;
        ...
        if(subttl > 0){
            tabModeRwJlDr.addRow(new Object[]{
                true,"","Total Lab "+status+" : "+Valid.SetAngka(subttl),
                "",null,null,null,null,"TtlLaborat"
            });
        }
        ...
        System.out.println("Notifikasi prosesLabByStatus : "+e);
    }
}
private void prosesRadiologiByStatus(String norawat, String status){
    try{
        subttl = 0;
        ...
        psperiksarad = koneksi.prepareStatement(
            ...
            "on jns_perawatan_radiologi.kd_jenis_prw=periksa_radiologi.kd_jenis_prw " +
            "where periksa_radiologi.no_rawat=? and periksa_radiologi.status=? " +
            "group by periksa_radiologi.kd_jenis_prw"
        );

        psperiksarad.setString(1, norawat);
        psperiksarad.setString(2, status);
        rsperiksarad = psperiksarad.executeQuery();

        if(rsperiksarad.next()){
            tabModeRwJlDr.addRow(new Object[]{
                true,
                (status.equals("Ralan") ? "Pemeriksaan Radiologi Rawat Jalan ("+namaPoli+")" : "Pemeriksaan Radiologi Rawat Inap"),
                ":","",null,null,null,null,"RADIOLOGI"
            });
        }
    ...
    "select ifnull(sum(tamkur),0) from tamkur " +
    "where no_rawat='" + norawat + "' " +
    "and nm_perawatan='" + rsperiksarad.getString("nm_perawatan") + "' " +
    "and status='Radiologi'"
);


            tabModeRwJlDr.addRow(new Object[]{
                true,"     ",
                rsperiksarad.getString("nm_perawatan"),":",
                rsperiksarad.getDouble("biaya"),
                rsperiksarad.getDouble("jml"),
                tamkur,
                rsperiksarad.getDouble("total") + tamkur,
                "Radiologi"
            });

            subttl += rsperiksarad.getDouble("total") + tamkur;
        }

        if(subttl > 0){
            tabModeRwJlDr.addRow(new Object[]{
                true,"","Total Radiologi "+status+" : "+Valid.SetAngka(subttl),
                "",null,null,null,null,"TtlRadiologi"
            });
        }
        ...
        System.out.println("Notifikasi prosesRadiologiByStatus : "+e);
    }
}
                ...
                if(rincianoperasi.equals("Yes")){
                    while(rsoperasi.next()){
                        ...
                        if(rsoperasi.getDouble("biayaoperator1")>0){
                            double biayaoperator1 = rsoperasi.getDouble("biayaoperator1") 
              + rsoperasi.getDouble("biayaperawat_luar");
                           

                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Operator 1",":",biayaoperator1,1,0,biayaoperator1,"Operasi"}); 
                        }
                        ...
                        if(rsoperasi.getDouble("biayaasisten_operator1")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Kru OK",":",rsoperasi.getDouble("biayaasisten_operator1"),1,0,rsoperasi.getDouble("biayaasisten_operator1"),"Operasi"}); 
                        }
...
//                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Jasa RS",":",rsoperasi.getDouble("biayaperawat_luar"),1,0,rsoperasi.getDouble("biayaperawat_luar"),"Operasi"}); 
//                        }
    ...
    private void tampilAkunBankPapua() { 
        try{      
             file=new File("./cache/akunbankpapua.iyem");
             file.createNewFile();
             fileWriter = new FileWriter(file);
             Host_to_Host_Bank_Papua=Sequel.cariIsi("select set_akun_bankpapua.kd_rek from set_akun_bankpapua");
             fileWriter.write("{\"akunbankpapua\":\""+Host_to_Host_Bank_Papua+"\"}");
             fileWriter.flush();
             fileWriter.close();
        } catch (Exception e) {
    ...
    private void tampilAkunBankBRI() { 
        try{      
    ...
    private void tampilAkunBankPapua2() { 
        try{      
             myObj = new FileReader("./cache/akunbankpapua.iyem");
             root = mapper.readTree(myObj);
             response = root.path("akunbankpapua");
    ...
    private void tampilAkunBankBRI2() { 
        try{      
         ...
         try{        
             ...
             try{
                 ...
                 while(rsakunpiutang.next()){                    
                     ...
                     iyembuilder.append("{\"NamaAkun\":\""+rsakunpiutang.getString(1).replaceAll("\"","")+"\",\"KodeRek\":\""+rsakunpiutang.getString(2)+"\",\"KdPJ\":\""+rsakunpiutang.getString(3)+"\"},");
                 } 
             }catch (Exception e) {
                 System.out.println("Notifikasi : "+e);
             } finally{
    ...
    private void tampilAkunPiutang2() {
         try{        
             ...
             root = mapper.readTree(myObj);
             response = root.path("akunpiutang");
             if(response.isArray()){
                for(JsonNode list:response){
                    if(list.path("NamaAkun").asText().toLowerCase().contains(TCari1.getText().toLowerCase())){
                        tabModeAkunPiutang.addRow(new Object[]{
                            list.path("NamaAkun").asText(),list.path("KodeRek").asText(),list.path("KdPJ").asText(),"",DTPTgl.getSelectedItem().toString().substring(0,10)
                        });
                    }
                }
             }
    ...
    private void isSimpan() {
        try {  
            ...
            if(sukses==true){
                    ...
                    if(Valid.SetAngka(tbAkunBayar.getValueAt(r,2).toString())>0){
                        ...
                        if(countbayar>1){
                            if(Sequel.menyimpantf2("detail_nota_inap","?,?,?,?","Akun bayar",4,new String[]{
                                    ...
                                    if(Sequel.menyimpantf("tampjurnal","'"+tbAkunBayar.getValueAt(r,1).toString()+"','"+tbAkunBayar.getValueAt(r,0).toString()+"','"+Double.toString(itembayar)+"','0'",
                                                     "debet=debet+"+Double.toString(itembayar),"kd_rek='"+tbAkunBayar.getValueAt(r,1).toString()+"'")==false){
                                        sukses=false;
                                    } 
                                    ...
                                    if(Host_to_Host_Bank_Jabar.equals(tbAkunBayar.getValueAt(r,1).toString())){
                                        if(Sequel.menyimpantf2("tagihan_bpd_jabar","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,''",16,new String[]{
                                            no_rkm_medis,nm_pasien,alamat,jk,tgl_lahir,umurdaftar,tgl_registrasi,no_nota.replaceAll("/",""),Double.toString(itembayar),KodeBankJabar+"1021312"+Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(tagihan_bpd_jabar.keterangan,4),signed)),0) from tagihan_bpd_jabar where year(tagihan_bpd_jabar.tgl_closing)='"+DTPTgl.getSelectedItem().toString().substring(6,10)+"' and tagihan_bpd_jabar.status_lanjut='Ranap'",DTPTgl.getSelectedItem().toString().substring(8,10),4),TNoRw.getText(),"Ranap",Valid.SetTgl(DTPTgl.getSelectedItem()+""),"Pending",akses.getkode(),"0000-00-00"
                                        })==false){
                                            sukses=false;
                                        }
                                    }
                            ...
                            if(piutang<=0){
                                if(Sequel.menyimpantf2("detail_nota_inap","?,?,?,?","Akun bayar",4,new String[]{
                                        ...
                                        if(Sequel.menyimpantf("tampjurnal","'"+tbAkunBayar.getValueAt(r,1).toString()+"','"+tbAkunBayar.getValueAt(r,0).toString()+"','"+Double.toString(itembayar-kekurangan)+"','0'",
                                                     "debet=debet+"+Double.toString(itembayar-kekurangan),"kd_rek='"+tbAkunBayar.getValueAt(r,1).toString()+"'")==false){
                                            sukses=false;
                                        } 
                                        if(Host_to_Host_Bank_Jateng.equals(tbAkunBayar.getValueAt(r,1).toString())){
                                            if(Sequel.menyimpantf2("tagihan_bpd_jateng","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,''",16,new String[]{
                                        ...
                                        if(Host_to_Host_Bank_Jabar.equals(tbAkunBayar.getValueAt(r,1).toString())){
                                            if(Sequel.menyimpantf2("tagihan_bpd_jabar","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,''",16,new String[]{
                                                no_rkm_medis,nm_pasien,alamat,jk,tgl_lahir,umurdaftar,tgl_registrasi,no_nota.replaceAll("/",""),Double.toString(itembayar-kekurangan),KodeBankJabar+"1021312"+Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(tagihan_bpd_jabar.keterangan,4),signed)),0) from tagihan_bpd_jabar where year(tagihan_bpd_jabar.tgl_closing)='"+DTPTgl.getSelectedItem().toString().substring(6,10)+"' and tagihan_bpd_jabar.status_lanjut='Ranap'",DTPTgl.getSelectedItem().toString().substring(8,10),4),TNoRw.getText(),"Ranap",Valid.SetTgl(DTPTgl.getSelectedItem()+""),"Pending",akses.getkode(),"0000-00-00"
                                            })==false){
                                                sukses=false;
                                            }
                                        }
                                        if(Akun_BRI_API.equals(tbAkunBayar.getValueAt(r,1).toString())){
                                            if(apibri.buatVA(TNoRw.getText().replaceAll("/","").substring(2,8)+TNoRw.getText().replaceAll("/","").substring(10,14),(nm_pasien.length()>38?nm_pasien.substring(0,38):nm_pasien),Valid.SetAngka2(itembayar-kekurangan),TNoRw.getText())==true){
                                                if(Sequel.menyimpantf2("tagihan_briva","?,?,?,?,?,?,?,?,?,?,?,?,?,?,''",14,new String[]{
                ...
                for(r=0;r<row2;r++){ 
                    if(Valid.SetAngka(tabModeAkunPiutang.getValueAt(r,3).toString())>0){
                        ...
                        if(Sequel.menyimpantf2("detail_piutang_pasien","?,?,?,?,?,?","Akun Piutang",6,new String[]{
                                ...
                                if(Sequel.menyimpantf("tampjurnal","'"+tabModeAkunPiutang.getValueAt(r,1).toString()+"','"+tabModeAkunPiutang.getValueAt(r,0).toString()+"','"+Double.toString(itempiutang)+"','0'",
                                                     "debet=debet+"+Double.toString(itempiutang),"kd_rek='"+tabModeAkunPiutang.getValueAt(r,1).toString()+"'")==false){
                                    sukses=false;
                                }                  
                        }else{
                            sukses=false;
                ...
                if(sukses==true){
                    if(uangdeposit>0){  
                        if(Sequel.menyimpantf("tampjurnal","'"+Uang_Muka_Ranap+"','Kontra Akun Uang Muka','"+uangdeposit+"','0'",
                                         "debet=debet+"+uangdeposit,"kd_rek='"+Uang_Muka_Ranap+"'")==false){
                            sukses=false;
                        }  
                    }
                    
                    if((-1*ttlPotongan)>0){
                        if(Sequel.menyimpantf2("tampjurnal","'"+Potongan_Ranap+"','Potongan Ranap','"+(-1*ttlPotongan)+"','0'","Rekening")==false){
                            sukses=false;
                        }     
                    }

                    if((-1*ttlRetur_Obat)>0){
                        if(Sequel.menyimpantf("tampjurnal","'"+Retur_Obat_Ranap+"','Retur Obat Ranap','"+(-1*ttlRetur_Obat)+"','0'","debet=debet+'"+(-1*ttlRetur_Obat)+"'","kd_rek='"+Retur_Obat_Ranap+"'")==false){
                            sukses=false;
                        }    
                        if(Sequel.menyimpantf("tampjurnal","'"+HPP_Obat_Rawat_Inap+"','HPP Persediaan Obat Rawat Inap','0','"+(-1*ttlRetur_Obat)+"'","kredit=kredit+'"+(-1*ttlRetur_Obat)+"'","kd_rek='"+Persediaan_Obat_Rawat_Inap+"'")==false){
                            sukses=false;
                        }    
                        if(Sequel.menyimpantf("tampjurnal","'"+Persediaan_Obat_Rawat_Inap+"','Persediaan Obat Rawat Inap','"+(-1*ttlRetur_Obat)+"','0'","debet=debet+'"+(-1*ttlRetur_Obat)+"'","kd_rek='"+Persediaan_Obat_Rawat_Inap+"'")==false){
                            sukses=false;
                        }     
                    }

                    if(ttlRegistrasi>0){
                        if(Sequel.menyimpantf2("tampjurnal","'"+Registrasi_Ranap+"','Registrasi Ranap','0','"+ttlRegistrasi+"'","Rekening")==false){
                            sukses=false;
                        }    
                    }

                    if(ttlTambahan>0){
                        if(Sequel.menyimpantf2("tampjurnal","'"+Tambahan_Ranap+"','Tambahan Ranap','0','"+ttlTambahan+"'","Rekening")==false){
                            sukses=false;
                        }    
                    }

                    if(ttlResep_Pulang>0){
                        if(Sequel.menyimpantf2("tampjurnal","'"+Resep_Pulang_Ranap+"','Resep Pulang Ranap','0','"+ttlResep_Pulang+"'","Rekening")==false){
                            sukses=false;
                        }    
                    }

                    if(ttlKamar>0){
                        if(Sequel.menyimpantf2("tampjurnal","'"+Kamar_Inap+"','Kamar Inap','0','"+ttlKamar+"'","Rekening")==false){
                            sukses=false;
                        }    
                    }

                    if(ttlHarian>0){
                        if(Sequel.menyimpantf2("tampjurnal","'"+Harian_Ranap+"','Harian Ranap','0','"+ttlHarian+"'","Rekening")==false){
                            sukses=false;
                        }    
                    }

                    if((ttlRanap_Dokter+ttlRanap_Paramedis+ttlRalan_Dokter+ttlRalan_Paramedis)>0){
                        if(Sequel.menyimpantf("tampjurnal","'"+Tindakan_Ranap+"','Tindakan Ranap','0','"+(ttlRanap_Dokter+ttlRanap_Paramedis+ttlRalan_Dokter+ttlRalan_Paramedis)+"'", 
                                         "kredit=kredit+"+(ttlRanap_Dokter+ttlRanap_Paramedis+ttlRalan_Dokter+ttlRalan_Paramedis),"kd_rek='"+Tindakan_Ranap+"'")==false){
                            sukses=false;
                        }                            
                    }

                    if(ttlLaborat>0){
                        if(Sequel.menyimpantf("tampjurnal","'"+Laborat_Ranap+"','Laborat','0','"+ttlLaborat+"'", 
                                         "kredit=kredit+"+ttlLaborat,"kd_rek='"+Laborat_Ranap+"'")==false){
                            sukses=false;
                        }                    
                    }

                    if(ttlRadiologi>0){
                        if(Sequel.menyimpantf("tampjurnal","'"+Radiologi_Ranap+"','Radiologi','0','"+ttlRadiologi+"'", 
                                         "kredit=kredit+"+ttlRadiologi,"kd_rek='"+Radiologi_Ranap+"'")==false){
                            sukses=false;
                        }    
                    }

                    if((ttlObat-obatlangsung-ppnobat)>0){
                        if(Sequel.menyimpantf("tampjurnal","'"+Obat_Ranap+"','Obat Ranap','0','"+(ttlObat-obatlangsung-ppnobat)+"'","kredit=kredit+'"+(ttlObat-obatlangsung-ppnobat)+"'","kd_rek='"+Obat_Ranap+"'")==false){
                            sukses=false;
                        }    
                    }

                    if(obatlangsung>0){
                        if(Sequel.menyimpantf("tampjurnal","'"+Obat_Langsung_Ranap+"','Obat Ranap','0','"+obatlangsung+"'","kredit=kredit+'"+(obatlangsung)+"'","kd_rek='"+Obat_Langsung_Ranap+"'")==false){
                            sukses=false;
                        }    
                    }
                    ...
                    if(ttlOperasi>0){
                        if(Sequel.menyimpantf("tampjurnal","'"+Operasi_Ranap+"','Operasi','0','"+ttlOperasi+"'","kredit=kredit+"+ttlOperasi,"kd_rek='"+Operasi_Ranap+"'")==false){
                            sukses=false;
                        }  
                    }

                    if(ttlService>0){
                        if(Sequel.menyimpantf2("tampjurnal","'"+Service_Ranap+"','Biaya Service Ranap','0','"+ttlService+"'","Rekening")==false){
                            sukses=false;
                        }    
                    }

                    if(sisadeposit>0){  
                        if(Sequel.menyimpantf("tampjurnal","'"+Sisa_Uang_Muka_Ranap+"','Sisa Uang Muka Ranap','0','"+sisadeposit+"'",
                                         "kredit=kredit+"+sisadeposit,"kd_rek='"+Sisa_Uang_Muka_Ranap+"'")==false){
                            sukses=false;
                        } 
