 ...
 * @author dosen
 */
public final class RMCariDiagnosa extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariDiagnosa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Kode","Diagnosa"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Riwayat Diagnosa ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariDiagnosa diagnosa = new RMCariDiagnosa(new javax.swing.JFrame(), true);
            diagnosa.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
