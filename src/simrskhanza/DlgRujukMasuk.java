...
public final class DlgRujukMasuk extends javax.swing.JDialog {
    ...
    public DlgRujukMasuk(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"P","Perujuk/Rujukan","Alamat Perujuk","No HP","Fee Perujuk","No.Rujuk","No.Rawat","No.R.M.",
                  "Nama Pasien","Alamat","Umur","Tgl.Masuk","Tgl.Keluar","Diagnosa Awal","Tindakan",
        ...
        //Perujuk
        Object[] row2={"Perujuk","Alamat Perujuk","No HP"};
        ...
        JMBPJS.setDocument(new batasInput((byte)15).getOnlyAngka(JMBPJS));
    ...
    private void initComponents() {
        ...
        DTPReg.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-10-2025" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-10-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-10-2025" }));
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(250, 215));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 220));
        ...
        JMBPJS.setText("100000");
        JMBPJS.setHighlighter(null);
        JMBPJS.setName("JMBPJS"); // NOI18N
        JMBPJS.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                JMBPJSKeyPressed(evt);
            }
        });
        FormInput.add(JMBPJS);
        JMBPJS.setBounds(620, 100, 110, 23);

        jLabel8.setText("JM.Perujuk : Rp.");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(530, 100, 90, 23);
        ...
        btnDokter.setBounds(690, 130, 28, 23);
        ...
        NmDiagnosa.setBounds(180, 130, 510, 23);
        ...
        kdDiagnosa.setBounds(80, 130, 100, 23);

        jLabel9.setText("Diagnosa :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(0, 130, 80, 23);
        ...
        jLabel16.setBounds(300, 160, 100, 23);
        ...
        Keterangan.setBounds(400, 160, 320, 23);

        jLabel10.setText("No.Balasan :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(0, 160, 80, 23);
        ...
        NoBalasan.setBounds(80, 160, 152, 23);

        jLabel17.setText("No HP :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(-20, 100, 100, 23);
        ...
        FormInput.add(NoHP);
        NoHP.setBounds(80, 100, 190, 23);

        jLabel18.setText("Tindakan :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(270, 100, 80, 23);
        ...
        Tindakan.setBounds(350, 100, 152, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(JMBPJS.getText().trim().equals("")){
            Valid.textKosong(JMBPJS,"J.M. Perujuk");
        }else{
            if(Sequel.menyimpantf("rujuk_masuk","'"+TNoRw.getText()+"','"+TRujukan.getText()+"','"+TAlamat.getText()+"','"+NoHP.getText()+"',"+
                             "'"+NoRujuk.getText()+"','"+JMBPJS.getText()+"','"+Dokter.getText()+"','"+kdDiagnosa.getText()+"','"+Tindakan.getText()+"',"+
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(int i=0;i<tbObat.getRowCount();i++){ 
            if(tbObat.getValueAt(i,0).toString().equals("true")){
                if(Sequel.meghapustf("rujuk_masuk","no_rawat",tbObat.getValueAt(i,6).toString())==true){
                    tabMode.removeRow(i);
                    i--;
                }
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TRujukan.getText().trim().equals("")){
            ...
            Sequel.mengedit("rujuk_masuk","no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),6).toString()+"'",
                    "perujuk='"+TRujukan.getText()+"',alamat='"+TAlamat.getText()+"',no_rujuk='"+NoRujuk.getText()+"',"+
                    "jm_perujuk='"+JMBPJS.getText()+"',dokter_perujuk='"+Dokter.getText()+"',kd_penyakit='"+kdDiagnosa.getText()+"',"+
                    "kategori_rujuk='"+KategoriRujuk.getSelectedItem().toString()+"',keterangan='"+Keterangan.getText()+"',"+
                    "no_balasan='"+NoBalasan.getText()+"',nohp='"+NoHP.getText()+"',tindakan='"+Tindakan.getText()+"'");
...
private void TAlamatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TAlamatKeyPressed
    ...
    private void JMBPJSKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JMBPJSKeyPressed
        Valid.pindah(evt,kdDiagnosa,NoBalasan);
    }//GEN-LAST:event_JMBPJSKeyPressed
    ...
    private void kdDiagnosaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdDiagnosaKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_UP){
            ...
            Valid.pindah(evt,TAlamat,JMBPJS);
        }
    ...
    private void NoBalasanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoBalasanKeyPressed
        Valid.pindah(evt,JMBPJS,Keterangan);
    ...
    */
    ...
    try {
        pstampil = koneksi.prepareStatement(
            "SELECT rujuk_masuk.perujuk, rujuk_masuk.alamat, rujuk_masuk.nohp, rujuk_masuk.jm_perujuk, " +
            "rujuk_masuk.no_rujuk, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, pasien.nm_pasien, " +
            "reg_periksa.almt_pj, CONCAT(reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur, " +
            "reg_periksa.tgl_registrasi, rujuk_masuk.dokter_perujuk, rujuk_masuk.kd_penyakit, penyakit.nm_penyakit, " +
            "rujuk_masuk.tindakan, rujuk_masuk.kategori_rujuk, rujuk_masuk.keterangan, rujuk_masuk.no_balasan, " +
            "poliklinik.nm_poli, " +
            "IFNULL(billing.tgl_byr,'') AS keluar, " +
            "IFNULL(diagnosa_pasien.kd_penyakit,'') AS diagnosa_awal, " +
            "IFNULL(kamar_inap.diagnosa_akhir,'') AS diagnosa_akhir, " +
            "IFNULL(reg_periksa.status_lanjut,'') AS status_lanjut " +
            "FROM reg_periksa " +
        ...
        for (int i = 1; i <= 14; i++) {
            if (i == 1)
                ...
                pstampil.setString(i, "%" + TCari.getText().trim() + "%");
        }
        ...
        while (rs.next()) {
            tabMode.addRow(new Object[]{
                ...
                rs.getString("kategori_rujuk"),
                rs.getString("nm_poli"),
                rs.getString("no_balasan"),
        ...
        try {
            ...
            System.out.println("Notif close : " + ex);
        }
    }
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            NoHP.setText(tbObat.getValueAt(tbObat.getSelectedRow(),3).toString());
            JMBPJS.setText(Valid.SetAngka2(Double.parseDouble(tbObat.getValueAt(tbObat.getSelectedRow(),4).toString())));
            NoRujuk.setText(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());
            TNoRw.setText(tbObat.getValueAt(tbObat.getSelectedRow(),6).toString());
            TNoRM.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());
            TPasien.setText(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
            Dokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
            KategoriRujuk.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
            NoBalasan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),20).toString());
            Keterangan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),21).toString());  
            kdDiagnosa.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());  
            NmDiagnosa.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());   
   ...
   private void isRawat() {
    try {
        pstampil = koneksi.prepareStatement(
            "SELECT reg_periksa.no_rkm_medis, pasien.nm_pasien, reg_periksa.kd_pj, reg_periksa.no_rawat " +
            "FROM reg_periksa " +
            "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
        ...
        if (rs.next()) {
            ...
            String kdPj = rs.getString("kd_pj");

            TNoRM.setText(rs.getString("no_rkm_medis"));
            TPasien.setText(rs.getString("nm_pasien"));

            if ("BPJ".equalsIgnoreCase(kdPj)) {
                // Jika pasien BPJS
                JMBPJS.setText("100000");
//                JMUmAs.setText("0");
            } else {
                // Jika pasien umum/asuransi lain
                double totalBiaya = 0;
                PreparedStatement psbiaya = koneksi.prepareStatement(
                    "SELECT IFNULL(SUM(totalbiaya),0) AS total FROM billing WHERE no_rawat = ?"
                );
                psbiaya.setString(1, noRawat);
                ResultSet rsbiaya = psbiaya.executeQuery();
                if (rsbiaya.next()) {
                    totalBiaya = rsbiaya.getDouble("total");
                }
                rsbiaya.close();
                psbiaya.close();

                double tigaPersen = totalBiaya * 0.03;

//                JMBPJS.setText("0");
                JMBPJS.setText(String.valueOf((int) tigaPersen));
            }
        } else {
...
//            JMUmAs.setText("0");
    ...
    public void tampil2() {        
        ...
        try{
            psperujuk=koneksi.prepareStatement("select rujuk_masuk.perujuk,rujuk_masuk.alamat,rujuk_masuk.nohp from rujuk_masuk where "+
                    "rujuk_masuk.perujuk like ? or rujuk_masuk.alamat like ? or rujuk_masuk.nohp like ? group by rujuk_masuk.perujuk order by rujuk_masuk.perujuk");
            try {
                psperujuk.setString(1,"%"+TCariPerujuk.getText()+"%");
                psperujuk.setString(2,"%"+TCariPerujuk.getText()+"%");
                psperujuk.setString(3,"%"+TCariPerujuk.getText()+"%");
    ...
    private void getData2() {
        if(tbPerujuk.getSelectedRow()!= -1){
            ...
            NoHP.setText(tbPerujuk.getValueAt(tbPerujuk.getSelectedRow(),2).toString());
        }
    }
