...
public class MenuBar extends JMenuBar {
    ...
    private final Color light = new Color(29, 114, 19);
    private final Color dark = new Color(29, 114, 19);
    private final Color black = new Color(29, 114, 19);
    private final Color warna = new Color(29, 114, 19);
