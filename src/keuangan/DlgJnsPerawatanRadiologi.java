 ...
 * @author dosen
 */
public final class DlgJnsPerawatanRadiologi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgJnsPerawatanRadiologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={
            "P","Kode Periksa","Nama Pemeriksaan","CoGS",
    ...
    private void initComponents() {
        ...
        jLabel18.setBounds(300, 40, 130, 23);
        ...
        FormInput.add(kdpnj);
        kdpnj.setBounds(440, 40, 60, 23);

        nmpnj.setEditable(false);
        nmpnj.setName("nmpnj"); // NOI18N
        FormInput.add(nmpnj);
        nmpnj.setBounds(500, 40, 192, 23);
        ...
        JMDokter.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JMDokterActionPerformed(evt);
            }
        });
        ...
        JMDokter.setBounds(440, 100, 250, 23);
        JMDokter.getAccessibleContext().setAccessibleDescription("");
        ...
        JMLaborat.setBounds(127, 132, 0, 0);
        JMLaborat.getAccessibleContext().setAccessibleDescription("");
        ...
        JMPerujuk.setBounds(127, 162, 0, 0);
        JMPerujuk.getAccessibleContext().setAccessibleDescription("");
        ...
        TotalBiaya.setBounds(127, 102, 170, 23);

        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("K.S.0.: Rp. ");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(650, 90, 153, 23);
        ...
        FormInput.add(KSO);
        KSO.setBounds(450, 100, 0, 0);
        KSO.getAccessibleContext().setAccessibleDescription("");

        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("Manajemen : Rp. ");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(300, 130, 153, 23);
        ...
        Menejemen.setBounds(450, 130, 0, 0);
        Menejemen.getAccessibleContext().setAccessibleDescription("");

        jLabel5.setText("J.M Dokter :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(300, 100, 130, 23);
        ...
        FormInput.add(Kelas);
        Kelas.setBounds(440, 70, 150, 23);

        jLabel17.setText("Kelas :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(300, 70, 130, 23);
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReportqry("rptTarifRad.jasper","report","::[ Data Tarif Radiologi ]::",
                    ...
                    " jns_perawatan_radiologi.status='1' and jns_perawatan_radiologi.kd_jenis_prw like '%"+TCari.getText().trim()+"%' or "+
    ...
    private void JMDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JMDokterActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JMDokterActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJnsPerawatanRadiologi dialog = new DlgJnsPerawatanRadiologi(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                        ...
                        "jns_perawatan_radiologi.status='1' and jns_perawatan_radiologi.nm_perawatan like ? or "+
