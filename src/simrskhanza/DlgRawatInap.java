...
import rekammedis.MasterCariTemplatePemeriksaanInap;
...
import rekammedis.RMSkriningRobson;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnTemplatePemeriksaanInap = new widget.Button();
        ...
        BtnRobson = new widget.Button();
        BtnPartograf = new widget.Button();
        ...
        BtnTemplatePemeriksaanInap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); 
        BtnTemplatePemeriksaanInap.setMnemonic('4');
        BtnTemplatePemeriksaanInap.setToolTipText("ALt+4");
        BtnTemplatePemeriksaanInap.setName("BtnTemplatePemeriksaanInap"); 
        BtnTemplatePemeriksaanInap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTemplatePemeriksaanInapActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnTemplatePemeriksaanInap);
        BtnTemplatePemeriksaanInap.setBounds(405, 40, 28, 23);
        ...
        BtnRobson.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnRobson.setText("Klasifikasi Robson");
        BtnRobson.setFocusPainted(false);
        BtnRobson.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnRobson.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnRobson.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRobson.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnRobson.setName("BtnRobson"); // NOI18N
        BtnRobson.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnRobson.setRoundRect(false);
        BtnRobson.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRobsonActionPerformed(evt);
            }
        });
        
        BtnPartograf.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPartograf.setText("Partograf");
        BtnPartograf.setFocusPainted(false);
        BtnPartograf.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPartograf.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPartograf.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPartograf.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPartograf.setName("BtnPartograf"); // NOI18N
        BtnPartograf.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnPartograf.setRoundRect(false);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnRobsonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRobsonActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMSkriningRobson form=new RMSkriningRobson(null,false);
            form.isCek();
    ...
    }//GEN-LAST:event_BtnRobsonActionPerformed
    ...
    private void BtnTemplatePemeriksaanInapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTemplatePemeriksaanInapActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else if(TPegawai.getText().trim().equals("")||KdPeg.getText().trim().equals("")){
...
//            } 
    ...
    }//GEN-LAST:event_BtnTemplatePemeriksaanInapActionPerformed
    ...
    */
    ...
    private widget.Button BtnRobson;
    private widget.Button BtnPartograf;
    ...
    private widget.Button BtnTemplatePemeriksaanInap;
    ...
    private widget.Button BtnSkorBromagePascaAnestesi,BtnPenilaianPreInduksi,BtnHasilPemeriksaanUSGUrologi,BtnHasilPemeriksaanUSGGynecologi,BtnHasilPemeriksaanEKG,BtnHasilPemeriksaanUSGNeonatus,BtnHasilEndoskopiFaringLaring,BtnHasilEndoskopiHidung,BtnHasilEndoskopiTelinga,
                          ...
                          BtnPelaksanaanInformasiEdukasi,BtnCatatanObservasiHemodialisa,BtnCatatanCairanHemodialisa,BtnCatatanPengkajianPaskaOperasi,BtnCatatanObservasiBayi;
    ...
    public void isCek(){
        ...
        BtnTemplatePemeriksaanInap.setEnabled(akses.gettemplate_pemeriksaan());
        ...
        BtnRobson.setVisible(akses.getskrining_robson()); 
        if(akses.getskrining_robson()==true){
            tinggi=tinggi+24;
        }
    ...
    private void inputTemplate(){
        if(perawatan.dokter.tampil3(KdPeg.getText()).equals("")){
            JOptionPane.showMessageDialog(null,"Template pemeriksaan hanya untuk dokter...!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            MasterCariTemplatePemeriksaanInap templatepemeriksaan=new MasterCariTemplatePemeriksaanInap(null,false);
