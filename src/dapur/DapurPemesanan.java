...
public class DapurPemesanan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DapurPemesanan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurPemesanan dialog = new DapurPemesanan(new javax.swing.JFrame(), true);
