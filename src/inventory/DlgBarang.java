...
public class DlgBarang extends javax.swing.JDialog {
    ...
    public DlgBarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
//           "P", "Kode Barang", "Nama Barang","Golongan", "Nm.Satuan Besar","Isi", "Nm.Satuan Kecil","Stok Minimal","Min","Max","Produsen",
//            "Distributor","LeadTime","Distribusi","Jml Total",
//            "Kps", "Kandungan","Hrg.Dasar(Rp)","COGS(Rp)", "Harga Jual(Rp)", "Ranap K1(Rp)", "Ranap K2(Rp)", "Ranap K3(Rp)",
...
//            "Kode Golongan","Golongan","Min","Max","Mutasi","Distribusi","Leadtime"
       tabMode = new DefaultTableModel(null,new Object[]{
                ...
                "Kd. Sat Besar",   // 7 (HIDDEN)
                "Nm.Satuan Besar", // 8
                "Kd. Sat Kecil",   // 9 (HIDDEN)
                "Nm.Satuan Kecil", // 10
                ...
                Class[] types = new Class[]{
                    ...
                    Object.class,   // 7 HIDDEN
                    Object.class,   // 8
                    Object.class,   // 9 HIDDEN
                    Object.class,   // 10

                    Double.class,   // 11
                    Object.class,   // 12 Kandungan
        ...
        int colCount = tbObat.getColumnCount();
        ...
        TableColumn column = tbObat.getColumnModel().getColumn(i);
            ...
            switch (i) {
                ...
                case 2: column.setPreferredWidth(220); break;
                ...
                case 7: // Kd Sat Besar (HIDDEN)
                case 9: // Kd Sat Kecil (HIDDEN)
                    column.setMinWidth(0);
                    column.setMaxWidth(0);
                    break;

                case 8:  // Nm Satuan Besar
                case 10: // Nm Satuan Kecil
    ...
    private void initComponents() {
        ...
        label26.setBounds(790, 250, 128, 23);

        kelas1.setForeground(new java.awt.Color(255, 255, 255));
        ...
        label14.setBounds(490, 280, 135, 23);
        ...
        kelasvip.setBounds(630, 102, 0, 23);
        ...
        kelasvvip.setBounds(630, 132, 0, 23);
        ...
        label36.setBounds(780, 170, 149, 23);
        ...
        beliluar.setBounds(630, 162, 0, 23);
        ...
        jualbebas.setBounds(630, 192, 0, 23);
        ...
        label37.setBounds(760, 190, 149, 23);
        ...
        label38.setBounds(760, 230, 149, 23);
        ...
        karyawan.setBounds(630, 222, 0, 23);

        DTPExpired.setForeground(new java.awt.Color(50, 70, 50));
        DTPExpired.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-12-2025" }));
        ...
        DTPExpired.setBounds(370, 280, 110, 23);
        ...
        ChkKadaluarsa.setLabel("Tgl Exp :");
        ChkKadaluarsa.setName("ChkKadaluarsa"); // NOI18N
        ChkKadaluarsa.setOpaque(false);
        ChkKadaluarsa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkKadaluarsaActionPerformed(evt);
            }
        });
        FormInput.add(ChkKadaluarsa);
        ChkKadaluarsa.setBounds(210, 280, 151, 23);
        ...
        kdkategori.setBounds(92, 192, 90, 23);
        ...
        nmkategori.setBounds(184, 192, 268, 23);
        ...
        nmgolongan.setBounds(184, 222, 268, 23);
        ...
        kdgolongan.setBounds(92, 222, 90, 23);
        ...
        kdsatBesar.setBounds(92, 102, 60, 23);
        ...
        nmsatBesar.setBounds(154, 102, 148, 23);
        ...
        FormInput.add(dasar);
        dasar.setBounds(109, 252, 110, 23);
        ...
        label15.setBounds(490, 190, 135, 23);

        max.setHighlighter(null);
        max.setName("max"); // NOI18N
        max.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                maxMouseMoved(evt);
            }
        });
        ...
        FormInput.add(min);
        min.setBounds(630, 160, 100, 23);

        label17.setText("LeadTime : ");
        label17.setName("label17"); // NOI18N
        label17.setPreferredSize(new java.awt.Dimension(85, 23));
        FormInput.add(label17);
        label17.setBounds(490, 220, 135, 23);

        leadtime.setHighlighter(null);
        leadtime.setName("leadtime"); // NOI18N
        leadtime.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                leadtimeMouseMoved(evt);
            }
        });
        leadtime.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseExited(java.awt.event.MouseEvent evt) {
                leadtimeMouseExited(evt);
            }
        });
        ...
        FormInput.add(leadtime);
        leadtime.setBounds(630, 220, 100, 23);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                Sequel.mengedit("databarang","kode_brng='"+tbObat.getValueAt(i, 1).toString()+"'","status='0'");
                tabMode.removeRow(i);
                i--;
            }
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            if(Valid.editTabletf(tabMode, "databarang", "kode_brng", "?", "nama_brng=?,kode_brng=?,kapasitas=?,kode_sat=?,letak_barang=?,"
                ...
                tbObat.setValueAt(Kd.getText(),tbObat.getSelectedRow(),1);
                tbObat.setValueAt(Nm.getText(),tbObat.getSelectedRow(),2);
                tbObat.setValueAt(kdsatBesar.getText(),tbObat.getSelectedRow(),3);
                tbObat.setValueAt(nmsatBesar.getText(),tbObat.getSelectedRow(),4);
                tbObat.setValueAt(Double.parseDouble(Isi.getText()),tbObat.getSelectedRow(),5);
                tbObat.setValueAt(kdsat.getText(),tbObat.getSelectedRow(),6);
                tbObat.setValueAt(nmsat.getText(),tbObat.getSelectedRow(),7);
                tbObat.setValueAt(Double.parseDouble(Kapasitas.getText()),tbObat.getSelectedRow(),8);
                tbObat.setValueAt(Letak.getText(),tbObat.getSelectedRow(),9);
                tbObat.setValueAt(Double.parseDouble(dasar.getText()),tbObat.getSelectedRow(),10);
                tbObat.setValueAt(Double.parseDouble(beli.getText()),tbObat.getSelectedRow(),11);
                tbObat.setValueAt(Double.parseDouble(ralan.getText()),tbObat.getSelectedRow(),12);
                tbObat.setValueAt(Double.parseDouble(kelas1.getText()),tbObat.getSelectedRow(),13);
                tbObat.setValueAt(Double.parseDouble(kelas2.getText()),tbObat.getSelectedRow(),14);
                tbObat.setValueAt(Double.parseDouble(kelas3.getText()),tbObat.getSelectedRow(),15);
                tbObat.setValueAt(Double.parseDouble(utama.getText()),tbObat.getSelectedRow(),16);
                tbObat.setValueAt(Double.parseDouble(kelasvip.getText()),tbObat.getSelectedRow(),17);
                tbObat.setValueAt(Double.parseDouble(kelasvvip.getText()),tbObat.getSelectedRow(),18);
                tbObat.setValueAt(Double.parseDouble(beliluar.getText()),tbObat.getSelectedRow(),19);
                tbObat.setValueAt(Double.parseDouble(jualbebas.getText()),tbObat.getSelectedRow(),20);
                tbObat.setValueAt(Double.parseDouble(karyawan.getText()),tbObat.getSelectedRow(),21);
                tbObat.setValueAt(Double.parseDouble(stok_minimal.getText()),tbObat.getSelectedRow(),22);
                tbObat.setValueAt(kdjns.getText(),tbObat.getSelectedRow(),23);
                tbObat.setValueAt(nmjns.getText(),tbObat.getSelectedRow(),24);
                tbObat.setValueAt(tanggal,tbObat.getSelectedRow(),25);
                tbObat.setValueAt(KdIF.getText(),tbObat.getSelectedRow(),26);
                tbObat.setValueAt(NmIF.getText(),tbObat.getSelectedRow(),27);
                tbObat.setValueAt(kdkategori.getText(),tbObat.getSelectedRow(),28);
...
private void KapasitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KapasitasKeyPressed
    ...
    private void ChkKadaluarsaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkKadaluarsaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ChkKadaluarsaActionPerformed

    private void maxMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_maxMouseMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_maxMouseMoved
    ...
    private void leadtimeMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_leadtimeMouseMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_leadtimeMouseMoved

    private void leadtimeMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_leadtimeMouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_leadtimeMouseExited
                   ...
                   while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("nama_brng"),             // 2
                         rs.getString("expire"),  
                        rs.getString("jenis_nama"),              // 3
                       
                        rs.getDouble("dasar"),                 // 4
                        rs.getDouble("h_beli"),                // 5
                        rs.getDouble("ralan"),                 // 6 (Harga jual)

                        rs.getString("kode_satbesar"),         // 7 (HIDDEN)
                        rs.getString("satuanbesar"),           // 8
                        rs.getString("kode_sat"),              // 9 (HIDDEN)
                        rs.getString("satuan"),                // 10

                        rs.getDouble("stokminimal"),           // 11
                        rs.getString("letak_barang"),             // 12

                        "",                                    // 13 Min
                        "",                                    // 14 Max
                        rs.getString("nama_industri"),         // 15 Produsen
                        "",                                    // 16 Distributor
                        "",                                    // 17 LeadTime
                        "",                                    // 18 Distribusi

                        rs.getDouble("kapasitas")              // 19 Jml Total
                    });
                }
  ...
  "select databarang.kode_brng, databarang.nama_brng, databarang.kode_satbesar, satuanbesar.satuan as satuanbesar, " +
  "databarang.isi, databarang.kode_sat, kodesatuan.satuan, databarang.letak_barang, " +

  "IFNULL(data_batch.dasar,0) as dasar, " +
  "IFNULL(data_batch.h_beli,0) as h_beli, " +
  "IFNULL(data_batch.ralan,0) as ralan, " +
  "IFNULL(data_batch.kelas1,0) as kelas1, " +
  "IFNULL(data_batch.kelas2,0) as kelas2, " +
  "IFNULL(data_batch.kelas3,0) as kelas3, " +

  "detail_pemberian_obat.no_batch, " +

  "IFNULL(data_batch.utama,0) as utama, " +
  "IFNULL(databarang.vip,0) as vip, " +
  "IFNULL(data_batch.vvip,0) as vvip, " +
  "IFNULL(data_batch.beliluar,0) as beliluar, " +
  "IFNULL(data_batch.jualbebas,0) as jualbebas, " +
  "IFNULL(data_batch.karyawan,0) as karyawan, " +

  "IFNULL(databarang.stokminimal,0) as stokminimal, databarang.kdjns, detail_pemberian_obat.no_faktur, " +
  "jenis.nama, kapasitas, databarang.expire, databarang.kode_industri, industrifarmasi.nama_industri, " +
  "databarang.kode_kategori, kategori_barang.nama as kategori, databarang.kode_golongan, golongan_barang.nama as golongan " +
  "from data_batch ... "
);
try {
  ...
  "from data_batch ... "
    ...
    private void getData() {
      ...
      String kode = tbObat.getValueAt(row, 1).toString();
      ...
      try {
          String sql =
              "SELECT databarang.kode_brng, databarang.nama_brng, " +
              "       databarang.kode_satbesar, satuanbesar.satuan AS satuanbesar, " +
              "       databarang.isi, databarang.kode_sat, kodesatuan.satuan, " +
              "       databarang.letak_barang, databarang.dasar, databarang.h_beli, " +
              "       databarang.ralan, databarang.kelas1, databarang.kelas2, databarang.kelas3, " +
              "       databarang.utama, databarang.vip, databarang.vvip, " +
              "       databarang.beliluar, databarang.jualbebas, databarang.karyawan, " +
              "       databarang.stokminimal, databarang.kdjns, jenis.nama AS nm_jenis, " +
              "       databarang.kapasitas, databarang.expire, " +
              "       databarang.kode_industri, industrifarmasi.nama_industri, " +
              "       databarang.kode_kategori, kategori_barang.nama AS kategori, " +
              "       databarang.kode_golongan, golongan_barang.nama AS golongan, " +
          ...
          if (rs.next()) {
              ...
              Kd.setText(rs.getString("kode_brng"));
              Nm.setText(rs.getString("nama_brng"));

        
              kdsatBesar.setText(rs.getString("kode_satbesar"));
              nmsatBesar.setText(rs.getString("satuanbesar"));
              Isi.setText(rs.getString("isi"));

              kdsat.setText(rs.getString("kode_sat"));
              nmsat.setText(rs.getString("satuan"));

           
              Kapasitas.setText(rs.getString("kapasitas"));
            
          
              dasar.setText(rs.getString("dasar"));
              beli.setText(rs.getString("h_beli"));
              ralan.setText(rs.getString("ralan"));
              kelas1.setText(rs.getString("kelas1"));
              kelas2.setText(rs.getString("kelas2"));
              kelas3.setText(rs.getString("kelas3"));
              utama.setText(rs.getString("utama"));
              kelasvip.setText(rs.getString("vip"));
              kelasvvip.setText(rs.getString("vvip"));
              beliluar.setText(rs.getString("beliluar"));
              jualbebas.setText(rs.getString("jualbebas"));
              karyawan.setText(rs.getString("karyawan"));

           
              stok_minimal.setText(rs.getString("stokminimal"));
               Letak.setText(rs.getString("letak_barang"));

            
              kdjns.setText(rs.getString("kdjns"));
              nmjns.setText(rs.getString("nm_jenis"));

            
              KdIF.setText(rs.getString("kode_industri"));
              NmIF.setText(rs.getString("nama_industri"));

            
              kdkategori.setText(rs.getString("kode_kategori"));
              nmkategori.setText(rs.getString("kategori"));

          
              kdgolongan.setText(rs.getString("kode_golongan"));
              nmgolongan.setText(rs.getString("golongan"));

              // Expired
              String exp = rs.getString("expire");
              if (exp == null || exp.trim().equals("")) {
                  ChkKadaluarsa.setSelected(false);
                  DTPExpired.setDate(new Date());
              } else {
                  ChkKadaluarsa.setSelected(true);
                  Valid.SetTgl(DTPExpired, exp);
              }
          }

      } catch (Exception e) {
          System.out.println("Notif getData : " + e);
      } finally {
          try {
              if (rs != null) rs.close();
              if (ps != null) ps.close();
                    ...
                    switch (pengaturanharga) {
                        case "Per Jenis":
                            if(kdjns.getText().equals("")){
                                ...
                                try{
                                    rs=koneksi.prepareStatement("select * from setpenjualan where setpenjualan.kdjns='"+kdjns.getText()+"'").executeQuery();
                                    if(rs.next()){
                        ...
                        case "Per Barang":
                            if(Kd.getText().equals("")){
                                ...
                                try{
                                    rs=koneksi.prepareStatement("select * from setpenjualanperbarang where setpenjualanperbarang.kode_brng='"+Kd.getText()+"'").executeQuery();
                                    if(rs.next()){
                                        ralan.setText(Double.toString(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("ralan") / 100)),100)));
                                        kelas1.setText(Double.toString(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("kelas1") / 100)),100)));
                                        kelas2.setText(Double.toString(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("kelas2") / 100)),100)));
