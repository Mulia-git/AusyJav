 ...
 * @author perpustakaan
 */
public final class RMDataKK3Ranap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataKK3Ranap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        });
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data KK3 Pasien Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
           ...
           if(Sequel.menyimpantf("datakk3_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",34,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataKK3Ranap dialog = new RMDataKK3Ranap(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps = koneksi.prepareStatement(
                    ...
                    "       datakk3_ranap.tgl_periksa, " +
                    "       datakk3_ranap.kd_dokter, " +
                    "       datakk3_ranap.jns_dokter, " +
                    "       datakk3_ranap.no_peserta, " +
                    "       datakk3_ranap.mitra, " +
                    "       datakk3_ranap.tgl_kecelakaan, " +
                    "       datakk3_ranap.anamnesa, " +
                    "       datakk3_ranap.fisik, " +
                    "       datakk3_ranap.tatalaksana, " +
                    "       datakk3_ranap.diagnose, " +
                    "       datakk3_ranap.komplikasi_pilih, " +
                    "       datakk3_ranap.komplikasi, " +
                    "       datakk3_ranap.sembuh, " +
                    "       datakk3_ranap.anatomis_pilih, " +
                    "       datakk3_ranap.anatomis, " +
                    "       datakk3_ranap.fungsi_pilih, " +
                    "       datakk3_ranap.fungsi, " +
                    "       datakk3_ranap.fungsi_besar, " +
                    "       datakk3_ranap.fungsi_terbilang, " +
                    "       datakk3_ranap.prothesa_pilih, " +
                    "       datakk3_ranap.prothesa, " +
                    "       datakk3_ranap.orthesa_pilih, " +
                    "       datakk3_ranap.orthesa, " +
                    "       datakk3_ranap.meninggal_pilih, " +
                    "       datakk3_ranap.meninggal, " +
                    "       datakk3_ranap.meninggal_jam, " +
                    "       datakk3_ranap.setelah_pilih, " +
                    "       datakk3_ranap.setelah, " +
                    "       datakk3_ranap.lama_awal, " +
                    "       datakk3_ranap.lama_akhir, " +
                    "       datakk3_ranap.istirahat_awal, " +
                    "       datakk3_ranap.istirahat_akhir, " +
                    "       datakk3_ranap.keterangan, " +
                    "       dokter.nm_dokter " +
                    "FROM reg_periksa " +
                    "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
                    "INNER JOIN datakk3_ranap ON reg_periksa.no_rawat = datakk3_ranap.no_rawat " +
                    "INNER JOIN dokter ON datakk3_ranap.kd_dokter = dokter.kd_dokter " +
                    "WHERE datakk3_ranap.tgl_periksa = ? " +
                    "ORDER BY datakk3_ranap.tgl_periksa"
                );
            }else{
                ps = koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,"+
                    "datakk3_ranap.tgl_periksa, datakk3_ranap.kd_dokter, " +
                    "datakk3_ranap.jns_dokter, datakk3_ranap.no_peserta,datakk3_ranap.mitra, datakk3_ranap.tgl_kecelakaan, " +
                    "datakk3_ranap.anamnesa, datakk3_ranap.fisik, datakk3_ranap.tatalaksana, " +
                    "datakk3_ranap.diagnose, datakk3_ranap.komplikasi_pilih, datakk3_ranap.komplikasi, " +
                    "datakk3_ranap.sembuh, datakk3_ranap.anatomis_pilih, datakk3_ranap.anatomis, " +
                    "datakk3_ranap.fungsi_pilih, datakk3_ranap.fungsi, datakk3_ranap.fungsi_besar, " +
                    "datakk3_ranap.fungsi_terbilang, datakk3_ranap.prothesa_pilih, datakk3_ranap.prothesa, " +
                    "datakk3_ranap.orthesa_pilih, datakk3_ranap.orthesa, datakk3_ranap.meninggal_pilih, " +
                    "datakk3_ranap.meninggal, datakk3_ranap.meninggal_jam, datakk3_ranap.setelah_pilih, datakk3_ranap.setelah, " +
                    "datakk3_ranap.lama_awal, datakk3_ranap.lama_akhir, datakk3_ranap.istirahat_awal, " +
                    "datakk3_ranap.istirahat_akhir, datakk3_ranap.keterangan, dokter.nm_dokter " +
                    "FROM reg_periksa " +
                    "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
                    "INNER JOIN datakk3_ranap ON reg_periksa.no_rawat = datakk3_ranap.no_rawat " +
                    "INNER JOIN dokter ON datakk3_ranap.kd_dokter = dokter.kd_dokter " +
                    ...
                    "OR pasien.nm_pasien LIKE ? OR datakk3_ranap.kd_dokter LIKE ? " +
    ...
    private void isRawat() {
        try {
            ps=koneksi.prepareStatement(
                ...
                "concat(pasien.nm_pasien,' (',reg_periksa.umurdaftar,' ',reg_periksa.sttsumur,')') as nm_pasien, " +
                "reg_periksa.tgl_registrasi, reg_periksa.jam_reg, " +
                "dpjp_ranap.kd_dokter, dokter.nm_dokter, " + // ambil dari dpjp_ranap
                ...
                "kamar_inap.diagnosa_awal, kamar_inap.kd_kamar, bangsal.nm_bangsal " +
                "from reg_periksa " +
                "inner join pasien on pasien.no_rkm_medis = reg_periksa.no_rkm_medis " +
                "inner join dpjp_ranap on dpjp_ranap.no_rawat = reg_periksa.no_rawat " + // join ke dpjp_ranap
                "inner join dokter on dokter.kd_dokter = dpjp_ranap.kd_dokter " +        // dokter sesuai dpjp_ranap
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    LamaPulang.setText(rs.getString("tgl_keluar"));
...
//        ppBerkasDigital.setEnabled(akses.getberkas_digital_perawatan()); 
    ...
    private void hapus() {
         if(Sequel.queryu2tf("delete from datakk3_ranap where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
        })==true){
