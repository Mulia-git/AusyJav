...
public class DapurPengeluaran extends javax.swing.JDialog {
    ...
    private DapurCariPengeluaran form=new DapurCariPengeluaran(null,false);
     ...
     * @param parent
     * @param modal */
    public DapurPengeluaran(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        form.petugas.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgPengeluaranDapur")){
        ...
        if(NoKeluar.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if(sukses==true){
                    ...
                    if(Sequel.menyimpantf2("tampjurnal","?,?,?,?",4,new String[]{Sequel.cariIsi("select Kontra_Stok_Keluar_Dapur from set_akun"),"KAS DI TANGAN","0",""+(ttl)})==false){
                        sukses=false;
                    }
                    if(sukses==true){
...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
        akses.setform("DlgPengeluaranDapur");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurPengeluaran dialog = new DapurPengeluaran(new javax.swing.JFrame(), true);
