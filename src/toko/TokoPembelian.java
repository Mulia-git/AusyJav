...
public class TokoPembelian extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public TokoPembelian(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] judul={"Jml","Kode Barang","Nama Barang","Satuan","G","Harga(Rp)","Subtotal(Rp)","Disk(%)","Diskon(Rp)","Total","Dasar","Distributor","Grosir","Retail"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Transaksi Pengadaan Barang Toko / Minimarket / Koperasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
                ...
                if(Sequel.menyimpantf2("tokopembelian","?,?,?,?,?,?,?,?,?,?,?","No.Faktur",11,new String[]{
                    ...
                    for(i=0;i<jml;i++){  
                        ...
                        if(Valid.SetAngka(tbDokter.getValueAt(i,0).toString())>0){
                            if(Sequel.menyimpantf2("toko_detail_beli","?,?,?,?,?,?,?,?,?","Transaksi Pengadaan",9,new String[]{
    ...
    */
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            ...
            BtnSimpan.setEnabled(akses.gettoko_pengadaan_barang());
    ...
    private void autoNomor() {
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(tokopembelian.no_faktur,3),signed)),0) from tokopembelian where tokopembelian.tgl_beli='"+Valid.SetTgl(TglBeli.getSelectedItem()+"")+"'","PT"+TglBeli.getSelectedItem().toString().substring(6,10)+TglBeli.getSelectedItem().toString().substring(3,5)+TglBeli.getSelectedItem().toString().substring(0,2),3,NoFaktur); 
    }
