...
public class TokoPengajuanBarang extends javax.swing.JDialog {
    ...
    private String[] jumlah,kodebarang,namabarang,satuan,tokojenisbarang;
    private Double[] h_beli,subtotal;
     ...
     * @param parent
     * @param modal */
    public TokoPengajuanBarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] judul={"Jml","Kode Barang","Nama Barang","Satuan","Jenis Barang","Harga Pengajuan","Sub Total"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengajuan Pengadaan/Pembelian Barang Toko / Minimarket / Koperasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        TokoCariPengajuanBarang form=new TokoCariPengajuanBarang(null,false);
        form.emptTeks(); 
        form.isCek();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoPengajuanBarang dialog = new TokoPengajuanBarang(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        try{
            ...
            tokojenisbarang=null;
            tokojenisbarang=new String[jml];
            h_beli=null;
            ...
            for(i=0;i<row;i++){
                if(!tbDokter.getValueAt(i,0).toString().equals("")){
                    ...
                    tokojenisbarang[index]=tbDokter.getValueAt(i,4).toString();
            ...
            ps=koneksi.prepareStatement(
                "select tokobarang.kode_brng,tokobarang.nama_brng,tokobarang.kode_sat,tokojenisbarang.nm_jenis,"+
