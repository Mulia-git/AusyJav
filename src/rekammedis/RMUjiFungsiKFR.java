...
public final class RMUjiFungsiKFR extends javax.swing.JDialog {
    ...
    public RMUjiFungsiKFR(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Umur","JK","Tgl.Lahir","Tanggal Uji","Diagnosis Fugsional","Diagnosis Medis","Hasil Yang Didapat","Kesimpulan","Rekomendasi","Treatment","Kode Dokter","Nama Dokter"
        }){
        ...
        Treatment.setDocument(new batasInput((int)100).getKata(Treatment));
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 290));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-07-2025" }));
        ...
        jLabel23.setText("Goal of Treatment :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(0, 240, 135, 23);

        Treatment.setFocusTraversalPolicyProvider(true);
        ...
        FormInput.add(Treatment);
        Treatment.setBounds(140, 240, 650, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(Treatment.getText().trim().equals("")){
            Valid.textKosong(Treatment,"Treatment");
        }else{
            if(Sequel.menyimpantf("uji_fungsi_kfr","?,?,?,?,?,?,?,?,?","Data",9,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
                DiagnosisFungsional.getText(),DiagnosisMedis.getText(),HasilYangDidapat.getText(),Kesimpulan.getText(),Rekomendasi.getText(),Treatment.getText(),KdDokter.getText()
            })==true){
                tampil();
                emptTeks();
            }   
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptUjiFungsiKFR.jasper","report","::[ Data Uji Fugsi/Prosedur KFR ]::",
                    ...
                    "uji_fungsi_kfr.kesimpulan,uji_fungsi_kfr.rekomedasi,uji_fungsi_kfr.treatment,uji_fungsi_kfr.kd_dokter,dokter.nm_dokter,date_format(pasien.tgl_lahir,'%d-%m-%Y') as lahir "+
    ...
    private void RekomendasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RekomendasiKeyPressed
        Valid.pindah(evt,Kesimpulan,Treatment);
    ...
    private void TreatmentKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TreatmentKeyPressed
        Valid.pindah(evt,Rekomendasi,BtnSimpan);// TODO add your handling code here:
    ...
    */
    ...
    private widget.TextBox Treatment;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("rekomedasi"),rs.getString("treatment"),rs.getString("kd_dokter"),rs.getString("nm_dokter")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Treatment.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            PanelInput.setPreferredSize(new Dimension(WIDTH,294));
    ...
    private void ganti() {
        Sequel.mengedit("uji_fungsi_kfr","no_rawat=?","no_rawat=?,tanggal=?,diagnosis_fungsional=?,diagnosis_medis=?,hasil_didapat=?,kesimpulan=?,rekomedasi=?,treatment=?,kd_dokter=?",9,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            DiagnosisFungsional.getText(),DiagnosisMedis.getText(),HasilYangDidapat.getText(),Kesimpulan.getText(),Rekomendasi.getText(),Treatment.getText(),KdDokter.getText(),
