...
public final class DlgAuditCuciTanganMedis extends javax.swing.JDialog {
    ...
    public DlgAuditCuciTanganMedis(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"P","Tanggal Audit","NIP/Kode","Dokter/Paramedis","Sebelum Menyentuh Pasien","Sebelum Tehnik Aseptik",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(int i=0;i<tbObat.getRowCount();i++){ 
            if(tbObat.getValueAt(i,0).toString().equals("true")){
                if(Sequel.queryutf("delete from audit_cuci_tangan_medis where nik='"+tbObat.getValueAt(i,2).toString()+"' "+
                              "and tanggal='"+tbObat.getValueAt(i,1).toString()+"'")==true){
                    tabMode.removeRow(i);
                    i--;
                }
            }
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        false,rs.getString("tanggal"),rs.getString("nik"),rs.getString("nama"),rs.getString("sebelum_menyentuh_pasien"),rs.getString("sebelum_tehnik_aseptik"),
                ...
                if(i>0){
                    tabMode.addRow(new Object[]{
                        false,"","Ya",":",""+ttlsebelum_menyentuh_pasien,""+ttlsebelum_tehnik_aseptik,""+ttlsetelah_terpapar_cairan_tubuh_pasien,
                    ...
                    tabMode.addRow(new Object[]{
                        false,"","Tidak",":",""+(i-ttlsebelum_menyentuh_pasien),""+(i-ttlsebelum_tehnik_aseptik),""+(i-ttlsetelah_terpapar_cairan_tubuh_pasien),
                    ...
                    tabMode.addRow(new Object[]{
                        false,"","Rata-rata",":",Math.round((ttlsebelum_menyentuh_pasien/i)*100)+" %",Math.round((ttlsebelum_tehnik_aseptik/i)*100)+" %",Math.round((ttlsetelah_terpapar_cairan_tubuh_pasien/i)*100)+" %",
