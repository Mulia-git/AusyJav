...
public final class RMLayananKedokteranFisikRehabilitasi extends javax.swing.JDialog {
    ...
    public RMLayananKedokteranFisikRehabilitasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Program","Pendamping","Anamnesa","Pemeriksaan Fisik & Uji Fungsi","Diagnosis Medis (ICD - 10)",
            "Diagnosis Fungsi (ICD - 10)","Tata Laksana KFR (ICD - 9 CM)","Pemeriksaan Penunjang","Anjuran","Evaluasi","Lama Terapi",
            "Goal Of Treatment","Suspek Akibat Kerja", "Keterangan Suspek Penyakit"
        }){
        ...
        Penunjang.setDocument(new batasInput((int)2000).getKata(Penunjang));
        Anjuran.setDocument(new batasInput((int)500).getKata(Anjuran));
        Evaluasi.setDocument(new batasInput((int)500).getKata(Evaluasi));
        Lama.setDocument(new batasInput((int)500).getKata(Lama));
        Treatment.setDocument(new batasInput((int)500).getKata(Treatment));
    ...
    private void initComponents() {
        ...
        Lama = new widget.TextArea();
        jLabel110 = new widget.Label();
        scrollPane19 = new widget.ScrollPane();
        Treatment = new widget.TextArea();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 959));
        ...
        scrollPane9.setBounds(60, 210, 810, 70);

        jLabel101.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel101.setText("Anamnesa :");
        jLabel101.setName("jLabel101"); // NOI18N
        FormInput.add(jLabel101);
        jLabel101.setBounds(30, 110, 190, 23);
        ...
        scrollPane12.setBounds(60, 310, 810, 43);

        jLabel102.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel102.setText("Pemeriksaan Fisik & Uji Fungsi :");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(30, 190, 190, 23);
        ...
        scrollPane6.setBounds(60, 130, 810, 53);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-08-2025 14:39:17" }));
        ...
        jSeparator11.setBounds(20, 110, 880, 1);
        ...
        Pendamping.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Assesmen", "Re-Assesmen", "Evaluasi" }));
        ...
        Pendamping.setBounds(80, 70, 280, 23);
        ...
        KeteranganPendamping.setBounds(644, 40, 210, 23);

        jLabel105.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel105.setText("Diagnosis Fungsi (ICD - 10) :");
        jLabel105.setName("jLabel105"); // NOI18N
        FormInput.add(jLabel105);
        jLabel105.setBounds(30, 360, 220, 23);
        ...
        scrollPane14.setBounds(60, 380, 810, 43);

        jLabel106.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel106.setText("Tata Laksana KFR (ICD - 9 CM) :");
        jLabel106.setName("jLabel106"); // NOI18N
        FormInput.add(jLabel106);
        jLabel106.setBounds(30, 430, 220, 23);
        ...
        scrollPane15.setBounds(60, 450, 810, 50);

        jLabel107.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel107.setText("Anjuran :");
        jLabel107.setName("jLabel107"); // NOI18N
        FormInput.add(jLabel107);
        jLabel107.setBounds(30, 580, 220, 23);
        ...
        scrollPane16.setBounds(60, 600, 810, 53);
        ...
        SuspekPenyakit.setBounds(190, 910, 80, 23);

        jLabel48.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel48.setText("Suspek Penyakit Akibat Kerja ");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(40, 910, 180, 23);
        ...
        KeteranganSuspekPenyakit.setBounds(270, 910, 609, 23);

        jLabel49.setText(":");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(30, 910, 158, 23);

        jLabel108.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel108.setText("Pemeriksaan Penunjang :");
        jLabel108.setName("jLabel108"); // NOI18N
        FormInput.add(jLabel108);
        jLabel108.setBounds(30, 510, 220, 23);
        ...
        scrollPane17.setViewportView(Penunjang);

        FormInput.add(scrollPane17);
        scrollPane17.setBounds(60, 530, 810, 50);

        jLabel109.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel109.setText("Lama Terapi :");
        jLabel109.setName("jLabel109"); // NOI18N
        FormInput.add(jLabel109);
        jLabel109.setBounds(30, 740, 190, 23);
        ...
        Lama.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Lama.setColumns(20);
        Lama.setRows(20);
        ...
        scrollPane18.setViewportView(Lama);

        FormInput.add(scrollPane18);
        scrollPane18.setBounds(60, 760, 810, 53);

        jLabel110.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel110.setText("Goal of Treatment :");
        jLabel110.setName("jLabel110"); // NOI18N
        FormInput.add(jLabel110);
        jLabel110.setBounds(30, 820, 190, 23);
        ...
        Treatment.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Treatment.setColumns(20);
        Treatment.setRows(20);
        Treatment.setName("Treatment"); // NOI18N
        Treatment.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TreatmentKeyPressed(evt);
            }
        });
        scrollPane19.setViewportView(Treatment);

        FormInput.add(scrollPane19);
        scrollPane19.setBounds(60, 840, 810, 53);

        jLabel50.setText("Program :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(0, 70, 70, 23);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-08-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-08-2025" }));
            ...
            try{
                ...
                htmlContent.append(                             
                    "<tr class='isi'>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Program</b></td>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Lama Terapi</b></td>"+
                        "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Goal of Treatment</b></td>"+
    ...
    private void EvaluasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_EvaluasiKeyPressed
        Valid.pindah2(evt,Anjuran,Lama);
    ...
    private void MnLayananRehabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLayananRehabActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakLayananKedokteranFisikRehabilitasi.jasper","report","::[ Lembar Formulir Layanan Rawat Jalan Kedokteran Fisik & Rehabilitasi ]::",
                        ...
                        "layanan_kedokteran_fisik_rehabilitasi.tanggal, layanan_kedokteran_fisik_rehabilitasi.kd_dokter, dokter.nm_dokter, layanan_kedokteran_fisik_rehabilitasi.pendamping," +
                        "layanan_kedokteran_fisik_rehabilitasi.keterangan_pendamping, layanan_kedokteran_fisik_rehabilitasi.anamnesa, layanan_kedokteran_fisik_rehabilitasi.pemeriksaan_fisik," +
                        "layanan_kedokteran_fisik_rehabilitasi.diagnosa_medis, layanan_kedokteran_fisik_rehabilitasi.diagnosa_fungsi, layanan_kedokteran_fisik_rehabilitasi.tatalaksana," +
                        "layanan_kedokteran_fisik_rehabilitasi.penunjang, layanan_kedokteran_fisik_rehabilitasi.anjuran, layanan_kedokteran_fisik_rehabilitasi.evaluasi," +
                        "layanan_kedokteran_fisik_rehabilitasi.lama, layanan_kedokteran_fisik_rehabilitasi.treatment, layanan_kedokteran_fisik_rehabilitasi.suspek_penyakit_kerja," +
                        "layanan_kedokteran_fisik_rehabilitasi.keterangan_suspek_penyakit_kerja, kelurahan.nm_kel, kecamatan.nm_kec, kabupaten.nm_kab, propinsi.nm_prop, poliklinik.nm_poli,  pasien.alamat" +
                        "FROM reg_periksa INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis INNER JOIN kelurahan ON kelurahan.kd_kel = pasien.kd_kel" +
                        ...
                        "INNER JOIN dokter ON layanan_kedokteran_fisik_rehabilitasi.kd_dokter = dokter.kd_dokter WHERE layanan_kedokteran_fisik_rehabilitasi.no_rawat ='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    private void TatalaksanaKFRKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TatalaksanaKFRKeyPressed
        Valid.pindah2(evt,DiagnosisFungsi,Penunjang);
    ...
    private void AnjuranKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AnjuranKeyPressed
        Valid.pindah2(evt,Penunjang,Evaluasi);
    ...
    private void MnLayananProgramKFRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLayananProgramKFRActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirLayananProgramKFR.jasper","report","::[ Formulir Layanan Program KFR ]::",
                ...
                "layanan_program_kfr.tanggal, layanan_program_kfr.no_rawat_layanan, layanan_kedokteran_fisik_rehabilitasi.diagnosa_medis, REPLACE(REPLACE(REPLACE(layanan_kedokteran_fisik_rehabilitasi.tatalaksana,'\t',''),'\n','; '),'\r','; ') AS tatalaksana, "+
                "layanan_kedokteran_fisik_rehabilitasi.penunjang, layanan_kedokteran_fisik_rehabilitasi.lama, layanan_kedokteran_fisik_rehabilitasi.treatment, layanan_program_kfr.program, layanan_program_kfr.nip, "+
                "petugas.nama, REPLACE(REPLACE(REPLACE(layanan_kedokteran_fisik_rehabilitasi.evaluasi,'\t',''),'\n','; '),'\r','; ') AS evaluasi, layanan_kedokteran_fisik_rehabilitasi.kd_dokter, dokter.nm_dokter, NOW() AS sekarang "+
                "FROM layanan_program_kfr INNER JOIN reg_periksa ON layanan_program_kfr.no_rawat = reg_periksa.no_rawat INNER JOIN pasien  ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis "+
                "INNER JOIN petugas ON layanan_program_kfr.nip = petugas.nip INNER JOIN layanan_kedokteran_fisik_rehabilitasi ON layanan_kedokteran_fisik_rehabilitasi.no_rawat = layanan_program_kfr.no_rawat_layanan "+
    ...
    private void PenunjangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PenunjangKeyPressed
        Valid.pindah2(evt,TatalaksanaKFR,Anjuran);// TODO add your handling code here:
    }//GEN-LAST:event_PenunjangKeyPressed

    private void LamaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LamaKeyPressed
        Valid.pindah2(evt,Evaluasi,Treatment);// TODO add your handling code here:
    }//GEN-LAST:event_LamaKeyPressed

    private void TreatmentKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TreatmentKeyPressed
        Valid.pindah2(evt,Lama,SuspekPenyakit);// TODO add your handling code here:
    }//GEN-LAST:event_TreatmentKeyPressed
    ...
    */
    ...
    private widget.TextArea Treatment;
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "layanan_kedokteran_fisik_rehabilitasi.diagnosa_fungsi,layanan_kedokteran_fisik_rehabilitasi.tatalaksana,layanan_kedokteran_fisik_rehabilitasi.penunjang,layanan_kedokteran_fisik_rehabilitasi.anjuran,layanan_kedokteran_fisik_rehabilitasi.evaluasi,"+
                        "layanan_kedokteran_fisik_rehabilitasi.lama,layanan_kedokteran_fisik_rehabilitasi.treatment,layanan_kedokteran_fisik_rehabilitasi.suspek_penyakit_kerja,layanan_kedokteran_fisik_rehabilitasi.keterangan_suspek_penyakit_kerja "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("tatalaksana"),rs.getString("penunjang"),rs.getString("anjuran"),rs.getString("evaluasi"),rs.getString("lama"),rs.getString("treatment"),rs.getString("suspek_penyakit_kerja"),rs.getString("keterangan_suspek_penyakit_kerja")                     
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Penunjang.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            Anjuran.setText(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
            Evaluasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
            Lama.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
            Treatment.setText(tbObat.getValueAt(tbObat.getSelectedRow(),19).toString());
            SuspekPenyakit.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),20).toString());
            KeteranganSuspekPenyakit.setText(tbObat.getValueAt(tbObat.getSelectedRow(),21).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("layanan_kedokteran_fisik_rehabilitasi","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,pendamping=?,keterangan_pendamping=?,anamnesa=?,pemeriksaan_fisik=?,diagnosa_medis=?,diagnosa_fungsi=?,tatalaksana=?,penunjang=?,anjuran=?,evaluasi=?,lama=?,treatment=?,suspek_penyakit_kerja=?,keterangan_suspek_penyakit_kerja=?",17,new String[]{
                ...
                DiagnosisFungsi.getText(),TatalaksanaKFR.getText(),Penunjang.getText(),Anjuran.getText(),Evaluasi.getText(),Lama.getText(),Treatment.getText(),SuspekPenyakit.getSelectedItem().toString(), 
                ...
                tbObat.setValueAt(Penunjang.getText(),tbObat.getSelectedRow(),15);
                tbObat.setValueAt(Anjuran.getText(),tbObat.getSelectedRow(),16);
                tbObat.setValueAt(Evaluasi.getText(),tbObat.getSelectedRow(),17);
                tbObat.setValueAt(Lama.getText(),tbObat.getSelectedRow(),18);
                tbObat.setValueAt(Treatment.getText(),tbObat.getSelectedRow(),19);
                tbObat.setValueAt(SuspekPenyakit.getSelectedItem().toString(),tbObat.getSelectedRow(),20);
                tbObat.setValueAt(KeteranganSuspekPenyakit.getText(),tbObat.getSelectedRow(),21);
                emptTeks();
                TabRawat.setSelectedIndex(1);
        }
    }
    ...
    private void simpan() {
        if(Sequel.menyimpantf("layanan_kedokteran_fisik_rehabilitasi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'Belum Selesai'","No.Rawat",17,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                Pendamping.getSelectedItem().toString(),KeteranganPendamping.getText(),Anamnesa.getText(),PemeriksaanFisik.getText(),DiagnosisMedis.getText(), 
                DiagnosisFungsi.getText(),TatalaksanaKFR.getText(),Penunjang.getText(),Anjuran.getText(),Evaluasi.getText(),Lama.getText(),Treatment.getText(),SuspekPenyakit.getSelectedItem().toString(), 
                ...
                tabMode.addRow(new Object[]{
                    ...
                    Penunjang.getText(),Anjuran.getText(),Evaluasi.getText(),Lama.getText(),Treatment.getText(),SuspekPenyakit.getSelectedItem().toString(),KeteranganSuspekPenyakit.getText()
                });
                emptTeks();
                LCount.setText(""+tabMode.getRowCount());
        }
