...
public final class DlgPermintaanLaboratorium extends javax.swing.JDialog {
    ...
    private String aktifkanparsial="no",kd_pj,norawatibu="",kelas="",kamar,namakamar,cara_bayar_lab="Yes",kelas_lab="Yes",status="",la="",ld="",pa="",pd="",finger="";
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    ...
    */
        ...
        try {
            ...
            try {
                ...
                while(rstindakan.next()){
                    ...
                    kd_pj=rstindakan.getString("kd_pj");
                }
            } catch (Exception e) {
    ...
    String kdPjSafe = (kd_pj == null ? "-" : kd_pj);

    if (this.status != null && this.status.equalsIgnoreCase("Ranap")) {

        if (!"BPJ".equalsIgnoreCase(kdPjSafe)) {

            if ("UMU".equalsIgnoreCase(kdPjSafe)) {
                filterKelas =
                    " ( (jns_perawatan_lab.kd_pj='" + kdPjSafe + "' " +
                    "     AND jns_perawatan_lab.kelas='" + kelas + "') " +
                    "   OR (jns_perawatan_lab.kd_pj='-' AND jns_perawatan_lab.kelas='-') ) AND ";
            } 
            else if ("BPK".equalsIgnoreCase(kdPjSafe)) {
    filterKelas =
        " ( (jns_perawatan_lab.kd_pj='" + kdPjSafe + "' " +
        "     AND jns_perawatan_lab.kelas='-') " +
        "   OR (jns_perawatan_lab.kd_pj='-' AND jns_perawatan_lab.kelas='-') ) AND ";
}
                    ...
                    filterKelas =
                        " ( (jns_perawatan_lab.kd_pj NOT IN ('UMU','BPJ','BPK') " +
                        "     AND jns_perawatan_lab.kelas='" + kelas + "') " +
                        "   OR (jns_perawatan_lab.kd_pj='-' AND jns_perawatan_lab.kelas='-') ) AND ";
            ...
            filterKelas =
                " ( jns_perawatan_lab.kelas='Rawat Inap' " +
                "   OR (jns_perawatan_lab.kd_pj='-' AND jns_perawatan_lab.kelas='-') ) AND ";
        }
    }
            ...
            if (kd_pj.equalsIgnoreCase("BPJ") || kd_pj.equalsIgnoreCase("UMU") ) {
                filterKelas =
                    " ( (jns_perawatan_lab.kelas='Rawat Jalan' " +
                    "     AND jns_perawatan_lab.kd_pj='" + kd_pj + "') " +
                    "   OR (jns_perawatan_lab.kd_pj='-' AND jns_perawatan_lab.kelas='-') ) AND ";
            } 
            else if (kd_pj.equalsIgnoreCase("BPK")) {
                       filterKelas =
                        " jns_perawatan_lab.kd_pj='" + kd_pj + "' " +
                        "     AND jns_perawatan_lab.kelas='-' AND " ;
                       
                      }
            else {
                filterKelas =
                    " ( (jns_perawatan_lab.kelas='Rawat Jalan' " + 
                    "     AND jns_perawatan_lab.kd_pj='-') " +
                    "   OR (jns_perawatan_lab.kd_pj='-' AND jns_perawatan_lab.kelas='-') ) AND ";
            }
        }
        ...
        try{
            ...
            if(cara_bayar_lab.equals("Yes")&&kelas_lab.equals("No")){
                pstindakan=koneksi.prepareStatement(
                    ...
                    "from jns_perawatan_lab inner join penjab on penjab.kd_pj=jns_perawatan_lab.kd_pj where "    + filterKelas +
        ...
        if (this.status.equalsIgnoreCase("Ranap")) {
            ...
            if (!kd_pj.equalsIgnoreCase("BPJ")) {
               ...
               filterKelas =
                    ...
                    "   OR (jns_perawatan_lab.kd_pj='-' AND jns_perawatan_lab.kelas='" + kelas + "') ) AND ";
...
System.out.println("debug"+kd_pj+filterKelas);
        try{
            jml=0;
            for(i=0;i<tbTarifPA.getRowCount();i++){
                if(tbTarifPA.getValueAt(i,0).toString().equals("true")){
