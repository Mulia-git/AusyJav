...
public class SuratKontrol extends javax.swing.JDialog {
    ...
    public SuratKontrol(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "Tahun","No.RM","Nama Pasien","Diagnosa","Terapi","Alasan Masuk","Keluhan Utama",
                "Tindak Lanjut","Pemeriksaan Fisik","Radiologi","Laboratorium","Tindakan","Periksa Kembali",
                "Tanggal Surat","No.Surat","Kode Dokter","Nama Dokter",
        ...
        Alasan1.setDocument(new batasInput((int)200).getKata(Alasan1));
        KeluhanUtama.setDocument(new batasInput((int)200).getKata(KeluhanUtama));
        Rtl1.setDocument(new batasInput((int)200).getKata(Rtl1));
        PemeriksaanFisik.setDocument(new batasInput((int)200).getKata(PemeriksaanFisik));
        KeluhanUtama.setDocument(new batasInput((byte)200).getKata(KeluhanUtama));
    ...
    private void initComponents() {
        ...
        HasilLaborat = new widget.TextBox();
        PemeriksaanRad = new widget.TextBox();
        jLabel26 = new widget.Label();
        TindakanSelamaDiRS = new widget.TextBox();
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2025" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2025" }));
        ...
        jLabel9.setBounds(0, 190, 92, 23);

        NmDokter.setEditable(false);
        NmDokter.setHighlighter(null);
        NmDokter.setName("NmDokter"); // NOI18N
        FormInput.add(NmDokter);
        NmDokter.setBounds(190, 190, 160, 23);
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2025 12:51:20" }));
        ...
        TanggalSurat.setBounds(474, 10, 130, 23);
        ...
        Status.setBounds(660, 190, 90, 23);
        ...
        KdDokter.setBounds(100, 190, 87, 23);
        ...
        BtnDokter.setBounds(350, 190, 28, 23);

        jLabel37.setText("Status :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(620, 190, 40, 23);

        jLabel11.setText("Unit/Poli :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(380, 160, 90, 23);

        KdPoli.setEditable(false);
        KdPoli.setHighlighter(null);
        KdPoli.setName("KdPoli"); // NOI18N
        FormInput.add(KdPoli);
        KdPoli.setBounds(480, 160, 70, 23);

        NmPoli.setEditable(false);
        NmPoli.setHighlighter(null);
        NmPoli.setName("NmPoli"); // NOI18N
        FormInput.add(NmPoli);
        NmPoli.setBounds(550, 160, 165, 23);
        ...
        BtnPoli.setBounds(720, 160, 28, 23);

        jLabel5.setText("Alasan Masuk :");
        ...
        Alasan1.setBounds(96, 70, 270, 23);
        ...
        KeluhanUtama.setBounds(480, 70, 270, 23);
        ...
        PemeriksaanFisik.setHighlighter(null);
        ...
        PemeriksaanFisik.setBounds(480, 100, 270, 23);

        jLabel14.setText("Periksa Kembali :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(380, 190, 92, 23);

        TanggalPeriksa.setForeground(new java.awt.Color(50, 70, 50));
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2025 12:51:20" }));
        ...
        TanggalPeriksa.setBounds(480, 190, 132, 23);

        jLabel15.setText("No.Surat :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(600, 10, 60, 23);
        ...
        NoSurat.setBounds(660, 10, 90, 23);
        ...
        Terapi.setBounds(480, 40, 270, 23);
        ...
        jLabel19.setText("Periksa Rad :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(0, 130, 92, 23);

        jLabel20.setText("Periksa Lab :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(0, 160, 92, 23);

        HasilLaborat.setHighlighter(null);
        ...
        FormInput.add(HasilLaborat);
        HasilLaborat.setBounds(100, 160, 270, 23);

        PemeriksaanRad.setHighlighter(null);
        ...
        FormInput.add(PemeriksaanRad);
        PemeriksaanRad.setBounds(100, 130, 270, 23);

        jLabel26.setText("Tindakan :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(380, 130, 90, 23);

        TindakanSelamaDiRS.setHighlighter(null);
        ...
        FormInput.add(TindakanSelamaDiRS);
        TindakanSelamaDiRS.setBounds(480, 130, 270, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Valid.textKosong(KeluhanUtama,"No.Antri");
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,KeluhanUtama,BtnBatal);
        }
...
private void BtnDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnDokterKeyPressed
    if(evt.getKeyCode()==KeyEvent.VK_SPACE){
        ...
        Valid.pindah(evt,PemeriksaanFisik,BtnPoli);
    }        
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
        ...
        if(TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("skdp_bpjs","tahun=? and no_antrian=?","tahun=?,no_rkm_medis=?,diagnosa=?,terapi=?,alasan1=?,alasan2=?,rtl1=?,rtl2=?,tanggal_datang=?,tanggal_rujukan=?,no_antrian=?,kd_dokter=?,status=?",15,new String[]{
                        ...
                        Alasan1.getText(),KeluhanUtama.getText(),Rtl1.getText(),PemeriksaanFisik.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),
                        Valid.SetTgl(TanggalSurat.getSelectedItem()+""),NoSurat.getText(),KdDokter.getText(),Status.getSelectedItem().toString(),
                        tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),11).toString()
                  })==true){
                    Sequel.mengedit3("booking_registrasi","no_rkm_medis=? and tanggal_periksa=?","tanggal_booking=?,no_rkm_medis=?,tanggal_periksa=?,kd_dokter=?,kd_poli=?",7,new String[]{
                         Valid.SetTgl(TanggalSurat.getSelectedItem()+""),TNoRM.getText(),
                         Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),KdDokter.getText(),
                         KdPoli.getText(),KeluhanUtama.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),1).toString(),
                    ...
                    tbObat.setValueAt(KeluhanUtama.getText(),tbObat.getSelectedRow(),6);
                    tbObat.setValueAt(Rtl1.getText(),tbObat.getSelectedRow(),7);
                    tbObat.setValueAt(PemeriksaanFisik.getText(),tbObat.getSelectedRow(),8);
    ...
    private void Alasan1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Alasan1KeyPressed
        Valid.pindah(evt,Terapi,KeluhanUtama);
    ...
    private void Rtl1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Rtl1KeyPressed
        Valid.pindah(evt,KeluhanUtama,PemeriksaanFisik);
    ...
    private void NoSuratKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoSuratKeyPressed
        Valid.pindah(evt,TanggalPeriksa,KeluhanUtama);
    ...
    */
    ...
    private widget.TextBox HasilLaborat;
    ...
    private widget.TextBox PemeriksaanRad;
    ...
    private widget.TextBox TindakanSelamaDiRS;
    ...
    private void isNomer(){
        switch (URUTNOREG) {
            case "poli":
                Valid.autoNomer3("select ifnull(MAX(CONVERT(booking_registrasi.no_reg,signed)),0) from booking_registrasi where booking_registrasi.kd_poli='"+KdPoli.getText()+"' and booking_registrasi.tanggal_periksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,KeluhanUtama);
                break;
            case "dokter":
                Valid.autoNomer3("select ifnull(MAX(CONVERT(booking_registrasi.no_reg,signed)),0) from booking_registrasi where booking_registrasi.kd_dokter='"+KdDokter.getText()+"' and booking_registrasi.tanggal_periksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,KeluhanUtama);
                break;
            case "dokter + poli":             
                Valid.autoNomer3("select ifnull(MAX(CONVERT(booking_registrasi.no_reg,signed)),0) from booking_registrasi where booking_registrasi.kd_dokter='"+KdDokter.getText()+"' and booking_registrasi.kd_poli='"+KdPoli.getText()+"' and booking_registrasi.tanggal_periksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,KeluhanUtama);
                break;
            default:
                Valid.autoNomer3("select ifnull(MAX(CONVERT(booking_registrasi.no_reg,signed)),0) from booking_registrasi where booking_registrasi.kd_dokter='"+KdDokter.getText()+"' and booking_registrasi.tanggal_periksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"'","",3,KeluhanUtama);
                break;
    ...
    private void isBooking(){
        if(Sequel.menyimpantf("skdp_bpjs","?,?,?,?,?,?,?,?,?,?,?,?,?","Tahun dan nomor surat",13,new String[]{
             TanggalPeriksa.getSelectedItem().toString().substring(6,10),TNoRM.getText(),Diagnosa.getText(),Terapi.getText(),
             Alasan1.getText(),KeluhanUtama.getText(),Rtl1.getText(),PemeriksaanFisik.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+" "+TanggalPeriksa.getSelectedItem().toString().substring(11,19),
             ...
             if(JADIKANBOOKINGSURATKONTROL.equals("yes")){
                Sequel.menyimpan2("booking_registrasi","?,?,?,?,?,?,?,?,?,?,?","Pasien dan Tanggal",11,new String[]{
                   ...
                   Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),KdDokter.getText(),
                   KdPoli.getText(),KeluhanUtama.getText(),Sequel.cariIsi("select pasien.kd_pj from pasien where pasien.no_rkm_medis=?",TNoRM.getText()),"0",
                   Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+" "+TanggalPeriksa.getSelectedItem().toString().substring(11,19),
                   "belum"
                });
             }
             tabMode.addRow(new Object[]{
                TanggalPeriksa.getSelectedItem().toString().substring(6,10),TNoRM.getText(),TPasien.getText(),Diagnosa.getText(),Terapi.getText(),Alasan1.getText(),KeluhanUtama.getText(),
                Rtl1.getText(),PemeriksaanFisik.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+" "+TanggalPeriksa.getSelectedItem().toString().substring(11,19),
                Valid.SetTgl(TanggalSurat.getSelectedItem()+"")+" "+TanggalSurat.getSelectedItem().toString().substring(11,19),NoSurat.getText(),KeluhanUtama.getText(),
