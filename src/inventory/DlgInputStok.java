...
public class DlgInputStok extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppBatch1Bulan = new javax.swing.JMenuItem();
        ppBatch3Bulan = new javax.swing.JMenuItem();
        ppBatch6Bulan = new javax.swing.JMenuItem();
        ppBatch9Bulan = new javax.swing.JMenuItem();
        ppBatch12Bulan = new javax.swing.JMenuItem();
        ppBatch24Bulan = new javax.swing.JMenuItem();
        ...
        ppBersihkan.setPreferredSize(new java.awt.Dimension(250, 26));
        ...
        ppStok.setPreferredSize(new java.awt.Dimension(250, 26));
        ...
        ppBelumOpname.setPreferredSize(new java.awt.Dimension(250, 26));
        ...
        ppSudahOpname.setPreferredSize(new java.awt.Dimension(250, 26));
        ...
        ppBatch1Bulan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        ppBatch1Bulan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppBatch1Bulan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppBatch1Bulan.setName("ppBatch1Bulan"); // NOI18N
        ppBatch1Bulan.setPreferredSize(new java.awt.Dimension(250, 26));
        ppBatch1Bulan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBatch1BulanActionPerformed(evt);
            }
        });
        Popup.add(ppBatch1Bulan);

        ppBatch3Bulan.setBackground(new java.awt.Color(255, 255, 254));
        ppBatch3Bulan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        ppBatch3Bulan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppBatch3Bulan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppBatch3Bulan.setName("ppBatch3Bulan"); // NOI18N
        ppBatch3Bulan.setPreferredSize(new java.awt.Dimension(250, 26));
        ppBatch3Bulan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBatch3BulanActionPerformed(evt);
            }
        });
        Popup.add(ppBatch3Bulan);

        ppBatch6Bulan.setBackground(new java.awt.Color(255, 255, 254));
        ppBatch6Bulan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        ppBatch6Bulan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppBatch6Bulan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppBatch6Bulan.setName("ppBatch6Bulan"); // NOI18N
        ppBatch6Bulan.setPreferredSize(new java.awt.Dimension(250, 26));
        ppBatch6Bulan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBatch6BulanActionPerformed(evt);
            }
        });
        Popup.add(ppBatch6Bulan);

        ppBatch9Bulan.setBackground(new java.awt.Color(255, 255, 254));
        ppBatch9Bulan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        ppBatch9Bulan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppBatch9Bulan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppBatch9Bulan.setName("ppBatch9Bulan"); // NOI18N
        ppBatch9Bulan.setPreferredSize(new java.awt.Dimension(250, 26));
        ppBatch9Bulan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBatch9BulanActionPerformed(evt);
            }
        });
        Popup.add(ppBatch9Bulan);

        ppBatch12Bulan.setBackground(new java.awt.Color(255, 255, 254));
        ppBatch12Bulan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        ppBatch12Bulan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppBatch12Bulan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppBatch12Bulan.setName("ppBatch12Bulan"); // NOI18N
        ppBatch12Bulan.setPreferredSize(new java.awt.Dimension(250, 26));
        ppBatch12Bulan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBatch12BulanActionPerformed(evt);
            }
        });
        Popup.add(ppBatch12Bulan);

        ppBatch24Bulan.setBackground(new java.awt.Color(255, 255, 254));
        ppBatch24Bulan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        ppBatch24Bulan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppBatch24Bulan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppBatch24Bulan.setName("ppBatch24Bulan"); // NOI18N
        ppBatch24Bulan.setPreferredSize(new java.awt.Dimension(250, 26));
        ppBatch24Bulan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppBatch24BulanActionPerformed(evt);
            }
        });
        Popup.add(ppBatch24Bulan);
                ...
                if(tbDokter.getSelectedColumn()==1){
                    ...
                    try {
                        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),11).toString().equals("")){
                            psstok=koneksi.prepareStatement("select data_batch.no_faktur,data_batch."+hppfarmasi+" as dasar from data_batch where data_batch.no_batch=? and data_batch.kode_brng=? and data_batch.sisa>0 order by data_batch.tgl_kadaluarsa limit 1");
                            try {
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(nmgudang.getText().trim().equals("")||kdgudang.getText().trim().equals("")){
            ...
            i= JOptionPane.showConfirmDialog(rootPane,"Apakah data yang ingin anda simpan sudah benar ?","Konfirmasi",JOptionPane.YES_NO_OPTION);
...
private void BtnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGudangActionPerformed
    ...
    private void ppBatch1BulanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBatch1BulanActionPerformed
            ...
            try{  
                ...
                try {
                    ...
                    while(rstampil.next()){                            
                        ...
                        iyembuilder.append("{\"KodeBarang\":\"").append(rstampil.getString("kode_brng")).append("\",\"NamaBarang\":\"").append(rstampil.getString("nama_brng").replaceAll("\"","")).append("\",\"Kategori\":\"").append(rstampil.getString("nama")).append("\",\"Satuan\":\"").append(rstampil.getString("kode_sat")).append("\",\"Harga\":\"").append(rstampil.getString("dasar")).append("\",\"NoBatch\":\"").append(rstampil.getString("no_batch")).append("\",\"NoFaktur\":\"").append(rstampil.getString("no_faktur")).append("\",\"Stok\":\"").append(rstampil.getDouble("sisa")).append("\"},");
                    }  
                } catch (Exception e) {
                    System.out.println("Notif : "+e);
                } finally{
    ...
    private void ppBatch3BulanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBatch3BulanActionPerformed
        if(kdgudang.getText().equals("")){
            try{  
                Valid.tabelKosong(tabMode);
                file=new File("./cache/stokopname.iyem");
    ...
    private void ppBatch6BulanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBatch6BulanActionPerformed
        if(kdgudang.getText().equals("")){
            try{  
                Valid.tabelKosong(tabMode);
                file=new File("./cache/stokopname.iyem");
    ...
    private void ppBatch9BulanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBatch9BulanActionPerformed
        if(kdgudang.getText().equals("")){
            try{  
                Valid.tabelKosong(tabMode);
                file=new File("./cache/stokopname.iyem");
    ...
    private void ppBatch12BulanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBatch12BulanActionPerformed
        if(kdgudang.getText().equals("")){
            try{  
                Valid.tabelKosong(tabMode);
                file=new File("./cache/stokopname.iyem");
    ...
    private void ppBatch24BulanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBatch24BulanActionPerformed
        if(kdgudang.getText().equals("")){
            try{  
                Valid.tabelKosong(tabMode);
                file=new File("./cache/stokopname.iyem");
                ...
                pstampil=koneksi.prepareStatement(
                    "select data_batch.kode_brng,databarang.nama_brng,jenis.nama,databarang.kode_sat,data_batch."+hppfarmasi+" as dasar, "+
                    "data_batch.sisa,data_batch.no_batch,data_batch.no_faktur from data_batch inner join databarang on data_batch.kode_brng=databarang.kode_brng "+
                    "inner join jenis on databarang.kdjns=jenis.kdjns where data_batch.tgl_beli between SUBDATE(current_date(), INTERVAL 24 MONTH) and current_date() "+
                    (TCari.getText().trim().equals("")?"":"and (data_batch.kode_brng like ? or databarang.nama_brng like ? or jenis.nama like ?) ")+order);
                try {
                    if(!TCari.getText().trim().equals("")){
                        pstampil.setString(1,"%"+TCari.getText().trim()+"%");
            ...
            try{  
                ...
                pstampil=koneksi.prepareStatement(
                    ...
                    "gudangbarang.stok as sisa,data_batch.no_batch,data_batch.no_faktur from data_batch inner join databarang on data_batch.kode_brng=databarang.kode_brng "+
                    "inner join jenis on databarang.kdjns=jenis.kdjns inner join gudangbarang on gudangbarang.kode_brng=data_batch.kode_brng and gudangbarang.no_batch=data_batch.no_batch and gudangbarang.no_faktur=data_batch.no_faktur "+
                    "where gudangbarang.kd_bangsal=? and data_batch.tgl_beli between SUBDATE(current_date(), INTERVAL 24 MONTH) and current_date() "+
                    (TCari.getText().trim().equals("")?"":"and (data_batch.kode_brng like ? or databarang.nama_brng like ? or jenis.nama like ?) ")+order);
                try {
                    if(!TCari.getText().trim().equals("")){
                        pstampil.setString(1,kdgudang.getText());
    ...
    */
    ...
    private javax.swing.JMenuItem ppBatch12Bulan;
    private javax.swing.JMenuItem ppBatch1Bulan;
    private javax.swing.JMenuItem ppBatch24Bulan;
    private javax.swing.JMenuItem ppBatch3Bulan;
    private javax.swing.JMenuItem ppBatch6Bulan;
    private javax.swing.JMenuItem ppBatch9Bulan;
        ...
        try{  
            ...
            try {
                ...
                while(rstampil.next()){                            
                    ...
                    iyembuilder.append("{\"KodeBarang\":\"").append(rstampil.getString("kode_brng")).append("\",\"NamaBarang\":\"").append(rstampil.getString("nama_brng").replaceAll("\"","")).append("\",\"Kategori\":\"").append(rstampil.getString("nama")).append("\",\"Satuan\":\"").append(rstampil.getString("kode_sat")).append("\",\"Harga\":\"").append(rstampil.getString("dasar")).append("\",\"NoBatch\":\"\",\"NoFaktur\":\"\",\"Stok\":\"0\"},");
                }  
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
