 ...
 * @author dosen
 */
public final class DlgTemplateUTD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Template Sub Pelayanan Unit Tranfusi Darah ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50,50,50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTemplateUTD dialog = new DlgTemplateUTD(new javax.swing.JFrame(), true);
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getDouble(10),rs.getDouble(11),rs.getString(1),""
                    });
                }
                urut();
            } catch (Exception e) {
    ...
    private void getData() {
        ...
        if(row!= -1){
            if((!tbKamar.getValueAt(row,1).toString().equals(""))
                    &&(!tbKamar.getValueAt(row,2).toString().equals(""))
                    &&(!tbKamar.getValueAt(row,3).toString().equals(""))
                    &&(!tbKamar.getValueAt(row,4).toString().equals(""))
                    &&(!tbKamar.getValueAt(row,5).toString().equals(""))
                    &&(!tbKamar.getValueAt(row,6).toString().equals(""))
                    &&(!tbKamar.getValueAt(row,7).toString().equals(""))
                    &&(!tbKamar.getValueAt(row,2).toString().equals(""))){
               tbKamar.setValueAt(Valid.SetAngka(tbKamar.getValueAt(row,2).toString())+
                       Valid.SetAngka(tbKamar.getValueAt(row,3).toString())+
                       Valid.SetAngka(tbKamar.getValueAt(row,4).toString())+
