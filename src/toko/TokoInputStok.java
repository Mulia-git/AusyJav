...
public class TokoInputStok extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public TokoInputStok(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Stok Opname Barang Toko / Minimarket / Koperasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        label10.setText("Nominal Hilang :");
        label10.setName("label10"); // NOI18N
        label10.setPreferredSize(new java.awt.Dimension(120, 23));
        panelisi1.add(label10);

        LTotal.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        LTotal.setText("0");
        LTotal.setName("LTotal"); // NOI18N
        LTotal.setPreferredSize(new java.awt.Dimension(205, 23));
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
       this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        TokoStokOpname opname=new TokoStokOpname(null,true);
        opname.isCek(); 
        opname.emptTeks();
                    ...
                    if(!tbDokter.getValueAt(i,0).toString().equals("")){
                        try {
                            if(Valid.SetAngka(tbDokter.getValueAt(i,0).toString())>=0){
                                if(Sequel.menyimpantf2("tokoopname","?,?,?,?,?,?,?,?","Stok Opname",8,new String[]{
                                    ...
                                    Sequel.mengedit3("tokobarang","kode_brng=?","stok=?",2,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoInputStok dialog = new TokoInputStok(new javax.swing.JFrame(), true);
                ...
                if(!tbDokter.getValueAt(i,0).toString().equals("")){
                    try {
                        if(Double.parseDouble(tabMode.getValueAt(i,0).toString())>=0){
                            try {
                                kurang=Double.parseDouble(tbDokter.getValueAt(i,6).toString())-
    ...
    public void isCek(){
         BtnSimpan.setEnabled(akses.getstok_opname_toko());   
    }
