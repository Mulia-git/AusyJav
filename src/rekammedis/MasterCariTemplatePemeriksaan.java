...
public final class MasterCariTemplatePemeriksaan extends javax.swing.JDialog {
    ...
    public MasterCariTemplatePemeriksaan(java.awt.Frame parent, boolean modal) {
       ...
       int yTerakhir = Scroll11.getY() + Scroll11.getHeight();
        ...
        // 2. Tempelkan Label "Data Operasi" 10 pixel di bawahnya
        ...
        // 3. Tempelkan Tabel Operasi di bawah Label
        if(Scroll12 == null) {
            Scroll12 = new widget.ScrollPane();
            Scroll12.setName("Scroll12");
        ...
        // Tinggi tabel operasi kita set 150 pixel
        Scroll12.setBounds(20, yTerakhir + 35, 700, 150);

        // 4. Update Luas Halaman Form agar Scrollbar kanan bisa turun sampai bawah
        // Kita set tinggi total = Posisi Tabel Operasi + Tinggi Tabelnya + Sedikit sisa
...
//        
    ...
    private void initComponents() {
        ...
        Diskon = new widget.Label();
        Rajal2 = new widget.Label();
        ...
        scrollPane2.setPreferredSize(new java.awt.Dimension(740, 1921));
        ...
        jLabel40.setText("Judul :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(20, 10, 410, 20);
        ...
        Diskon.setBounds(550, 10, 70, 20);

        Rajal2.setText("Diskon Rp. ");
        Rajal2.setName("Rajal2"); // NOI18N
        FormInput.add(Rajal2);
        Rajal2.setBounds(490, 10, 60, 20);
        ...
        if(Subjek.getText().trim().equals("")){
            ...
            if(tbDokter.getSelectedRow()>-1){
                ...
                if(sukses==true){
                    ...
                    Sequel.menyimpan("pengurangan_biaya", "'" + noperawatan + "','Diskon','" + Diskon.getText() + "'",  "Besar Pengurangan");
                    ...
                    if(tabModeRadiologi.getRowCount()>0){
                        ...
                        if(Sequel.menyimpantf2("permintaan_radiologi","?,?,?,?,?,?,?,?,?,?,?,?","No.Permintaan Radiologi",12,new String[]{
                                nomor,noperawatan,tanggaldilakukan,jamdilakukan,"0000-00-00","00:00:00","0000-00-00","00:00:00",kodedokter,"ralan","-",Subjek.getText()
                            })==true){
                    ...
                    if(tabModePA.getRowCount()>0){
                        ...
                        if(Sequel.menyimpantf2("permintaan_labpa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Permintaan",20,new String[]{
                                nomor,noperawatan,tanggaldilakukan,jamdilakukan,"0000-00-00","00:00:00","0000-00-00","00:00:00",kodedokter,"ralan","-",Subjek.getText(),tanggaldilakukan,"-","-","-","-","0000-00-00","-","-"
                            })==true){
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("jenis"),
                        rs.getString("tipe"),
                        rs.getString("besar_pengurangan")
                    });
                }
            } catch (Exception e) {
                System.out.println(e);
