...
public class IPSRSReturBeli extends javax.swing.JDialog {
    ...
    private IPSRSCariReturBeli form=new IPSRSCariReturBeli(null,false);
     ...
     * @param parent
     * @param modal */
    public IPSRSReturBeli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        form.suplier.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("IPSRSReturBeli")){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Transaksi Retur Barang Non Medis dan Penunjang ( Lab & RO ) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoRetur.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                sukses=true;
                if(Sequel.menyimpantf2("ipsrsreturbeli","?,?,?,?,?,?","No.Retur",6,new String[]{
                    NoRetur.getText(),Valid.SetTgl(TglRetur.getSelectedItem()+""),kdptg.getText(),kdsup.getText(),Catatan.getText(),ttl+""
                })==true){
                    jml=tbDokter.getRowCount();
                    for(i=0;i<jml;i++){
                        if(Valid.SetAngka(tbDokter.getValueAt(i,0).toString())>0){
                            if(Sequel.menyimpantf2("ipsrs_detail_returbeli","?,?,?,?,?,?,?,?","Transaksi Retur Beli",8,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            IPSRSReturBeli dialog = new IPSRSReturBeli(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            ...
            BtnSimpan.setEnabled(akses.getipsrs_returbeli());
