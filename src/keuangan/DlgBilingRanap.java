...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    */
    ...
    private void prosesCariObat(String norawat) {    
            ...
            try {
                ...
                if(centangobatranap.equals("Yes")){
                    if(rsobatoperasi.next()){
                        tabModeRwJlDr.addRow(new Object[]{true,x+". Obat & BHP Operasi",":","",null,null,null,null,"Obat"});
                        x++;
        ...
        String kd_pj = Sequel.cariIsi("SELECT kd_pj FROM reg_periksa WHERE no_rawat = '"+no_rawat+"'");
        Double besar_ppn = 0.11;
        
        if(kd_pj.equals("BPJ") || kd_pj.equals("UMU") || kd_pj.equals("B28") || kd_pj.equals("BPK")){
            besar_ppn = 0.11;
        }else{
            besar_ppn = 0.2;
        }
        ...
        if((ttlobat-ttlretur)>0){
            if(tampilkan_ppnobat_ranap.equals("Yes")){
                ...
                ppnobat=Math.round((ttlobat+ttlretur)*besar_ppn);
