...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Scrol20 = new widget.ScrollPane();
        Scrol21 = new widget.ScrollPane();
        Scrol22 = new widget.ScrollPane();
        FormDetailBHPDr = new widget.PanelBiasa();
        FormDetailBHPPr = new widget.PanelBiasa();
        FormDetailBHPDrPr = new widget.PanelBiasa();
        ...
        PanelAccor1.setPreferredSize(new java.awt.Dimension(350, 43));
        ...
        FormDetailBHPDr.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 254)));
        FormDetailBHPDr.setName("FormDetailBHPDr"); // NOI18N
        FormDetailBHPDr.setLayout(new java.awt.GridLayout(1, 0, 1, 1));

        Scrol20.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 254)));
        Scrol20.setName("Scrol20"); // NOI18N
        Scrol20.setOpaque(true);
        Scrol20.setPreferredSize(new java.awt.Dimension(350, 807));

        tbDetailBHPDr.setName("tbDetailBHPDr"); // NOI18N
        tbDetailBHPDr.setPreferredSize(new java.awt.Dimension(350, 807));
        Scrol20.setViewportView(tbDetailBHPDr);

        FormDetailBHPDr.add(Scrol20);

        PanelAccor1.add(FormDetailBHPDr, java.awt.BorderLayout.CENTER);

        internalFrame2.add(PanelAccor1, java.awt.BorderLayout.EAST);
        ...
        PanelAccor2.setPreferredSize(new java.awt.Dimension(350, 43));
        ...
        FormDetailBHPPr.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 254)));
        FormDetailBHPPr.setName("FormDetailBHPPr"); // NOI18N
        FormDetailBHPPr.setLayout(new java.awt.GridLayout(1, 0, 1, 1));

        Scrol21.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 254)));
        Scrol21.setName("Scrol21"); // NOI18N
        Scrol21.setOpaque(true);
        Scrol21.setPreferredSize(new java.awt.Dimension(350, 807));

        tbDetailBHPPr.setName("tbDetailBHPPr"); // NOI18N
        tbDetailBHPPr.setPreferredSize(new java.awt.Dimension(350, 807));
        Scrol21.setViewportView(tbDetailBHPPr);

        FormDetailBHPPr.add(Scrol21);

        PanelAccor2.add(FormDetailBHPPr, java.awt.BorderLayout.CENTER);

        internalFrame3.add(PanelAccor2, java.awt.BorderLayout.EAST);
        ...
        PanelAccor3.setPreferredSize(new java.awt.Dimension(250, 43));
        PanelAccor3.setLayout(new java.awt.BorderLayout(1, 1));

        ChkAccor3.setBackground(new java.awt.Color(255, 250, 250));
        ChkAccor3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kiri.png"))); // NOI18N
        ...
        ChkAccor3.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kiri.png"))); // NOI18N
        ChkAccor3.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kanan.png"))); // NOI18N
        ChkAccor3.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kanan.png"))); // NOI18N
        ChkAccor3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkAccor3ActionPerformed(evt);
            }
        });
        PanelAccor3.add(ChkAccor3, java.awt.BorderLayout.WEST);

        FormDetailBHPDrPr.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 254)));
        FormDetailBHPDrPr.setName("FormDetailBHPDrPr"); // NOI18N
        FormDetailBHPDrPr.setLayout(new java.awt.GridLayout(1, 0, 1, 1));

        Scrol22.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 254)));
        Scrol22.setName("Scrol22"); // NOI18N
        Scrol22.setOpaque(true);
        Scrol22.setPreferredSize(new java.awt.Dimension(350, 807));

        tbDetailBHPDrPr.setName("tbDetailBHPDrPr"); // NOI18N
        tbDetailBHPDrPr.setPreferredSize(new java.awt.Dimension(350, 807));
        Scrol22.setViewportView(tbDetailBHPDrPr);

        FormDetailBHPDrPr.add(Scrol22);

        PanelAccor3.add(FormDetailBHPDrPr, java.awt.BorderLayout.CENTER);

        internalFrame4.add(PanelAccor3, java.awt.BorderLayout.EAST);
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                if(Sequel.cariRegistrasi(tbRawatDr.getValueAt(i,1).toString())>0){
                                    ...
                                    if(Sequel.queryutf("delete from rawat_jl_dr where no_rawat='"+tbRawatDr.getValueAt(i,1).toString()+
                                        ...
                                        String kode_paket = tbRawatDr.getValueAt(i,10).toString();
                                        
                                        String depo = "AP1";

                                        System.out.println("Depo yang Dipakai : "+depo);
                                        System.out.println("Kode Tindakan : "+kode_paket);
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                if(Sequel.cariRegistrasi(tbRawatPr.getValueAt(i,1).toString())>0){
                                    ...
                                    if(Sequel.queryutf("delete from rawat_jl_pr where no_rawat='"+tbRawatPr.getValueAt(i,1).toString()+
                                        ...
                                        String kode_paket = tbRawatPr.getValueAt(i,10).toString();
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void tbTindakanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabRawatTindakanDokterMouseClicked
        try {
            ChkAccor1.setSelected(true);
            isBHPDr();
            getBHPDr();
    ...
    private void tbTindakan2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabRawatTindakanDokterMouseClicked
        try {
            ChkAccor2.setSelected(true);
            isBHPPr();
            getBHPPr();
    ...
    private void tbTindakan3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabRawatTindakanDokterMouseClicked
        try {
            ChkAccor3.setSelected(true);
            isBHPDrPr();
            getBHPDrPr();
    ...
    private void ChkAccor1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkAccorActionPerformed
        isBHPDr();
    }//GEN-LAST:event_ChkAccorActionPerformed
    
    private void ChkAccor2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkAccorActionPerformed
        isBHPPr();
    }//GEN-LAST:event_ChkAccorActionPerformed
    
    private void ChkAccor3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkAccorActionPerformed
        isBHPDrPr();
    }//GEN-LAST:event_ChkAccorActionPerformed
    ...
    */
    ...
    private widget.PanelBiasa FormDetailBHPDr;
    private widget.PanelBiasa FormDetailBHPPr;
    private widget.PanelBiasa FormDetailBHPDrPr;
    ...
    private widget.ScrollPane Scrol20;
    private widget.ScrollPane Scrol21;
    private widget.ScrollPane Scrol22;
    ...
    private void tampilTindakanDr() {
        ...
        try{     
            ...
            String setting_tindakan = Sequel.cariIsi("Select per_triase from setting_tindakan");
            
            if(setting_tindakan.equals("yes")){
                String no_rawat=TNoRw.getText();
                String igd = Sequel.cariIsi("Select kd_poli from reg_periksa where no_rawat='"+no_rawat+"'");

                if(igd.equals("IGDK") || igd.equals("PONEK")){

                    String triase="-";

                    String triase1 = Sequel.cariIsi("Select no_rawat from data_triase_igdprimer where no_rawat='"+no_rawat+"'");
                    if(!triase1.isEmpty()){
                        triase = "1";
                    }

                    String triase23 = Sequel.cariIsi("Select plan from data_triase_igdsekunder where no_rawat='"+no_rawat+"'");
                    if(triase23.equals("Zona Kuning")){
                        triase = "2";
                    }else if(triase23.equals("Zona Hijau")){
                        triase = "3";
                    }
                    ...
                    if(triase.equals("1")){
                        pstindakan = koneksi.prepareStatement(
                            ...
                            "INNER JOIN jns_perawatan_igd ON TRIM(jns_perawatan.kd_jenis_prw) = TRIM(jns_perawatan_igd.kd_jenis_prw) " +
                            "WHERE jns_perawatan.total_byrdr > 0 " +
                            "  AND jns_perawatan.status = '1' " +
                            "  AND (jns_perawatan_igd.triase = '1' OR jns_perawatan_igd.triase = '-') " +
                            ...
                            "       OR jns_perawatan.nm_perawatan LIKE ? " +
                            "       OR kategori_perawatan.nm_kategori LIKE ?) " +
                            "ORDER BY jns_perawatan.nm_perawatan"
                        );
                    }else if(triase.equals("2")){
                        pstindakan = koneksi.prepareStatement(
                            "SELECT " +
                            "  jns_perawatan.kd_jenis_prw, " +
                            "  jns_perawatan.nm_perawatan, " +
                            ...
                            "WHERE jns_perawatan.total_byrdr > 0 " +
                            "  AND jns_perawatan.status = '1' " +
                            "  AND (jns_perawatan_igd.triase = '2' OR jns_perawatan_igd.triase = '-') " +
                            "  AND (jns_perawatan.kd_pj = ? OR jns_perawatan.kd_pj = '-') " +
                            "  AND (jns_perawatan.kd_poli = ? OR jns_perawatan.kd_poli = '-') " +
                            "  AND (jns_perawatan.kd_jenis_prw LIKE ? " +
                            "       OR jns_perawatan.nm_perawatan LIKE ? " +
                        ...
                        pstindakan = koneksi.prepareStatement(
                            ...
                            "WHERE jns_perawatan.total_byrdr > 0 " +
                            "  AND jns_perawatan.status = '1' " +
                            "  AND (jns_perawatan_igd.triase = '3' OR jns_perawatan_igd.triase = '-') " +
                            "  AND (jns_perawatan.kd_pj = ? OR jns_perawatan.kd_pj = '-') " +
                            "  AND (jns_perawatan.kd_poli = ? OR jns_perawatan.kd_poli = '-') " +
                            "  AND (jns_perawatan.kd_jenis_prw LIKE ? " +
                            "       OR jns_perawatan.nm_perawatan LIKE ? " +
                        ...
                        pstindakan = koneksi.prepareStatement(
                            ...
                            "FROM jns_perawatan " +
                            "INNER JOIN kategori_perawatan ON jns_perawatan.kd_kategori = kategori_perawatan.kd_kategori " +
                            "WHERE  jns_perawatan.kd_jenis_prw = '-' " +
                            "  AND jns_perawatan.status = '1' " +
                            "  AND (jns_perawatan.kd_pj = ? OR jns_perawatan.kd_pj = '-') " +
                            "  AND (jns_perawatan.kd_poli = ? OR jns_perawatan.kd_poli = '-') " +
                            "  AND (jns_perawatan.kd_jenis_prw LIKE ? " +
                        ...
                        JOptionPane.showMessageDialog(rootPane,"Data Triase Belum Diinput.\nSilahkan masukkan triase untuk membuka list tindakan.");
                    }
                }else{
                

                
                    if (kd_pj.trim().equalsIgnoreCase("BPJ")
                            || kd_pj.trim().equalsIgnoreCase("UMU") || kd_pj.trim().equalsIgnoreCase("BPK")
                           ) {

                    
                        filterKdPj = " AND jns_perawatan.kd_pj=? ";

                    } else {

                       
                        filterKdPj = " AND (jns_perawatan.kd_pj = '-' OR jns_perawatan.kd_pj NOT IN ('BPJ','UMU','BPK')) ";
                    ...
                    if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("Yes")){
                       pstindakan = koneksi.prepareStatement(
                        ...
                        "jns_perawatan.bhp, jns_perawatan.material, jns_perawatan.tarif_tindakandr, " +
                        "jns_perawatan.tarif_tindakanpr, jns_perawatan.kso, jns_perawatan.menejemen " +
                        "FROM jns_perawatan " +
                        "INNER JOIN kategori_perawatan ON jns_perawatan.kd_kategori = kategori_perawatan.kd_kategori " +
                        "WHERE  " +
                        " jns_perawatan.status = '1' " +
                         filterKdPj +
                        "AND (jns_perawatan.kd_poli = ? OR jns_perawatan.kd_poli = '-') " +
                        "AND (jns_perawatan.kd_jenis_prw LIKE ? " +
                        "OR jns_perawatan.nm_perawatan LIKE ? " +
                       ...
                       pstindakan = koneksi.prepareStatement(
                            ...
                            "INNER JOIN kategori_perawatan ON jns_perawatan.kd_kategori = kategori_perawatan.kd_kategori " +
                            "WHERE  " +
                            " jns_perawatan.status = '1' " + filterKdPj +
                            "AND (jns_perawatan.kd_poli = ? OR jns_perawatan.kd_poli = '-') " +
                            "AND (jns_perawatan.kd_jenis_prw LIKE ? " +
                            "OR jns_perawatan.nm_perawatan LIKE ? " +
                            "OR kategori_perawatan.nm_kategori LIKE ?) " +
                ...
                if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("Yes")){
                    ...
                    pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                       ...
                       "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen from jns_perawatan inner join kategori_perawatan "+
                       "on jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori  "+
                       "where jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and "+filterKdPj +
                       "(jns_perawatan.kd_jenis_prw like ? or jns_perawatan.nm_perawatan like ? or kategori_perawatan.nm_kategori like ?) order by jns_perawatan.nm_perawatan ");        
                }else if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("No")){
                    pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                       "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
                       "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen from jns_perawatan inner join kategori_perawatan "+
                       "on jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori  "+
                       "where jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and "+filterKdPj +
                       "(jns_perawatan.kd_jenis_prw like ? or jns_perawatan.nm_perawatan like ? or kategori_perawatan.nm_kategori like ?) order by jns_perawatan.nm_perawatan ");     
                }else if(poli_ralan.equals("No")&&cara_bayar_ralan.equals("No")){
                    pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                       "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
                       "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen from jns_perawatan inner join kategori_perawatan "+
                       "on jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori  "+
                       "where jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and "+filterKdPj +
                       "(jns_perawatan.kd_jenis_prw like ? or jns_perawatan.nm_perawatan like ? or kategori_perawatan.nm_kategori like ?) order by jns_perawatan.nm_perawatan "); 
                }
           ...
           try {
                ...
                int totalParam = pstindakan.getParameterMetaData().getParameterCount();

                
                if(totalParam >= idx) {
                    if(totalParam >= 1 && pstindakan.toString().contains("kd_pj")) {
                        pstindakan.setString(idx++, kd_pj.trim());
                    }
                }

                if(totalParam >= idx) {
                    if(pstindakan.toString().contains("kd_poli")) {
                        pstindakan.setString(idx++, kode_poli.trim());
                    }
                }

              
                while(idx <= totalParam){
                    pstindakan.setString(idx++, "%" + TCari.getText().trim() + "%");
                }
                ...
                while(rstindakan.next()){
                    TabModeTindakan.addRow(new Object[] {
                        false,
                        rstindakan.getString(1),
                        rstindakan.getString(2),
                        rstindakan.getString(3),
                        rstindakan.getDouble("total_byrdr"),
        ...
        try{     
            ...
            if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("Yes")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   ...
                   "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen from jns_perawatan inner join kategori_perawatan "+
                   "on jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori  "+
                   "where jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and "+filterKdPj+
                   "(jns_perawatan.kd_jenis_prw like ? or jns_perawatan.nm_perawatan like ? or kategori_perawatan.nm_kategori like ?) order by jns_perawatan.nm_perawatan "); 
            }else if(poli_ralan.equals("No")&&cara_bayar_ralan.equals("Yes")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
                   "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen from jns_perawatan inner join kategori_perawatan "+
                   "on jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori  "+
                   "where jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and "+filterKdPj+
                   "(jns_perawatan.kd_jenis_prw like ? or jns_perawatan.nm_perawatan like ? or kategori_perawatan.nm_kategori like ?) order by jns_perawatan.nm_perawatan ");        
            }else if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("No")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
                   "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen from jns_perawatan inner join kategori_perawatan "+
                   "on jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori  "+
                   "where jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and "+filterKdPj+
                   "(jns_perawatan.kd_jenis_prw like ? or jns_perawatan.nm_perawatan like ? or kategori_perawatan.nm_kategori like ?) order by jns_perawatan.nm_perawatan ");     
            }else if(poli_ralan.equals("No")&&cara_bayar_ralan.equals("No")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
