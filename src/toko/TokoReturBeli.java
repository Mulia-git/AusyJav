        ...
        if(NoRetur.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if(sukses==true){
                    ...
                    if(Sequel.menyimpantf2("tampjurnal","?,?,?,?",4,new String[]{Retur_Beli_Toko,"RETUR PEMBELIAN","0",""+ttl})==false){
                        sukses=false;
                    }
                    if(Sequel.menyimpantf2("tampjurnal","?,?,?,?",4,new String[]{Kontra_Retur_Beli_Toko,"KONTRA RETUR PEMBELIAN",""+ttl,"0"})==false){
                        sukses=false;
                    }
                    if(sukses==true){
